...
package com.glaf.scheduler.query;

import java.util.*;
import com.glaf.core.query.DataQuery;

public class ExSchedulerLogQuery extends DataQuery {
	...
	public ExSchedulerLogQuery() {

	}

	public ExSchedulerLogQuery contentLike(String contentLike) {
		if (contentLike == null) {
	...
	public ExSchedulerLogQuery createDateGreaterThanOrEqual(
	...
	public ExSchedulerLogQuery createDateLessThanOrEqual(
	...
	public ExSchedulerLogQuery endDateGreaterThanOrEqual(
	...
	public ExSchedulerLogQuery endDateLessThanOrEqual(Date endDateLessThanOrEqual) {
	...
	public ExSchedulerLogQuery exitCode(String exitCode) {
		if (exitCode == null) {
	...
	public ExSchedulerLogQuery exitMessageLike(String exitMessageLike) {
	...
	public ExSchedulerLogQuery startDateGreaterThanOrEqual(
	...
	public ExSchedulerLogQuery startDateLessThanOrEqual(
	...
	public ExSchedulerLogQuery taskId(String taskId) {
		if (taskId == null) {
	...
	public ExSchedulerLogQuery taskName(String taskName) {
		if (taskName == null) {
	...
	public ExSchedulerLogQuery taskNameLike(String taskNameLike) {
	...
	public ExSchedulerLogQuery title(String title) {
		if (title == null) {
	...
	public ExSchedulerLogQuery titleLike(String titleLike) {
		if (titleLike == null) {
			throw new RuntimeException("title is null");
		}
		this.titleLike = titleLike;
