...
public class SchedulerLogJsonFactory {
	...
	public static ExSchedulerLog jsonToObject(JSONObject jsonObject) {
		ExSchedulerLog model = new ExSchedulerLog();
	...
	public static JSONObject toJsonObject(ExSchedulerLog model) {
	...
	public static ObjectNode toObjectNode(ExSchedulerLog model) {
	...
	public static JSONArray listToArray(java.util.List<ExSchedulerLog> list) {
		JSONArray array = new JSONArray();
		if (list != null && !list.isEmpty()) {
			for (ExSchedulerLog model : list) {
	...
	public static java.util.List<ExSchedulerLog> arrayToList(JSONArray array) {
		java.util.List<ExSchedulerLog> list = new java.util.ArrayList<ExSchedulerLog>();
		for (int i = 0, len = array.size(); i < len; i++) {
			JSONObject jsonObject = array.getJSONObject(i);
			ExSchedulerLog model = jsonToObject(jsonObject);
			list.add(model);
		}
		return list;
	}
