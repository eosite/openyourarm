...
public class ExSchedulerExecutionQuery extends DataQuery {
	...
	public ExSchedulerExecutionQuery() {

	}

	public ExSchedulerExecutionQuery createTimeGreaterThanOrEqual(
	...
	public ExSchedulerExecutionQuery createTimeLessThanOrEqual(
	...
	public ExSchedulerExecutionQuery jobNo(String jobNo) {
		if (jobNo == null) {
	...
	public ExSchedulerExecutionQuery runDay(Integer runDay) {
		if (runDay == null) {
	...
	public ExSchedulerExecutionQuery runDayGreaterThanOrEqual(
	...
	public ExSchedulerExecutionQuery runDayLessThanOrEqual(
	...
	public ExSchedulerExecutionQuery runMonth(Integer runMonth) {
		if (runMonth == null) {
	...
	public ExSchedulerExecutionQuery runQuarter(Integer runQuarter) {
		if (runQuarter == null) {
	...
	public ExSchedulerExecutionQuery runWeek(Integer runWeek) {
		if (runWeek == null) {
	...
	public ExSchedulerExecutionQuery runYear(Integer runYear) {
		if (runYear == null) {
	...
	public ExSchedulerExecutionQuery schedulerId(String schedulerId) {
		if (schedulerId == null) {
	...
	public ExSchedulerExecutionQuery statusGreaterThanOrEqual(
	...
	public ExSchedulerExecutionQuery statusLessThanOrEqual(
