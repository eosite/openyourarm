...
import com.glaf.scheduler.domain.ExSchedulerEntity;
...
public class SchedulerJsonFactory {
	...
	public static Scheduler jsonToObject(JSONObject jsonObject) {
		ExSchedulerEntity model = new ExSchedulerEntity();
		...
		if (jsonObject.containsKey("fireTime")) {
			model.setFireTime(jsonObject.getDate("fireTime"));
		}
	...
	public static JSONObject toJsonObject(Scheduler model) {
		...
		if (model.getFireTime() != null) {
			jsonObject.put("fireTime", DateUtils.getDate(model.getFireTime()));
			jsonObject.put("fireTime_date", DateUtils.getDate(model.getFireTime()));
			jsonObject.put("fireTime_datetime", DateUtils.getDateTime(model.getFireTime()));
		}

		if (model.getNextFireTime() != null) {
			jsonObject.put("nextFireTime", DateUtils.getDate(model.getNextFireTime()));
			jsonObject.put("nextFireTime_date", DateUtils.getDate(model.getNextFireTime()));
			jsonObject.put("nextFireTime_datetime", DateUtils.getDateTime(model.getNextFireTime()));
		}
		if (model.getPreviousFireTime() != null) {
			jsonObject.put("previousFireTime", DateUtils.getDate(model.getPreviousFireTime()));
			jsonObject.put("previousFireTime_date", DateUtils.getDate(model.getPreviousFireTime()));
			jsonObject.put("previousFireTime_datetime", DateUtils.getDateTime(model.getPreviousFireTime()));
		}
