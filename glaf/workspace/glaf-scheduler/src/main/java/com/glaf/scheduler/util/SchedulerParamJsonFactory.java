...
public class SchedulerParamJsonFactory {
	...
	public static java.util.List<ExSchedulerParam> arrayToList(JSONArray array) {
		java.util.List<ExSchedulerParam> list = new java.util.ArrayList<ExSchedulerParam>();
		for (int i = 0, len = array.size(); i < len; i++) {
			JSONObject jsonObject = array.getJSONObject(i);
			ExSchedulerParam model = jsonToObject(jsonObject);
			list.add(model);
		}
		return list;
	}

	public static ExSchedulerParam jsonToObject(JSONObject jsonObject) {
		ExSchedulerParam model = new ExSchedulerParam();
	...
	public static JSONArray listToArray(java.util.List<ExSchedulerParam> list) {
		JSONArray array = new JSONArray();
		if (list != null && !list.isEmpty()) {
			for (ExSchedulerParam model : list) {
	...
	public static JSONObject toJsonObject(ExSchedulerParam model) {
	...
	public static ObjectNode toObjectNode(ExSchedulerParam model) {
