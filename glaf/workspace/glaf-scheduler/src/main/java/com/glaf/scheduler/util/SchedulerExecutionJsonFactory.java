...
public class SchedulerExecutionJsonFactory {
	...
	public static java.util.List<ExSchedulerExecution> arrayToList(JSONArray array) {
		java.util.List<ExSchedulerExecution> list = new java.util.ArrayList<ExSchedulerExecution>();
		for (int i = 0, len = array.size(); i < len; i++) {
			JSONObject jsonObject = array.getJSONObject(i);
			ExSchedulerExecution model = jsonToObject(jsonObject);
			list.add(model);
		}
		return list;
	}

	public static ExSchedulerExecution jsonToObject(JSONObject jsonObject) {
		ExSchedulerExecution model = new ExSchedulerExecution();
	...
	public static JSONArray listToArray(java.util.List<ExSchedulerExecution> list) {
		JSONArray array = new JSONArray();
		if (list != null && !list.isEmpty()) {
			for (ExSchedulerExecution model : list) {
	...
	public static JSONObject toJsonObject(ExSchedulerExecution model) {
	...
	public static ObjectNode toObjectNode(ExSchedulerExecution model) {
