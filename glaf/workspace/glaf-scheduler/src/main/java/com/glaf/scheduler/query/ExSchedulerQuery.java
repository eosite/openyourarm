...
public class ExSchedulerQuery extends DataQuery {
	...
	public ExSchedulerQuery() {

	}

	public ExSchedulerQuery contentLike(String contentLike) {
		if (contentLike == null) {
	...
	public ExSchedulerQuery endDateGreaterThanOrEqual(
	...
	public ExSchedulerQuery endDateLessThanOrEqual(Date endDateLessThanOrEqual) {
	...
	public ExSchedulerQuery jobClassLike(String jobClassLike) {
	...
	public ExSchedulerQuery runStatus(Integer runStatus) {
		if (runStatus == null) {
	...
	public ExSchedulerQuery runType(Integer runType) {
		if (runType == null) {
	...
	public ExSchedulerQuery startDateGreaterThanOrEqual(
	...
	public ExSchedulerQuery startDateLessThanOrEqual(Date startDateLessThanOrEqual) {
	...
	public ExSchedulerQuery taskId(String taskId) {
		if (taskId == null) {
	...
	public ExSchedulerQuery taskIds(List<String> taskIds) {
		if (taskIds == null) {
	...
	public ExSchedulerQuery taskNameLike(String taskNameLike) {
	...
	public ExSchedulerQuery taskType(String taskType) {
		if (taskType == null) {
	...
	public ExSchedulerQuery titleLike(String titleLike) {
		if (titleLike == null) {
