...
public class SystemRealm extends AuthorizingRealm {
	...
	protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken token) throws AuthenticationException {
		...
		AuthenticationInfo info = new SimpleAuthenticationInfo(actorId, password.toCharArray(), getName());
		return info;
	}
	...
	protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principals) {
		...
		if (actorId != null) {
			...
			if (loginContext.isSystemAdministrator()
					&& (StringUtils.equals(actorId, "admin") || StringUtils.equals(actorId, "root"))) {
				perms.add("SystemAdministrator");
				roles.add("SystemAdministrator");
			} else {
				perms.remove("SystemAdministrator");
				roles.remove("SystemAdministrator");
			}
