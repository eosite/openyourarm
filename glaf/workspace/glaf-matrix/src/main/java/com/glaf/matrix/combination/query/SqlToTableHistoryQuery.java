...
public class SqlToTableHistoryQuery extends DataQuery {
	...
	public SqlToTableHistoryQuery() {

	}

	public SqlToTableHistoryQuery createTimeGreaterThanOrEqual(Date createTimeGreaterThanOrEqual) {
	...
	public SqlToTableHistoryQuery createTimeLessThanOrEqual(Date createTimeLessThanOrEqual) {
	...
	public SqlToTableHistoryQuery databaseId(Long databaseId) {
		if (databaseId == null) {
	...
	public SqlToTableHistoryQuery databaseIds(List<Long> databaseIds) {
		if (databaseIds == null) {
	...
	public SqlToTableHistoryQuery deploymentId(String deploymentId) {
	...
	public SqlToTableHistoryQuery deploymentIds(List<String> deploymentIds) {
	...
	public SqlToTableHistoryQuery syncId(Long syncId) {
		if (syncId == null) {
	...
	public SqlToTableHistoryQuery syncIds(List<Long> syncIds) {
		if (syncIds == null) {
	...
	public SqlToTableHistoryQuery totalTimeGreaterThanOrEqual(Integer totalTimeGreaterThanOrEqual) {
	...
	public SqlToTableHistoryQuery totalTimeLessThanOrEqual(Integer totalTimeLessThanOrEqual) {
