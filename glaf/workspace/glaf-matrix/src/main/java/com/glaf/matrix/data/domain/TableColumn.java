 ...
 */
@Entity
@Table(name = "SYS_EXT_COLUMN")
public class TableColumn implements java.lang.Comparable<TableColumn>, java.io.Serializable {
	...
	/**
	 * 列位置，Excel的列索引，从1开始，实际使用时减去1（Excel从0开始，所以减去1）
	 */
	@Column(name = "COLINDEX_")
	...
	public TableColumn jsonToObject(JSONObject jsonObject) {
		return TableColumnJsonFactory.jsonToObject(jsonObject);
	}
	...
	public JSONObject toJsonObject() {
		return TableColumnJsonFactory.toJsonObject(this);
	}

	public ObjectNode toObjectNode() {
		return TableColumnJsonFactory.toObjectNode(this);
	}
