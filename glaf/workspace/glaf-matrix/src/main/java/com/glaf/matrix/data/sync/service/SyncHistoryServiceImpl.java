...
import com.glaf.matrix.data.sync.mapper.SyncHistoryMapper;
import com.glaf.matrix.data.sync.query.SyncHistoryQuery;

@Service("com.glaf.matrix.data.sync.service.syncHistoryService")
...
public class SyncHistoryServiceImpl implements SyncHistoryService {
	...
	public SyncHistory getLatestSyncHistory(long syncId,  long databaseId) {
		SyncHistoryQuery query = new SyncHistoryQuery();
		query.syncId(syncId);
	...
	@javax.annotation.Resource(name = "com.glaf.matrix.data.sync.mapper.SyncHistoryMapper")
