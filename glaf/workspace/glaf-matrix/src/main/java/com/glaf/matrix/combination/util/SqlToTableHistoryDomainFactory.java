 ...
 *
 */
public class SqlToTableHistoryDomainFactory {

	public static final String TABLENAME = "SYS_SQL_TO_TABLE_HISTORY";
	...
	public static TableDefinition getTableDefinition(String tableName) {
		...
		tableDefinition.setName("SqlToTableHistory");
	...
	private SqlToTableHistoryDomainFactory() {
