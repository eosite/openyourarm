...
@Entity
@Table(name = "SYS_TABLE_AGGR_ITEM")
public class TableAggregateItem implements Serializable, JSONable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TableAggregateItem other = (TableAggregateItem) obj;
		if (id != other.id)
			return false;
		return true;
	}
	...
	public TableAggregateItem jsonToObject(JSONObject jsonObject) {
		return TableAggregateItemJsonFactory.jsonToObject(jsonObject);
	}
	...
	public JSONObject toJsonObject() {
		return TableAggregateItemJsonFactory.toJsonObject(this);
	}

	public ObjectNode toObjectNode() {
		return TableAggregateItemJsonFactory.toObjectNode(this);
	}
