...
package com.glaf.matrix.aggregate.domain;
...
import com.glaf.matrix.aggregate.util.*;
...
@Entity
@Table(name = "SYS_TABLE_AGGR_APP")
public class TableAggregateApp implements Serializable, JSONable {
	 ...
	 * 来源表计算列
	 */
	@Column(name = "SOURCECALCULATECOLUMNS_", length = 4000)
	protected String sourceCalculateColumns;

	/**
	 * 切分日期格式
	 */
	@Column(name = "SPLITDATEFORMAT_", length = 50)
	protected String splitDateFormat;

	/**
	 * 维度表
	 */
	@Column(name = "DIMENSIONTABLENAME_", length = 50)
	protected String dimensionTableName;

	/**
	 * 维度列
	 */
	@Column(name = "DIMENSIONCOLUMN_", length = 50)
	protected String dimensionColumn;
	...
	protected List<TableAggregateItem> items = new ArrayList<TableAggregateItem>();

	public TableAggregateApp() {

	}

	public void addItem(TableAggregateItem item) {
		if (items == null) {
			items = new ArrayList<TableAggregateItem>();
		}
		items.add(item);
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TableAggregateApp other = (TableAggregateApp) obj;
		if (id != other.id)
			return false;
		return true;
	}
	...
	public List<TableAggregateItem> getItems() {
		return items;
	}
	...
	public String getSourceCalculateColumns() {
		return sourceCalculateColumns;
	}
	...
	public String getSourceTextColumn() {
		return sourceTextColumn;
	}

	public String getSourceTreeIdColumn() {
		return sourceTreeIdColumn;
	}
	...
	public TableAggregateApp jsonToObject(JSONObject jsonObject) {
		return TableAggregateAppJsonFactory.jsonToObject(jsonObject);
	}
	...
	public void setItems(List<TableAggregateItem> items) {
		this.items = items;
	}
	...
	public void setSourceCalculateColumns(String sourceCalculateColumns) {
		this.sourceCalculateColumns = sourceCalculateColumns;
	}
	...
	public JSONObject toJsonObject() {
		return TableAggregateAppJsonFactory.toJsonObject(this);
	}

	public ObjectNode toObjectNode() {
		return TableAggregateAppJsonFactory.toObjectNode(this);
	}
