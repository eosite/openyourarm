...
public class TableServiceImpl implements ITableService {
	...
	public List<TableColumn> getTableColumns(TableColumnQuery query) {
		return columnDefinitionMapper.getTableColumns(query);
	}
	...
	@Transactional
	public void saveColumns(String targetId, List<TableColumn> columnDefinitions) {
		columnDefinitionMapper.deleteTableColumnByTargetId(targetId);
		if (columnDefinitions != null && !columnDefinitions.isEmpty()) {
			for (TableColumn col : columnDefinitions) {
	...
	@Transactional
	public void saveTableColumn(String tableId, TableColumn column) {
	...
	@Transactional
	public void saveTableColumns(String tableId, List<TableColumn> columns) {
		columnDefinitionMapper.deleteTableColumnByTableId(tableId);
		if (columns != null && !columns.isEmpty()) {
	...
	public void saveSystemTable(String tableName, List<TableColumn> columns) {
		...
		if (table == null) {
			...
			table.setColumnQty(columns.size());
			table.setRevision(1);
	 ...
	 */
	@Transactional
	public void updateColumn(TableColumn columnDefinition) {
		columnDefinitionMapper.updateTableColumn(columnDefinition);
	}
