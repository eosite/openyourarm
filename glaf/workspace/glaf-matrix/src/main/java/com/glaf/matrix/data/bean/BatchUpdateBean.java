...
public class BatchUpdateBean {
	 ...
	 * @param dataList
	 */
	public void dynamicUpdate(Connection conn, SysTable sysTable, List<Map<String, Object>> dataList) {
		StringBuilder buffer = new StringBuilder();
		TableColumn idColumn = sysTable.getIdColumn();
		...
		try {
			...
			for (int k = 0, l = dataList.size(); k < l; k++) {
				...
				buffer.append(" update ").append(sysTable.getTableName()).append(" set ");
	 ...
	 * @param dataList
	 */
	public void executeBatch(Connection conn, SysTable sysTable, List<Map<String, Object>> dataList) {
		StringBuilder buffer = new StringBuilder();
		TableColumn idColumn = sysTable.getIdColumn();
		List<TableColumn> columns = sysTable.getColumns();
		List<TableColumn> cols = new ArrayList<TableColumn>();
