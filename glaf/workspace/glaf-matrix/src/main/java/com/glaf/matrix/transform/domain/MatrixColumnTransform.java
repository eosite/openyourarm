...
@Entity
@Table(name = "MATRIX_COLUMN_TRANSFORM")
public class MatrixColumnTransform implements java.lang.Comparable<MatrixColumnTransform>, Serializable, JSONable {
	...
	public MatrixColumnTransform() {

	}

	public int compareTo(MatrixColumnTransform o) {
		if (o == null) {
			return -1;
		}

		MatrixColumnTransform field = o;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		MatrixColumnTransform other = (MatrixColumnTransform) obj;
		if (id != other.id)
			return false;
		return true;
	}
	...
	public MatrixColumnTransform jsonToObject(JSONObject jsonObject) {
		return MatrixColumnTransformJsonFactory.jsonToObject(jsonObject);
	}
	...
	public JSONObject toJsonObject() {
		return MatrixColumnTransformJsonFactory.toJsonObject(this);
	}

	public ObjectNode toObjectNode() {
		return MatrixColumnTransformJsonFactory.toObjectNode(this);
	}
