 ...
 *
 */
public class SqlToTableAppDomainFactory {

	public static final String TABLENAME = "SYS_SQL_TO_TABLE_APP";
	...
	static {
		...
		columnMap.put("srcDatabaseIds", "SRCDATABASEIDS_");
		...
		columnMap.put("uniqueFlag", "UNIQUEFLAG_");
		...
		javaTypeMap.put("srcDatabaseIds", "String");
		...
		javaTypeMap.put("uniqueFlag", "String");
	...
	public static TableDefinition getTableDefinition(String tableName) {
		...
		tableDefinition.setName("SqlToTableApp");
		...
		ColumnDefinition srcDatabaseIds = new ColumnDefinition();
		srcDatabaseIds.setName("srcDatabaseIds");
		srcDatabaseIds.setColumnName("SRCDATABASEIDS_");
		srcDatabaseIds.setJavaType("String");
		srcDatabaseIds.setLength(4000);
		tableDefinition.addColumn(srcDatabaseIds);
		...
		ColumnDefinition uniqueFlag = new ColumnDefinition();
		uniqueFlag.setName("uniqueFlag");
		uniqueFlag.setColumnName("UNIQUEFLAG_");
		uniqueFlag.setJavaType("String");
		uniqueFlag.setLength(50);
		tableDefinition.addColumn(uniqueFlag);
	...
	private SqlToTableAppDomainFactory() {
