 ...
 *
 */
public class MatrixColumnTransformDomainFactory {

	public static final String TABLENAME = "MATRIX_COLUMN_TRANSFORM";
	...
	public static TableDefinition getTableDefinition(String tableName) {
		...
		tableDefinition.setName("MatrixColumnTransform");
	...
	private MatrixColumnTransformDomainFactory() {
