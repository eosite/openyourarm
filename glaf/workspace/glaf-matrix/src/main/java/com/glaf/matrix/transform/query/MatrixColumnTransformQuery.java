...
public class MatrixColumnTransformQuery extends DataQuery {
	...
	public MatrixColumnTransformQuery() {

	}

	public MatrixColumnTransformQuery createTimeGreaterThanOrEqual(Date createTimeGreaterThanOrEqual) {
	...
	public MatrixColumnTransformQuery createTimeLessThanOrEqual(Date createTimeLessThanOrEqual) {
	...
	public MatrixColumnTransformQuery nameLike(String nameLike) {
		if (nameLike == null) {
	...
	public MatrixColumnTransformQuery syncStatus(Integer syncStatus) {
		if (syncStatus == null) {
	...
	public MatrixColumnTransformQuery tableName(String tableName) {
		if (tableName == null) {
	...
	public MatrixColumnTransformQuery tableNameLike(String tableNameLike) {
	...
	public MatrixColumnTransformQuery titleLike(String titleLike) {
		if (titleLike == null) {
	...
	public MatrixColumnTransformQuery transformId(String transformId) {
		if (transformId == null) {
