...
public class SqlToTableAppQuery extends DataQuery {
	...
	public SqlToTableAppQuery() {

	}

	public SqlToTableAppQuery active(String active) {
		if (active == null) {
	...
	public SqlToTableAppQuery autoSyncFlag(String autoSyncFlag) {
	...
	public SqlToTableAppQuery createTimeGreaterThanOrEqual(Date createTimeGreaterThanOrEqual) {
	...
	public SqlToTableAppQuery createTimeLessThanOrEqual(Date createTimeLessThanOrEqual) {
	...
	public SqlToTableAppQuery deploymentId(String deploymentId) {
	...
	public SqlToTableAppQuery deploymentIds(List<String> deploymentIds) {
	...
	public String getOrderBy() {
		if (sortColumn != null) {
			...
			if ("srcDatabaseIds".equals(sortColumn)) {
				orderBy = "E.SRCDATABASEIDS_" + a_x;
			}
	...
	public SqlToTableAppQuery nodeId(Long nodeId) {
		if (nodeId == null) {
	...
	public SqlToTableAppQuery nodeIds(List<Long> nodeIds) {
		if (nodeIds == null) {
	...
	public SqlToTableAppQuery syncFlag(String syncFlag) {
		if (syncFlag == null) {
	...
	public SqlToTableAppQuery targetTableName(String targetTableName) {
	...
	public SqlToTableAppQuery targetTableNameLike(String targetTableNameLike) {
	...
	public SqlToTableAppQuery titleLike(String titleLike) {
		if (titleLike == null) {
	...
	public SqlToTableAppQuery type(String type) {
		if (type == null) {
	...
	public SqlToTableAppQuery uniqueFlag(String uniqueFlag) {
		if (uniqueFlag == null) {
	...
	public SqlToTableAppQuery updateBy(String updateBy) {
		if (updateBy == null) {
	...
	public SqlToTableAppQuery updateTimeGreaterThanOrEqual(Date updateTimeGreaterThanOrEqual) {
	...
	public SqlToTableAppQuery updateTimeLessThanOrEqual(Date updateTimeLessThanOrEqual) {
