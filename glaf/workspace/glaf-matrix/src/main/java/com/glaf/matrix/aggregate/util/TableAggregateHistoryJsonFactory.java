 ...
 *
 */
public class TableAggregateHistoryJsonFactory {

	public static TableAggregateHistory jsonToObject(JSONObject jsonObject) {
		TableAggregateHistory model = new TableAggregateHistory();
	...
	public static JSONObject toJsonObject(TableAggregateHistory model) {
	...
	public static ObjectNode toObjectNode(TableAggregateHistory model) {
	...
	public static JSONArray listToArray(java.util.List<TableAggregateHistory> list) {
		JSONArray array = new JSONArray();
		if (list != null && !list.isEmpty()) {
			for (TableAggregateHistory model : list) {
	...
	public static java.util.List<TableAggregateHistory> arrayToList(JSONArray array) {
		java.util.List<TableAggregateHistory> list = new java.util.ArrayList<TableAggregateHistory>();
		for (int i = 0, len = array.size(); i < len; i++) {
			JSONObject jsonObject = array.getJSONObject(i);
			TableAggregateHistory model = jsonToObject(jsonObject);
			list.add(model);
		}
		return list;
	}

	private TableAggregateHistoryJsonFactory() {
