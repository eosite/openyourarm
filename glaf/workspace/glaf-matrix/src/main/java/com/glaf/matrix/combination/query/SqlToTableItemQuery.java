...
public class SqlToTableItemQuery extends DataQuery {
	...
	public SqlToTableItemQuery() {

	}

	public SqlToTableItemQuery createTimeGreaterThanOrEqual(Date createTimeGreaterThanOrEqual) {
	...
	public SqlToTableItemQuery createTimeLessThanOrEqual(Date createTimeLessThanOrEqual) {
	...
	public SqlToTableItemQuery deploymentId(String deploymentId) {
	...
	public SqlToTableItemQuery deploymentIds(List<String> deploymentIds) {
	...
	public SqlToTableItemQuery sqlLike(String sqlLike) {
		if (sqlLike == null) {
	...
	public SqlToTableItemQuery syncId(Long syncId) {
		if (syncId == null) {
	...
	public SqlToTableItemQuery syncIds(List<Long> syncIds) {
		if (syncIds == null) {
