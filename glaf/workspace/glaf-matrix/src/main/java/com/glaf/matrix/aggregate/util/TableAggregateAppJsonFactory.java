 ...
 *
 */
public class TableAggregateAppJsonFactory {

	public static TableAggregateApp jsonToObject(JSONObject jsonObject) {
		TableAggregateApp model = new TableAggregateApp();
		...
		if (jsonObject.containsKey("sourceCalculateColumns")) {
			model.setSourceCalculateColumns(jsonObject.getString("sourceCalculateColumns"));
		}
		if (jsonObject.containsKey("splitDateFormat")) {
			model.setSplitDateFormat(jsonObject.getString("splitDateFormat"));
		}
		if (jsonObject.containsKey("srcDatabaseId")) {
			model.setSrcDatabaseId(jsonObject.getLong("srcDatabaseId"));
		}
		if (jsonObject.containsKey("dimensionTableName")) {
			model.setDimensionTableName(jsonObject.getString("dimensionTableName"));
		}
		if (jsonObject.containsKey("dimensionColumn")) {
			model.setDimensionColumn(jsonObject.getString("dimensionColumn"));
		}
	...
	public static JSONObject toJsonObject(TableAggregateApp model) {
		...
		if (model.getSourceCalculateColumns() != null) {
			jsonObject.put("sourceCalculateColumns", model.getSourceCalculateColumns());
		}
		if (model.getSplitDateFormat() != null) {
			jsonObject.put("splitDateFormat", model.getSplitDateFormat());
		}
		if (model.getDimensionTableName() != null) {
			jsonObject.put("dimensionTableName", model.getDimensionTableName());
		}
		if (model.getDimensionColumn() != null) {
			jsonObject.put("dimensionColumn", model.getDimensionColumn());
		}
	...
	public static ObjectNode toObjectNode(TableAggregateApp model) {
	...
	public static JSONArray listToArray(java.util.List<TableAggregateApp> list) {
		JSONArray array = new JSONArray();
		if (list != null && !list.isEmpty()) {
			for (TableAggregateApp model : list) {
	...
	public static java.util.List<TableAggregateApp> arrayToList(JSONArray array) {
		java.util.List<TableAggregateApp> list = new java.util.ArrayList<TableAggregateApp>();
		for (int i = 0, len = array.size(); i < len; i++) {
			JSONObject jsonObject = array.getJSONObject(i);
			TableAggregateApp model = jsonToObject(jsonObject);
			list.add(model);
		}
		return list;
	}

	private TableAggregateAppJsonFactory() {
