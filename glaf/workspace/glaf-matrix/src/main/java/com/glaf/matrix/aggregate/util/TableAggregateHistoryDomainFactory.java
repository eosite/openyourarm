 ...
 *
 */
public class TableAggregateHistoryDomainFactory {

	public static final String TABLENAME = "SYS_TABLE_AGGR_HISTORY";
	...
	public static TableDefinition getTableDefinition(String tableName) {
		...
		tableDefinition.setName("TableAggregateHistory");
	...
	private TableAggregateHistoryDomainFactory() {
