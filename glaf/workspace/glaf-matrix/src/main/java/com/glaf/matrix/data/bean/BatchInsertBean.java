...
public class BatchInsertBean {
	 ...
	 * @param dataList
	 */
	public void bulkInsert(Connection conn, SysTable sysTable, List<Map<String, Object>> dataList) {
	...
	public void bulkInsertInner(Connection conn, SysTable sysTable, List<Map<String, Object>> dataList) {
		List<TableColumn> columns = sysTable.getColumns();
