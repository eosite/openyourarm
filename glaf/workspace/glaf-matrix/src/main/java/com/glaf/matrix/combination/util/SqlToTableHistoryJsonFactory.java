 ...
 *
 */
public class SqlToTableHistoryJsonFactory {

	public static SqlToTableHistory jsonToObject(JSONObject jsonObject) {
		SqlToTableHistory model = new SqlToTableHistory();
	...
	public static JSONObject toJsonObject(SqlToTableHistory model) {
	...
	public static ObjectNode toObjectNode(SqlToTableHistory model) {
	...
	public static JSONArray listToArray(java.util.List<SqlToTableHistory> list) {
		JSONArray array = new JSONArray();
		if (list != null && !list.isEmpty()) {
			for (SqlToTableHistory model : list) {
	...
	public static java.util.List<SqlToTableHistory> arrayToList(JSONArray array) {
		java.util.List<SqlToTableHistory> list = new java.util.ArrayList<SqlToTableHistory>();
		for (int i = 0, len = array.size(); i < len; i++) {
			JSONObject jsonObject = array.getJSONObject(i);
			SqlToTableHistory model = jsonToObject(jsonObject);
			list.add(model);
		}
		return list;
	}

	private SqlToTableHistoryJsonFactory() {
