...
public class TableAggregateHistoryQuery extends DataQuery {
	...
	public TableAggregateHistoryQuery() {

	}

	public TableAggregateHistoryQuery createTimeGreaterThanOrEqual(Date createTimeGreaterThanOrEqual) {
	...
	public TableAggregateHistoryQuery createTimeLessThanOrEqual(Date createTimeLessThanOrEqual) {
	...
	public TableAggregateHistoryQuery databaseId(Long databaseId) {
		if (databaseId == null) {
	...
	public TableAggregateHistoryQuery databaseIds(List<Long> databaseIds) {
		if (databaseIds == null) {
	...
	public TableAggregateHistoryQuery deploymentId(String deploymentId) {
	...
	public TableAggregateHistoryQuery deploymentIds(List<String> deploymentIds) {
	...
	public TableAggregateHistoryQuery syncId(Long syncId) {
		if (syncId == null) {
	...
	public TableAggregateHistoryQuery syncIds(List<Long> syncIds) {
		if (syncIds == null) {
	...
	public TableAggregateHistoryQuery totalTimeGreaterThanOrEqual(Integer totalTimeGreaterThanOrEqual) {
	...
	public TableAggregateHistoryQuery totalTimeLessThanOrEqual(Integer totalTimeLessThanOrEqual) {
