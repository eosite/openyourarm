...
@Entity
@Table(name = "SYS_SQL_TO_TABLE_ITEM")
public class SqlToTableItem implements Serializable, JSONable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SqlToTableItem other = (SqlToTableItem) obj;
		if (id != other.id)
			return false;
		return true;
	}
	...
	public SqlToTableItem jsonToObject(JSONObject jsonObject) {
		return SqlToTableItemJsonFactory.jsonToObject(jsonObject);
	}
	...
	public JSONObject toJsonObject() {
		return SqlToTableItemJsonFactory.toJsonObject(this);
	}

	public ObjectNode toObjectNode() {
		return SqlToTableItemJsonFactory.toObjectNode(this);
	}
