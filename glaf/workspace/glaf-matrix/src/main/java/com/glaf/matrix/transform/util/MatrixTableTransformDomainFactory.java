 ...
 *
 */
public class MatrixTableTransformDomainFactory {

	public static final String TABLENAME = "MATRIX_TABLE_TRANSFORM";
	...
	public static TableDefinition getTableDefinition(String tableName) {
		...
		tableDefinition.setName("MatrixTableTransform");
	...
	private MatrixTableTransformDomainFactory() {
