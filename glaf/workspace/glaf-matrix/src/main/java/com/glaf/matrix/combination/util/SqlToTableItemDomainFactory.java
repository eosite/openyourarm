 ...
 *
 */
public class SqlToTableItemDomainFactory {

	public static final String TABLENAME = "SYS_SQL_TO_TABLE_ITEM";
	...
	public static TableDefinition getTableDefinition(String tableName) {
		...
		tableDefinition.setName("SqlToTableItem");
	...
	private SqlToTableItemDomainFactory() {
