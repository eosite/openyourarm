...
public class SysTableQuery extends BaseQuery {
	...
	public SysTableQuery() {

	}

	public SysTableQuery attachmentFlag(String attachmentFlag) {
	...
	public SysTableQuery createTimeGreaterThanOrEqual(Date createTimeGreaterThanOrEqual) {
	...
	public SysTableQuery createTimeLessThanOrEqual(Date createTimeLessThanOrEqual) {
	...
	public SysTableQuery descriptionLike(String descriptionLike) {
	...
	public SysTableQuery nodeId(Long nodeId) {
		if (nodeId == null) {
	...
	public SysTableQuery privilegeFlag(String privilegeFlag) {
	...
	public SysTableQuery revision(Integer revision) {
		if (revision == null) {
	...
	public SysTableQuery systemFlag(String systemFlag) {
		if (systemFlag == null) {
	...
	public SysTableQuery tableIds(List<String> tableIds) {
		if (tableIds == null) {
	...
	public SysTableQuery tableType(String tableType) {
		if (tableType == null) {
	...
	public SysTableQuery titleLike(String titleLike) {
		if (titleLike == null) {
	...
	public SysTableQuery type(String type) {
		if (type == null) {
