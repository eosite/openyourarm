...
package com.glaf.matrix.aggregate.query;

import java.util.*;
import com.glaf.core.query.DataQuery;

public class TableAggregateAppQuery extends DataQuery {
	...
	public TableAggregateAppQuery() {

	}

	public TableAggregateAppQuery active(String active) {
		if (active == null) {
	...
	public TableAggregateAppQuery autoSyncFlag(String autoSyncFlag) {
	...
	public TableAggregateAppQuery createTimeGreaterThanOrEqual(Date createTimeGreaterThanOrEqual) {
	...
	public TableAggregateAppQuery createTimeLessThanOrEqual(Date createTimeLessThanOrEqual) {
	...
	public TableAggregateAppQuery deploymentId(String deploymentId) {
	...
	public TableAggregateAppQuery deploymentIds(List<String> deploymentIds) {
	...
	public TableAggregateAppQuery nodeId(Long nodeId) {
		if (nodeId == null) {
	...
	public TableAggregateAppQuery nodeIds(List<Long> nodeIds) {
		if (nodeIds == null) {
	...
	public TableAggregateAppQuery syncFlag(String syncFlag) {
		if (syncFlag == null) {
	...
	public TableAggregateAppQuery targetTableName(String targetTableName) {
	...
	public TableAggregateAppQuery targetTableNameLike(String targetTableNameLike) {
	...
	public TableAggregateAppQuery titleLike(String titleLike) {
		if (titleLike == null) {
	...
	public TableAggregateAppQuery type(String type) {
		if (type == null) {
	...
	public TableAggregateAppQuery updateBy(String updateBy) {
		if (updateBy == null) {
	...
	public TableAggregateAppQuery updateTimeGreaterThanOrEqual(Date updateTimeGreaterThanOrEqual) {
	...
	public TableAggregateAppQuery updateTimeLessThanOrEqual(Date updateTimeLessThanOrEqual) {
