...
public class TableAggregateItemQuery extends DataQuery {
	...
	public TableAggregateItemQuery() {

	}

	public TableAggregateItemQuery createTimeGreaterThanOrEqual(Date createTimeGreaterThanOrEqual) {
	...
	public TableAggregateItemQuery createTimeLessThanOrEqual(Date createTimeLessThanOrEqual) {
	...
	public TableAggregateItemQuery deploymentId(String deploymentId) {
	...
	public TableAggregateItemQuery deploymentIds(List<String> deploymentIds) {
	...
	public TableAggregateItemQuery sqlLike(String sqlLike) {
		if (sqlLike == null) {
	...
	public TableAggregateItemQuery syncId(Long syncId) {
		if (syncId == null) {
	...
	public TableAggregateItemQuery syncIds(List<Long> syncIds) {
		if (syncIds == null) {
