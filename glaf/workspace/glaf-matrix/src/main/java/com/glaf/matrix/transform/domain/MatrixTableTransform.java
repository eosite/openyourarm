...
@Entity
@Table(name = "MATRIX_TABLE_TRANSFORM")
public class MatrixTableTransform implements java.lang.Comparable<MatrixTableTransform>, Serializable, JSONable {
	...
	protected List<MatrixColumnTransform> columns = new ArrayList<MatrixColumnTransform>();

	public MatrixTableTransform() {

	}
	
	

	public int compareTo(MatrixTableTransform o) {
		if (o == null) {
			return -1;
		}

		MatrixTableTransform field = o;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		MatrixTableTransform other = (MatrixTableTransform) obj;
		if (tableName == null) {
	...
	public List<MatrixColumnTransform> getColumns() {
		return columns;
	}
	...
	public MatrixTableTransform jsonToObject(JSONObject jsonObject) {
		return MatrixTableTransformJsonFactory.jsonToObject(jsonObject);
	}

	public void setColumns(List<MatrixColumnTransform> columns) {
	...
	public JSONObject toJsonObject() {
		return MatrixTableTransformJsonFactory.toJsonObject(this);
	}

	public ObjectNode toObjectNode() {
		return MatrixTableTransformJsonFactory.toObjectNode(this);
	}
