 ...
 *
 */
public class TableAggregateItemDomainFactory {

	public static final String TABLENAME = "SYS_TABLE_AGGR_ITEM";
	...
	public static TableDefinition getTableDefinition(String tableName) {
		...
		tableDefinition.setName("TableAggregateItem");
	...
	private TableAggregateItemDomainFactory() {
