...
public class SqlCriteriaController {
	...
	public ModelAndView edit(HttpServletRequest request, ModelMap modelMap) {
		...
		return new ModelAndView("/matrix/sys/sqlCriteria/edit", modelMap);
	}
	...
	public ModelAndView list(HttpServletRequest request, ModelMap modelMap) {
		...
		return new ModelAndView("/matrix/sys/sqlCriteria/list", modelMap);
	}
	...
	public ModelAndView query(HttpServletRequest request, ModelMap modelMap) {
		...
		return new ModelAndView("/matrix/sys/sqlCriteria/query", modelMap);
	}
	...
	public ModelAndView showSort(HttpServletRequest request, ModelMap modelMap) {
		...
		return new ModelAndView("/matrix/sys/sqlCriteria/showSort", modelMap);
	}
	...
	public ModelAndView view(HttpServletRequest request, ModelMap modelMap) {
		...
		return new ModelAndView("/matrix/sys/sqlCriteria/view");
	}
