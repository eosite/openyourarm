 ...
 *
 */
public class MonitorTerminalItemJsonFactory {

	public static MonitorTerminalItem jsonToObject(JSONObject jsonObject) {
            MonitorTerminalItem model = new MonitorTerminalItem();
	...
	public static JSONObject toJsonObject(MonitorTerminalItem model) {
	...
	public static ObjectNode toObjectNode(MonitorTerminalItem model){
	...
	public static JSONArray listToArray(java.util.List<MonitorTerminalItem> list) {
		JSONArray array = new JSONArray();
		if (list != null && !list.isEmpty()) {
			for (MonitorTerminalItem model : list) {
	...
	public static java.util.List<MonitorTerminalItem> arrayToList(JSONArray array) {
		java.util.List<MonitorTerminalItem> list = new java.util.ArrayList<MonitorTerminalItem>();
		for (int i = 0, len = array.size(); i < len; i++) {
			JSONObject jsonObject = array.getJSONObject(i);
			MonitorTerminalItem model = jsonToObject(jsonObject);
			list.add(model);
		}
		return list;
	}
	...
	private MonitorTerminalItemJsonFactory() {
