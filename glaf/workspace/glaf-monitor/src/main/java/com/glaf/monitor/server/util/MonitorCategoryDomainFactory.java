 ...
 *
 */
public class MonitorCategoryDomainFactory {

    public static final String TABLENAME = "MONITOR_CATEGORY";
    ...
    public static TableDefinition getTableDefinition(String tableName) {
        ...
        tableDefinition.setName("MonitorCategory");
    ...
    private MonitorCategoryDomainFactory() {
