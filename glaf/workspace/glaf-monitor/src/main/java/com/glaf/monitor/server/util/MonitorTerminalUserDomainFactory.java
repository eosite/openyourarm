 ...
 *
 */
public class MonitorTerminalUserDomainFactory {

    public static final String TABLENAME = "MONITOR_TERMINAL_USER";
    ...
    public static TableDefinition getTableDefinition(String tableName) {
        ...
        tableDefinition.setName("MonitorTerminalUser");
    ...
    private MonitorTerminalUserDomainFactory() {
