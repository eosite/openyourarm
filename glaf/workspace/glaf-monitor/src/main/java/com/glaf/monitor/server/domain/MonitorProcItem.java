...
@Entity
@Table(name = "MONITOR_PROC_ITEM")
public class MonitorProcItem implements Serializable, JSONable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		MonitorProcItem other = (MonitorProcItem) obj;
		if (id == null) {
			if (other.id != null)
				return false;
	...
	public MonitorProcItem jsonToObject(JSONObject jsonObject) {
            return MonitorProcItemJsonFactory.jsonToObject(jsonObject);
	}


	public JSONObject toJsonObject() {
            return MonitorProcItemJsonFactory.toJsonObject(this);
	}

	public ObjectNode toObjectNode(){
            return MonitorProcItemJsonFactory.toObjectNode(this);
	}
