 ...
 *
 */
public class MonitorTerminalItemDomainFactory {

    public static final String TABLENAME = "MONITOR_TERMINAL_ITEM";
    ...
    public static TableDefinition getTableDefinition(String tableName) {
        ...
        tableDefinition.setName("MonitorTerminalItem");
    ...
    private MonitorTerminalItemDomainFactory() {
