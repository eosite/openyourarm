...
public class MonitorProcCategoryQuery extends DataQuery {
    ...
    public MonitorProcCategoryQuery() {
    ...
    public MonitorProcCategoryQuery name(String name){
	if (name == null) {
    ...
    public MonitorProcCategoryQuery nameLike( String nameLike){
        if (nameLike == null) {
            throw new RuntimeException("name is null");
        }
        this.nameLike = nameLike;
    ...
    public MonitorProcCategoryQuery names(List<String> names){
        if (names == null) {
    ...
    public MonitorProcCategoryQuery code(String code){
	if (code == null) {
    ...
    public MonitorProcCategoryQuery codeLike( String codeLike){
        if (codeLike == null) {
            throw new RuntimeException("code is null");
        }
        this.codeLike = codeLike;
    ...
    public MonitorProcCategoryQuery codes(List<String> codes){
        if (codes == null) {
    ...
    public MonitorProcCategoryQuery pid(Integer pid){
	if (pid == null) {
    ...
    public MonitorProcCategoryQuery pidGreaterThanOrEqual(Integer pidGreaterThanOrEqual){
    ...
    public MonitorProcCategoryQuery pidLessThanOrEqual(Integer pidLessThanOrEqual){
    ...
    public MonitorProcCategoryQuery pids(List<Integer> pids){
        if (pids == null) {
    ...
    public MonitorProcCategoryQuery treeid(String treeid){
	if (treeid == null) {
    ...
    public MonitorProcCategoryQuery treeidLike( String treeidLike){
        if (treeidLike == null) {
            throw new RuntimeException("treeid is null");
        }
        this.treeidLike = treeidLike;
    ...
    public MonitorProcCategoryQuery treeids(List<String> treeids){
        if (treeids == null) {
    ...
    public MonitorProcCategoryQuery createby(String createby){
	if (createby == null) {
    ...
    public MonitorProcCategoryQuery createbyLike( String createbyLike){
    ...
    public MonitorProcCategoryQuery createbys(List<String> createbys){
        if (createbys == null) {
    ...
    public MonitorProcCategoryQuery createtimeGreaterThanOrEqual(Date createtimeGreaterThanOrEqual){
    ...
    public MonitorProcCategoryQuery createtimeLessThanOrEqual(Date createtimeLessThanOrEqual){
    ...
    public MonitorProcCategoryQuery updateby(String updateby){
	if (updateby == null) {
    ...
    public MonitorProcCategoryQuery updatebyLike( String updatebyLike){
    ...
    public MonitorProcCategoryQuery updatebys(List<String> updatebys){
        if (updatebys == null) {
    ...
    public MonitorProcCategoryQuery updatetimeGreaterThanOrEqual(Date updatetimeGreaterThanOrEqual){
    ...
    public MonitorProcCategoryQuery updatetimeLessThanOrEqual(Date updatetimeLessThanOrEqual){
    ...
    public MonitorProcCategoryQuery deleteFlag(Integer deleteFlag){
	if (deleteFlag == null) {
    ...
    public MonitorProcCategoryQuery deleteFlagGreaterThanOrEqual(Integer deleteFlagGreaterThanOrEqual){
    ...
    public MonitorProcCategoryQuery deleteFlagLessThanOrEqual(Integer deleteFlagLessThanOrEqual){
    ...
    public MonitorProcCategoryQuery deleteFlags(List<Integer> deleteFlags){
        if (deleteFlags == null) {
