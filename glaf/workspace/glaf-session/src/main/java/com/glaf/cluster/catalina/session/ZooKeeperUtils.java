...
public class ZooKeeperUtils {
	...
	public static boolean asynSetSessionData(final String sid, final String name, final Object value, boolean waitFor) {
	...
	public static void createGroupNode() {
		...
		if (zk != null) {
			try {
				...
				if (stat == null) {
					// 创建组件点
					String path = zk.create(GROUP_NAME, null, Ids.OPEN_ACL_UNSAFE, CreateMode.PERSISTENT);
