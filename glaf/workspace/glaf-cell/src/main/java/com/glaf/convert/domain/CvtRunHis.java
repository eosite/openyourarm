...
@Entity
@Table(name = "CVT_RUN_HIS")
public class CvtRunHis implements Serializable, JSONable {
	...
	public CvtRunHis jsonToObject(JSONObject jsonObject) {
            return CvtRunHisJsonFactory.jsonToObject(jsonObject);
	}


	public JSONObject toJsonObject() {
            return CvtRunHisJsonFactory.toJsonObject(this);
	}

	public ObjectNode toObjectNode(){
            return CvtRunHisJsonFactory.toObjectNode(this);
	}
