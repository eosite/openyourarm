...
public class CvtRunHisQuery extends DataQuery {
	...
	public CvtRunHisQuery taskName(String taskName) {
		if (taskName == null) {
	...
	public CvtRunHisQuery taskNameLike(String taskNameLike) {
	...
	public CvtRunHisQuery taskNames(List<String> taskNames) {
		if (taskNames == null) {
	...
	public CvtRunHisQuery runTimeGreaterThanOrEqual(Date runTimeGreaterThanOrEqual) {
	...
	public CvtRunHisQuery runTimeLessThanOrEqual(Date runTimeLessThanOrEqual) {
	...
	public CvtRunHisQuery runFlag(Integer runFlag) {
		if (runFlag == null) {
	...
	public CvtRunHisQuery runFlagGreaterThanOrEqual(Integer runFlagGreaterThanOrEqual) {
	...
	public CvtRunHisQuery runFlagLessThanOrEqual(Integer runFlagLessThanOrEqual) {
	...
	public CvtRunHisQuery runFlags(List<Integer> runFlags) {
		if (runFlags == null) {
	...
	public CvtRunHisQuery succCount(Integer succCount) {
		if (succCount == null) {
	...
	public CvtRunHisQuery succCountGreaterThanOrEqual(Integer succCountGreaterThanOrEqual) {
	...
	public CvtRunHisQuery succCountLessThanOrEqual(Integer succCountLessThanOrEqual) {
	...
	public CvtRunHisQuery succCounts(List<Integer> succCounts) {
		if (succCounts == null) {
	...
	public CvtRunHisQuery failCount(Integer failCount) {
		if (failCount == null) {
	...
	public CvtRunHisQuery failCountGreaterThanOrEqual(Integer failCountGreaterThanOrEqual) {
	...
	public CvtRunHisQuery failCountLessThanOrEqual(Integer failCountLessThanOrEqual) {
	...
	public CvtRunHisQuery failCounts(List<Integer> failCounts) {
		if (failCounts == null) {
