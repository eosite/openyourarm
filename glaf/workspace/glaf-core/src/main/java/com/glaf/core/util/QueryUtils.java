...
public class QueryUtils {
	...
	public static SqlExecutor getMyBatisAndConditionSql(List<QueryCondition> conditions) {
	...
	public static String getSQLCondition(List<String> rowKeys, String alias, String columnName) {
		if (rowKeys == null || rowKeys.size() <= 0) {
			return "";
		}
		int index = 1;
	...
	public static void main(String[] args) {
		String sql = " select * from UserInfo where 1=1 and ( status = ${status} ) and ( userId in (${userIds})) ";
