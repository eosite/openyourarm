...
public class DatabaseController {
	...
	@RequestMapping("/addMQUserAll")
	public ModelAndView addMQUserAll(HttpServletRequest request, ModelMap modelMap) {
		...
		String x_view = ViewProperties.getString("database.addMQUserAll");
		if (StringUtils.isNotEmpty(x_view)) {
			return new ModelAndView(x_view);
		}

		return new ModelAndView("/modules/sys/database/addMQUserAll");
	}
	...
	public ModelAndView chooseDatabases(HttpServletRequest request, ModelMap modelMap) {
		...
		return new ModelAndView("/modules/sys/database/chooseDatabases", modelMap);
	}
	...
	public ModelAndView edit(HttpServletRequest request, ModelMap modelMap) {
		...
		if (database != null) {
			...
			request.setAttribute("nodeId", database.getNodeId());
		} else {
	...
	public ModelAndView showServerRef(HttpServletRequest request, ModelMap modelMap) {
		...
		if (databases != null && serverId > 0) {
			...
			for (Database db : databases) {
				if (db.getServerId() != null && db.getServerId() == serverId) {
		...
		return new ModelAndView("/modules/sys/database/showServerRef", modelMap);
	}
	...
	public ModelAndView showSort(HttpServletRequest request, ModelMap modelMap) {
		...
		return new ModelAndView("/modules/sys/database/showSort", modelMap);
	}
	...
	public byte[] verify(HttpServletRequest request) {
		try {
			...
			if (!"88888888".equals(password)) {
				...
				database.setKey(key);
				database.setPassword(pass);//设置新的密码
			}
	...
	public ModelAndView verifyAll(HttpServletRequest request, ModelMap modelMap) {
		...
		return new ModelAndView("/modules/sys/database/verifyAll");
	}
