...
public class MxSysSchedulerServiceImpl implements ISysSchedulerService {
	protected final static Log logger = LogFactory.getLog(MxSysSchedulerServiceImpl.class);
	...
	public void save(Scheduler model) {
		if (StringUtils.isEmpty(model.getId())) {
			...
			if (StringUtils.isEmpty(model.getBusinessType())) {
				model.setBusinessType("SYS");
			}
