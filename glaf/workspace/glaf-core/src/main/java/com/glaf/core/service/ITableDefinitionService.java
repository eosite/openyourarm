...
public interface ITableDefinitionService {
	 ...
	 */
	@Transactional
	String getNextTableName(String type);
	 ...
	 * @return
	 */
	List<TableDefinition> getTableDefinitionsByQueryCriteria(int start, int pageSize, TableDefinitionQuery query);

	@Transactional
	void insertColumns(String tableName, List<ColumnDefinition> columns);
