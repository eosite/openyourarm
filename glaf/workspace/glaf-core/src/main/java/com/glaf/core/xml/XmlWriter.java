...
public class XmlWriter {
	...
	public Document write(TableDefinition classDefinition) {
	...
	public Document write(List<TableDefinition> rows) {
		...
		for (TableDefinition classDefinition : rows) {
			...
			ColumnDefinition idField = classDefinition.getIdField();
			if (idField != null) {
			...
			Map<String, ColumnDefinition> fields = classDefinition.getFields();
