...
public class XmlBuilderThread extends Thread {
	protected final static Log logger = LogFactory.getLog(XmlBuilderThread.class);
	...
	public XmlBuilderThread(String systemName, byte[] bytes, Map<String, Object> paramMap, String filename, int index) {
	...
	public void run() {
		...
		while (retry < 3 && !success) {
			...
			try {
				...
				if (doc != null) {
					FileUtils.save(filename, Dom4jUtils.getBytesFromPrettyDocument(doc, "GBK"));
