...
public class BlobItemQuery extends DataQuery {
	...
	public BlobItemQuery createDateGreaterThanOrEqual(Date createDateGreaterThanOrEqual) {
	...
	public BlobItemQuery createDateLessThanOrEqual(Date createDateLessThanOrEqual) {
	...
	public BlobItemQuery lastModifiedGreaterThanOrEqual(Long lastModifiedGreaterThanOrEqual) {
	...
	public BlobItemQuery lastModifiedLessThanOrEqual(Long lastModifiedLessThanOrEqual) {
