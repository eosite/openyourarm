...
public class ResourceFactory {
	...
	protected static List<String> regions = new CopyOnWriteArrayList<String>();

	protected static Cache<String, byte[]> cache = CacheBuilder.newBuilder().maximumSize(50000)
