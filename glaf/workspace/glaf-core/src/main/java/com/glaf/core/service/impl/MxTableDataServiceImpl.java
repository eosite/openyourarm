...
public class MxTableDataServiceImpl implements ITableDataService {
	protected final static Log logger = LogFactory.getLog(MxTableDataServiceImpl.class);
	...
	public void insertTableData(String tableName, List<Map<String, Object>> rows) {
		...
		if (tableDefinition != null) {
			...
			List<ColumnDefinition> columns = tableDefinitionService.getColumnDefinitionsByTableName(tableName);
					...
					for (ColumnDefinition column : columns) {
						...
						if (value == null) {
							if (column.getName() != null) {
								...
								if (value == null) {
									value = dataMap.get(column.getName().toUpperCase());
								}
							}
						}
						if (value != null) {
	...
	@Transactional
	public void saveAll(String tableName, String seqNo, Collection<TableModel> rows) {
		TableDefinition tableDefinition = tableDefinitionService.getTableDefinition(tableName);
	...
	@Transactional
	public void saveOrUpdate(String tableName, boolean updatable, List<Map<String, Object>> rows) {
		tableName = tableName.toUpperCase();
		TableDefinition tableDefinition = tableDefinitionService.getTableDefinition(tableName);
		if (tableDefinition != null) {
			if (tableDefinition.getTableName() != null) {
