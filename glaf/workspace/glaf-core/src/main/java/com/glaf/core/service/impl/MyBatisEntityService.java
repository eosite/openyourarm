...
public class MyBatisEntityService implements EntityService {
	...
	public void updateNextId(String name, long nextId) {
		...
		tableModel.setTableName("SYS_DBID");

		ColumnModel idColumn = new ColumnModel();
		idColumn.setColumnName("NAME_");
		idColumn.setJavaType("String");
		idColumn.setValue(name);
		tableModel.setIdColumn(idColumn);

		ColumnModel nextIdColumn = new ColumnModel();
		nextIdColumn.setColumnName("VALUE_");
		nextIdColumn.setJavaType("String");
		nextIdColumn.setValue(String.valueOf(nextId));
		tableModel.addColumn(nextIdColumn);
