...
public class MxTreeModelResource {
	protected static final Log logger = LogFactory.getLog(MxTreeModelResource.class);

	protected ITreeModelService treeModelService;

	protected JSONObject fillTreeDataChildren(TreeModel treeNode) throws JSONException {
	...
	protected JSONObject getTreeData(String code) throws JSONException {
		...
		if (treeNode != null) {
			treeNode = treeModelService.getTreeModelWithAllChildren(treeNode.getId());
