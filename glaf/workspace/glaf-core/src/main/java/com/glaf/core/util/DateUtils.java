...
public class DateUtils {
	...
	public static void main(String[] args) {
		System.out.println(DateUtils.getDateTime(DateUtils.toDate("2017-10-24 1024:43i")));
		System.out.println(DateUtils.getDateTime(DateUtils.toDate("2017-10-16 0724:2i:")));
		System.out.println(DateUtils.getDateTime(DateUtils.toDate("2017-10-16 0924:48i")));
	...
	public static Date toDate(String dateString) {
		...
		try {
			if (dateString.length() == 4) {
				...
				if (dateString.endsWith("i") || dateString.endsWith("i:")) {
					parsePatterns[0] = DATE_PATTERN;
