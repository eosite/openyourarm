...
public class TableDefinition implements java.io.Serializable, java.lang.Comparable<TableDefinition> {
	 ...
	 * 聚合数据集编号
	 */
	@Column(name = "AGGR_DATASETIDS_", length = 500)
	protected String aggregationDatasetIds;
	...
	public String getAggregationDatasetIds() {
		return aggregationDatasetIds;
	}
	...
	public void setAggregationDatasetIds(String aggregationDatasetIds) {
		this.aggregationDatasetIds = aggregationDatasetIds;
	}
