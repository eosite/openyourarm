...
public class MxSystemSchedulerController {
	protected static final Log logger = LogFactory.getLog(MxSystemSchedulerController.class);
	...
	public ModelAndView save(HttpServletRequest request, ModelMap modelMap) {
		...
		scheduler.setBusinessType(request.getParameter("businessType"));
		...
		String jobDataMapStr = MapUtils.getString(params, "jobDataMap");
		
		if(MapUtils.isEmpty(scheduler.getJobDataMap()) && //
				StringUtils.isNotBlank(jobDataMapStr)){
			JSONObject jsonObject = JSONObject.parseObject(jobDataMapStr);
			
			for(String key : jsonObject.keySet()){
				scheduler.getJobDataMap().put(key, jsonObject.getObject(key, SchedulerParam.class));
			}
