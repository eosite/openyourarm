...
@Controller("/rs/sys/accessLog")
@Path("/rs/sys/accessLog")
public class SysAccessLogResource {
	protected static final Log logger = LogFactory.getLog(SysAccessLogResource.class);
