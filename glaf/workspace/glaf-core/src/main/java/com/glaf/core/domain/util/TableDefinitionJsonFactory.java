...
public class TableDefinitionJsonFactory {
	...
	public static TableDefinition jsonToObject(JSONObject jsonObject) {
		...
		if (jsonObject.containsKey("aggregationDatasetIds")) {
			model.setAggregationDatasetIds(jsonObject.getString("aggregationDatasetIds"));
		}
		...
		if (jsonObject.containsKey("aggregationQueryIds")) {
			model.setAggregationQueryIds(jsonObject.getString("aggregationQueryIds"));
		}
	...
	public static JSONObject toJsonObject(TableDefinition model) {
		...
		if (model.getParentTableName() != null) {
			...
			jsonObject.put("parentTableName_enc", RequestUtils.encodeString(model.getParentTableName()));
		}
		...
		if (model.getAggregationDatasetIds() != null) {
			jsonObject.put("aggregationDatasetIds", model.getAggregationDatasetIds());
		}
		if (model.getQueryIds() != null) {
			jsonObject.put("queryIds", model.getQueryIds());
		}
		if (model.getAggregationQueryIds() != null) {
			jsonObject.put("aggregationQueryIds", model.getAggregationQueryIds());
		}
