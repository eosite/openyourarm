 ...
 *
 */
public class DynamicSqlTreeDomainFactory {

	public static final String TABLENAME = "SYS_DYNAMIC_SQL_TREE";
	...
	public static TableDefinition getTableDefinition(String tableName) {
		...
		tableDefinition.setName("DynamicSqlTree");
	...
	private DynamicSqlTreeDomainFactory() {
