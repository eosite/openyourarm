...
public class TableTransformTask extends RecursiveTask<Boolean> {
	public final static Log logger = LogFactory.getLog(TableTransformTask.class);
	...
	public TableTransformTask(long databaseId, String tableName, String jobNo, Map<String, Object> parameter) {
