 ...
 *
 */
public class HavingSegmentJsonFactory {

	public static HavingSegment jsonToObject(JSONObject jsonObject) {
		HavingSegment model = new HavingSegment();
	...
	public static JSONObject toJsonObject(HavingSegment model) {
	...
	public static ObjectNode toObjectNode(HavingSegment model) {
	...
	public static JSONArray listToArray(java.util.List<HavingSegment> list) {
		JSONArray array = new JSONArray();
		if (list != null && !list.isEmpty()) {
			for (HavingSegment model : list) {
	...
	public static java.util.List<HavingSegment> arrayToList(JSONArray array) {
		java.util.List<HavingSegment> list = new java.util.ArrayList<HavingSegment>();
		for (int i = 0, len = array.size(); i < len; i++) {
			JSONObject jsonObject = array.getJSONObject(i);
			HavingSegment model = jsonToObject(jsonObject);
			list.add(model);
		}
		return list;
	}

	private HavingSegmentJsonFactory() {
