...
public class TableSyntheticAction extends RecursiveAction {
	...
	public TableSyntheticAction(long sourceDatabaseId, long targetDatabaseId, long tableSyntheticId) {
	...
	public void execute() {
		...
		log.setJobNo("table_synthetic_" + tableSyntheticId + "_" + sourceDatabaseId + "_" + targetDatabaseId + "_"
				+ log.getRunDay());
