 ...
 *
 */
public class TableSyncJsonFactory {

	public static java.util.List<TableSync> arrayToList(JSONArray array) {
		java.util.List<TableSync> list = new java.util.ArrayList<TableSync>();
		for (int i = 0, len = array.size(); i < len; i++) {
			JSONObject jsonObject = array.getJSONObject(i);
			TableSync model = jsonToObject(jsonObject);
			list.add(model);
		}
		return list;
	}

	public static TableSync jsonToObject(JSONObject jsonObject) {
		TableSync model = new TableSync();
		...
		if (jsonObject.containsKey("sourceDatabaseId")) {
			model.setSourceDatabaseId(jsonObject.getLong("sourceDatabaseId"));
		}
	...
	public static JSONArray listToArray(java.util.List<TableSync> list) {
		JSONArray array = new JSONArray();
		if (list != null && !list.isEmpty()) {
			for (TableSync model : list) {
	...
	public static JSONObject toJsonObject(TableSync model) {
	...
	public static ObjectNode toObjectNode(TableSync model) {
