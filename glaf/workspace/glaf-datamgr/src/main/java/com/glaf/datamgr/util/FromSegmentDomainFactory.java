 ...
 *
 */
public class FromSegmentDomainFactory {

	public static final String TABLENAME = "SYS_DATA_FROM";
	...
	public static TableDefinition getTableDefinition(String tableName) {
		...
		tableDefinition.setName("FromSegment");
	...
	private FromSegmentDomainFactory() {
