...
public class TaskTableTask extends RecursiveTask<Boolean> {
	public final static Log logger = LogFactory.getLog(TaskTableTask.class);
	...
	public TaskTableTask(long databaseId, long taskTableId, String jobNo, Map<String, Object> parameter) {
