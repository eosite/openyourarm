 ...
 *
 */
public class DataPermissionDomainFactory {

	public static final String TABLENAME = "SYS_DATA_PERMISSION";
	...
	static {
		...
		columnMap.put("businessType", "BUSINESSTYPE_");
		columnMap.put("accessType", "ACCESSTYPE_");
		columnMap.put("userId", "USERID_");
		columnMap.put("roleId", "ROLEID_");
		...
		javaTypeMap.put("businessType", "String");
		javaTypeMap.put("accessType", "String");
		javaTypeMap.put("userId", "String");
		javaTypeMap.put("roleId", "String");
	...
	public static TableDefinition getTableDefinition(String tableName) {
		...
		tableDefinition.setName("DataPermission");
		...
		ColumnDefinition businessType = new ColumnDefinition();
		businessType.setName("businessType");
		businessType.setColumnName("BUSINESSTYPE_");
		businessType.setJavaType("String");
		businessType.setLength(50);
		tableDefinition.addColumn(businessType);
		...
		roleId.setColumnName("ROLEID_");
		roleId.setJavaType("String");
		roleId.setLength(50);
	...
	private DataPermissionDomainFactory() {
