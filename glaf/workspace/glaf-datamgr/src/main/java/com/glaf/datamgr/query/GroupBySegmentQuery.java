...
public class GroupBySegmentQuery extends DataQuery {
	...
	public GroupBySegmentQuery() {

	}

	public GroupBySegmentQuery createBy(String createBy) {
		if (createBy == null) {
	...
	public GroupBySegmentQuery createBys(List<String> createBys) {
		if (createBys == null) {
	...
	public GroupBySegmentQuery createTimeGreaterThanOrEqual(
	...
	public GroupBySegmentQuery createTimeLessThanOrEqual(
	...
	public GroupBySegmentQuery datasetId(String datasetId) {
		if (datasetId == null) {
	...
	public GroupBySegmentQuery datasetIds(List<String> datasetIds) {
		if (datasetIds == null) {
	...
	public GroupBySegmentQuery tableName(String tableName) {
		if (tableName == null) {
	...
	public GroupBySegmentQuery tableNameLike(String tableNameLike) {
	...
	public GroupBySegmentQuery tableNames(List<String> tableNames) {
		if (tableNames == null) {
	...
	public GroupBySegmentQuery updateBy(String updateBy) {
		if (updateBy == null) {
	...
	public GroupBySegmentQuery updateBys(List<String> updateBys) {
		if (updateBys == null) {
	...
	public GroupBySegmentQuery updateTimeGreaterThanOrEqual(
			Date updateTimeGreaterThanOrEqual) {
	...
	public GroupBySegmentQuery updateTimeLessThanOrEqual(
