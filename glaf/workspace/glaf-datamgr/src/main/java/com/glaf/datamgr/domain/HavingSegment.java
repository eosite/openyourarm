...
@Entity
@Table(name = "SYS_DATA_HAVING")
public class HavingSegment implements Serializable, JSONable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		HavingSegment other = (HavingSegment) obj;
		if (id == null) {
			if (other.id != null)
				return false;
	...
	public HavingSegment jsonToObject(JSONObject jsonObject) {
		return HavingSegmentJsonFactory.jsonToObject(jsonObject);
	}
	...
	public JSONObject toJsonObject() {
		return HavingSegmentJsonFactory.toJsonObject(this);
	}

	public ObjectNode toObjectNode() {
		return HavingSegmentJsonFactory.toObjectNode(this);
	}
