...
@Entity
@Table(name = "SYS_SQL_EXPORT")
public class SqlExport implements Serializable, JSONable {
	 ...
	 * 数据集编号
	 */
	@Column(name = "DATASETIDS_", length = 2000)
	protected String datasetIds;

	/**
	 * SQL语句定义
	 */
	@Column(name = "SQLDEFIDS_", length = 500)
	protected String sqlDefIds;
	...
	public String getSqlDefIds() {
		return this.sqlDefIds;
	}
	...
	public SqlExport jsonToObject(JSONObject jsonObject) {
		return SqlExportJsonFactory.jsonToObject(jsonObject);
	}
	...
	public void setSqlDefIds(String sqlDefIds) {
	...
	public JSONObject toJsonObject() {
		return SqlExportJsonFactory.toJsonObject(this);
	}

	public ObjectNode toObjectNode() {
		return SqlExportJsonFactory.toObjectNode(this);
	}
