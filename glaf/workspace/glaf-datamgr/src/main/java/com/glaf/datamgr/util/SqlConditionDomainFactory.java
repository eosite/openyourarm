 ...
 *
 */
public class SqlConditionDomainFactory {

	public static final String TABLENAME = "SYS_SQL_CONDITION";
	...
	static {
		...
		columnMap.put("segment", "SEGMENT_");
		...
		javaTypeMap.put("segment", "String");
	...
	public static TableDefinition getTableDefinition(String tableName) {
		...
		tableDefinition.setName("SqlCondition");
		...
		operator.setLength(10);
		tableDefinition.addColumn(operator);

		ColumnDefinition segment = new ColumnDefinition();
		segment.setName("segment");
		segment.setColumnName("SEGMENT_");
		segment.setJavaType("Clob");
		tableDefinition.addColumn(segment);
	...
	private SqlConditionDomainFactory() {
