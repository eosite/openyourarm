...
import com.glaf.datamgr.bean.AccessDBHelper;
import com.zaxxer.hikari.HikariDataSource;

public class AccessParser implements Parser {

	public static void main(String[] args) throws Exception {
		String mappingFile = "./report/mapping/SKU2.mapping.xml";
		String dataFile = "./report/data/SKU2.mdb";
		...
		AccessParser parser = new AccessParser();
