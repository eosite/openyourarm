...
public class TreeTableSyntheticTask extends RecursiveTask<Boolean> {
	public final static Log logger = LogFactory.getLog(TreeTableSyntheticTask.class);
	...
	public TreeTableSyntheticTask(long sourceDatabaseId, long targetDatabaseId, long tableSyntheticId, String jobNo) {
