...
public class ParameterLogQuery extends DataQuery {
	...
	public ParameterLogQuery businessKey(String businessKey) {
		if (businessKey == null) {
	...
	public ParameterLogQuery statusGreaterThanOrEqual(Integer statusGreaterThanOrEqual) {
	...
	public ParameterLogQuery statusLessThanOrEqual(Integer statusLessThanOrEqual) {
