 ...
 *
 */
public class TableSyncDomainFactory {

	public static final String TABLENAME = "SYS_TABLE_SYNC";
	...
	static {
		...
		columnMap.put("sourceDatabaseId", "SOURCEDATABASEID_");
		...
		javaTypeMap.put("sourceDatabaseId", "Long");
	...
	public static TableDefinition getTableDefinition(String tableName) {
		...
		tableDefinition.setName("TableSync");
		...
		ColumnDefinition sourceDatabaseId = new ColumnDefinition();
		sourceDatabaseId.setName("sourceDatabaseId");
		sourceDatabaseId.setColumnName("SOURCEDATABASEID_");
		sourceDatabaseId.setJavaType("Long");
		tableDefinition.addColumn(sourceDatabaseId);
	...
	private TableSyncDomainFactory() {
