...
public class HavingSegmentQuery extends DataQuery {
	...
	public HavingSegmentQuery() {

	}

	public HavingSegmentQuery createBy(String createBy) {
		if (createBy == null) {
	...
	public HavingSegmentQuery createBys(List<String> createBys) {
		if (createBys == null) {
	...
	public HavingSegmentQuery createTimeGreaterThanOrEqual(
	...
	public HavingSegmentQuery createTimeLessThanOrEqual(
	...
	public HavingSegmentQuery datasetId(String datasetId) {
		if (datasetId == null) {
	...
	public HavingSegmentQuery datasetIds(List<String> datasetIds) {
		if (datasetIds == null) {
	...
	public HavingSegmentQuery tableName(String tableName) {
		if (tableName == null) {
	...
	public HavingSegmentQuery tableNameLike(String tableNameLike) {
	...
	public HavingSegmentQuery tableNames(List<String> tableNames) {
		if (tableNames == null) {
	...
	public HavingSegmentQuery updateBy(String updateBy) {
		if (updateBy == null) {
	...
	public HavingSegmentQuery updateBys(List<String> updateBys) {
		if (updateBys == null) {
	...
	public HavingSegmentQuery updateTimeGreaterThanOrEqual(
			Date updateTimeGreaterThanOrEqual) {
	...
	public HavingSegmentQuery updateTimeLessThanOrEqual(
