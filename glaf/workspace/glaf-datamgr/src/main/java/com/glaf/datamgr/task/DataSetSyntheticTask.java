...
public class DataSetSyntheticTask extends RecursiveTask<Boolean> {
	public final static Log logger = LogFactory.getLog(DataSetSyntheticTask.class);
	...
	public DataSetSyntheticTask(long sourceDatabaseId, long targetDatabaseId, long dataSetSyntheticId, String jobNo) {
