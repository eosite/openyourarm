 ...
 *
 */
public class OrderBySegmentDomainFactory {

	public static final String TABLENAME = "SYS_DATA_ORDERBY";
	...
	public static TableDefinition getTableDefinition(String tableName) {
		...
		tableDefinition.setName("OrderBySegment");
	...
	private OrderBySegmentDomainFactory() {
