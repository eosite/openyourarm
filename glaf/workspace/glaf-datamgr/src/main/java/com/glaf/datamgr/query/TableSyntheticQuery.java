...
public class TableSyntheticQuery extends DataQuery {
	...
	public TableSyntheticQuery() {

	}

	public TableSyntheticQuery createTableFlag(String createTableFlag) {
	...
	public TableSyntheticQuery createTimeGreaterThanOrEqual(Date createTimeGreaterThanOrEqual) {
	...
	public TableSyntheticQuery createTimeLessThanOrEqual(Date createTimeLessThanOrEqual) {
	...
	public TableSyntheticQuery deleteFetch(String deleteFetch) {
		if (deleteFetch == null) {
	...
	public TableSyntheticQuery insertOnly(String insertOnly) {
		if (insertOnly == null) {
	...
	public TableSyntheticQuery locked(Integer locked) {
		if (locked == null) {
	...
	public TableSyntheticQuery name(String name) {
		if (name == null) {
	...
	public TableSyntheticQuery scheduleFlag(String scheduleFlag) {
	...
	public TableSyntheticQuery sourceDatabaseIds(Long sourceDatabaseIds) {
	...
	public TableSyntheticQuery sourceTableName(String sourceTableName) {
	...
	public TableSyntheticQuery syncStatus(Integer syncStatus) {
		if (syncStatus == null) {
	...
	public TableSyntheticQuery syncTimeGreaterThanOrEqual(Date syncTimeGreaterThanOrEqual) {
	...
	public TableSyntheticQuery syncTimeLessThanOrEqual(Date syncTimeLessThanOrEqual) {
	...
	public TableSyntheticQuery targetTableName(String targetTableName) {
	...
	public TableSyntheticQuery titleLike(String titleLike) {
		if (titleLike == null) {
	...
	public TableSyntheticQuery type(String type) {
		if (type == null) {
