 ...
 *
 */
public class ParameterLogDomainFactory {

	public static final String TABLENAME = "SYS_PARAM_LOG";
	...
	public static TableDefinition getTableDefinition(String tableName) {
		...
		tableDefinition.setName("ParameterLog");
	...
	private ParameterLogDomainFactory() {
