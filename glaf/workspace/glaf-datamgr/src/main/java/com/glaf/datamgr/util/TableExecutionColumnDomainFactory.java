 ...
 *
 */
public class TableExecutionColumnDomainFactory {

	public static final String TABLENAME = "SYS_TABLE_EXECUTION_COLUMN";
	...
	static {
		...
		columnMap.put("executionId", "EXECUTIONID_");
		...
		javaTypeMap.put("executionId", "String");
	...
	public static TableDefinition getTableDefinition(String tableName) {
		...
		tableDefinition.setName("TableExecutionColumn");
		...
		ColumnDefinition executionId = new ColumnDefinition();
		executionId.setName("executionId");
		executionId.setColumnName("EXECUTIONID_");
		executionId.setJavaType("String");
		executionId.setLength(50);
		tableDefinition.addColumn(executionId);
	...
	private TableExecutionColumnDomainFactory() {
