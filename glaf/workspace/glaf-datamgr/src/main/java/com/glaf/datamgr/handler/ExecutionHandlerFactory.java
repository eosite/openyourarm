...
import com.glaf.datamgr.config.HandlerProperties;
...
public class ExecutionHandlerFactory {
	...
	static {
		handlerMap.put("task_table", new TaskTableHandler());
		handlerMap.put("table_sync", new TableSyncHandler());
		handlerMap.put("table_transform", new TableTransformHandler());
		handlerMap.put("table_combination", new TableCombinationHandler());
		handlerMap.put("table_synthetic", new TableSyntheticHandler());
		handlerMap.put("dataset_synthetic", new DataSetSyntheticHandler());
		handlerMap.put("treetable_synthetic", new TreeTableSyntheticHandler());
