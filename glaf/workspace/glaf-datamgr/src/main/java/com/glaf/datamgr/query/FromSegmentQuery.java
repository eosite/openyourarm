...
public class FromSegmentQuery extends DataQuery {
	...
	public FromSegmentQuery() {

	}

	public FromSegmentQuery createBy(String createBy) {
		if (createBy == null) {
	...
	public FromSegmentQuery createBys(List<String> createBys) {
		if (createBys == null) {
	...
	public FromSegmentQuery createTimeGreaterThanOrEqual(
	...
	public FromSegmentQuery createTimeLessThanOrEqual(
	...
	public FromSegmentQuery datasetId(String datasetId) {
		if (datasetId == null) {
	...
	public FromSegmentQuery datasetIds(List<String> datasetIds) {
		if (datasetIds == null) {
	...
	public FromSegmentQuery tableName(String tableName) {
		if (tableName == null) {
	...
	public FromSegmentQuery tableNameLike(String tableNameLike) {
	...
	public FromSegmentQuery tableNames(List<String> tableNames) {
		if (tableNames == null) {
	...
	public FromSegmentQuery updateBy(String updateBy) {
		if (updateBy == null) {
	...
	public FromSegmentQuery updateBys(List<String> updateBys) {
		if (updateBys == null) {
	...
	public FromSegmentQuery updateTimeGreaterThanOrEqual(
			Date updateTimeGreaterThanOrEqual) {
	...
	public FromSegmentQuery updateTimeLessThanOrEqual(
