...
public class ColumnTransformController {
	...
	public ModelAndView edit(HttpServletRequest request, ModelMap modelMap) {
		...
		if (columnTransform != null) {
			...
			tableName = columnTransform.getTableName();
		}

		List<ColumnTransform> cols = columnTransformService.getColumnTransforms(tableName);

		TableTransform tableTransform = tableTransformService.getTableTransform(tableName);
		...
		return new ModelAndView("/datamgr/columnTransform/edit", modelMap);
	}
	...
	public ModelAndView list(HttpServletRequest request, ModelMap modelMap) {
		...
		return new ModelAndView("/datamgr/columnTransform/list", modelMap);
	}
	...
	public ModelAndView query(HttpServletRequest request, ModelMap modelMap) {
		...
		return new ModelAndView("/datamgr/columnTransform/query", modelMap);
	}
	...
	public @ResponseBody ColumnTransform saveOrUpdate(HttpServletRequest request,
			@RequestBody Map<String, Object> model) {
		User user = RequestUtils.getUser(request);
		String actorId = user.getActorId();
		ColumnTransform columnTransform = new ColumnTransform();
		try {
			Tools.populate(columnTransform, model);
			columnTransform.setName(request.getParameter("name"));
			columnTransform.setTitle(request.getParameter("title"));
			columnTransform.setTableName(request.getParameter("tableName"));
			columnTransform.setColumnName(request.getParameter("columnName"));
	...
	public ModelAndView view(HttpServletRequest request, ModelMap modelMap) {
		...
		return new ModelAndView("/datamgr/columnTransform/view");
	}
