 ...
 *
 */
public class TableExecutionDomainFactory {

	public static final String TABLENAME = "SYS_TABLE_EXECUTION";
	...
	public static TableDefinition getTableDefinition(String tableName) {
		...
		tableDefinition.setName("TableExecution");
	...
	private TableExecutionDomainFactory() {
