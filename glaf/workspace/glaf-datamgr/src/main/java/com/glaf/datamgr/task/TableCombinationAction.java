...
public class TableCombinationAction extends RecursiveAction {
	...
	public TableCombinationAction(long sourceDatabaseId, long targetDatabaseId, long tableCombinationId) {
	...
	public void execute() {
		...
		log.setJobNo("table_combination_" + tableCombinationId + "_" + sourceDatabaseId + "_" + targetDatabaseId + "_"
				+ log.getRunDay());
