 ...
 *
 */
public class DataExportDomainFactory {

	public static final String TABLENAME = "SYS_DATA_EXPORT";
	...
	static {
		...
		columnMap.put("exportName", "EXPORTNAME_");
		columnMap.put("exportType", "EXPORTTYPE_");
		columnMap.put("lastExportStatus", "LASTEXPORTSTATUS_");
		columnMap.put("lastExportTime", "LASTEXPORTTIME_");
		columnMap.put("tables", "TABLES_");
		...
		javaTypeMap.put("exportName", "String");
		javaTypeMap.put("exportType", "String");
		javaTypeMap.put("lastExportStatus", "Integer");
		javaTypeMap.put("lastExportTime", "Date");
		javaTypeMap.put("tables", "String");
	...
	public static TableDefinition getTableDefinition(String tableName) {
		...
		tableDefinition.setName("DataExport");
		...
		ColumnDefinition exportName = new ColumnDefinition();
		exportName.setName("exportName");
		exportName.setColumnName("EXPORTNAME_");
		exportName.setJavaType("String");
		exportName.setLength(50);
		tableDefinition.addColumn(exportName);

		ColumnDefinition exportType = new ColumnDefinition();
		exportType.setName("exportType");
		exportType.setColumnName("EXPORTTYPE_");
		exportType.setJavaType("String");
		exportType.setLength(20);
		tableDefinition.addColumn(exportType);
		...
		ColumnDefinition tables = new ColumnDefinition();
		tables.setName("tables");
		tables.setColumnName("TABLES_");
		tables.setJavaType("String");
		tables.setLength(2000);
		tableDefinition.addColumn(tables);
	...
	private DataExportDomainFactory() {
