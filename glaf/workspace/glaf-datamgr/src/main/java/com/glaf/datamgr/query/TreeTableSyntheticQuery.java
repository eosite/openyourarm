...
public class TreeTableSyntheticQuery extends DataQuery {
	...
	public TreeTableSyntheticQuery() {

	}

	public TreeTableSyntheticQuery createTimeGreaterThanOrEqual(Date createTimeGreaterThanOrEqual) {
	...
	public TreeTableSyntheticQuery createTimeLessThanOrEqual(Date createTimeLessThanOrEqual) {
	...
	public TreeTableSyntheticQuery deleteFlag(Integer deleteFlag) {
		if (deleteFlag == null) {
	...
	public String getOrderBy() {
		if (sortColumn != null) {
			...
			if ("syntheticFlag".equals(sortColumn)) {
				orderBy = "E.SYNTHETICFLAG_" + a_x;
			}
	...
	public void initQueryColumns() {
		...
		addColumn("syntheticFlag", "SYNTHETICFLAG_");
	...
	public TreeTableSyntheticQuery name(String name) {
		if (name == null) {
	...
	public TreeTableSyntheticQuery nameLike(String nameLike) {
		if (nameLike == null) {
			throw new RuntimeException("name is null");
		}
	...
	public TreeTableSyntheticQuery sourceTableName(String sourceTableName) {
	...
	public TreeTableSyntheticQuery sourceTableNameLike(String sourceTableNameLike) {
	...
	public TreeTableSyntheticQuery syncStatus(Integer syncStatus) {
		if (syncStatus == null) {
	...
	public TreeTableSyntheticQuery syncTimeGreaterThanOrEqual(Date syncTimeGreaterThanOrEqual) {
	...
	public TreeTableSyntheticQuery syncTimeLessThanOrEqual(Date syncTimeLessThanOrEqual) {
	...
	public TreeTableSyntheticQuery syntheticFlag(String syntheticFlag) {
		if (syntheticFlag == null) {
			throw new RuntimeException("syntheticFlag is null");
		}
		this.syntheticFlag = syntheticFlag;
		return this;
	}

	public TreeTableSyntheticQuery targetTableName(String targetTableName) {
	...
	public TreeTableSyntheticQuery targetTableNameLike(String targetTableNameLike) {
	...
	public TreeTableSyntheticQuery titleLike(String titleLike) {
		if (titleLike == null) {
	...
	public TreeTableSyntheticQuery type(String type) {
		if (type == null) {
	...
	public TreeTableSyntheticQuery updateTimeGreaterThanOrEqual(Date updateTimeGreaterThanOrEqual) {
	...
	public TreeTableSyntheticQuery updateTimeLessThanOrEqual(Date updateTimeLessThanOrEqual) {
