 ...
 *
 */
public class SqlParameterDomainFactory {

	public static final String TABLENAME = "SYS_SQL_PARAM";
	...
	public static TableDefinition getTableDefinition(String tableName) {
		...
		tableDefinition.setName("SqlParameter");
	...
	private SqlParameterDomainFactory() {
