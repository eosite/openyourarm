 ...
 *
 */
public class WhereSegmentDomainFactory {

	public static final String TABLENAME = "SYS_DATA_WHERE";
	...
	public static TableDefinition getTableDefinition(String tableName) {
		...
		tableDefinition.setName("WhereSegment");
	...
	private WhereSegmentDomainFactory() {
