 ...
 *
 */
public class DataSetSyntheticDomainFactory {

	public static final String TABLENAME = "SYS_DATASET_SYNTHETIC";
	...
	static {
		...
		columnMap.put("sourceDataSetId", "SOURCEDATASETID_");
		columnMap.put("primaryKey", "PRIMARYKEY_");
		columnMap.put("aggregationKeys", "AGGREGATIONKEYS_");
		...
		javaTypeMap.put("sourceDataSetId", "String");
		javaTypeMap.put("primaryKey", "String");
		javaTypeMap.put("aggregationKeys", "String");
	...
	public static TableDefinition getTableDefinition(String tableName) {
		...
		tableDefinition.setName("DataSetSynthetic");
		...
		ColumnDefinition sourceDataSetId = new ColumnDefinition();
		sourceDataSetId.setName("sourceDataSetId");
		sourceDataSetId.setColumnName("SOURCEDATASETID_");
		sourceDataSetId.setJavaType("String");
		sourceDataSetId.setLength(50);
		tableDefinition.addColumn(sourceDataSetId);
		...
		ColumnDefinition aggregationKeys = new ColumnDefinition();
		aggregationKeys.setName("aggregationKeys");
		aggregationKeys.setColumnName("AGGREGATIONKEYS_");
		aggregationKeys.setJavaType("String");
		aggregationKeys.setLength(2000);
		tableDefinition.addColumn(aggregationKeys);
	...
	private DataSetSyntheticDomainFactory() {
