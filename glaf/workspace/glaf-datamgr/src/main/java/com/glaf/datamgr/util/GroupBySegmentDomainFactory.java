 ...
 *
 */
public class GroupBySegmentDomainFactory {

	public static final String TABLENAME = "SYS_DATA_GROUPBY";
	...
	public static TableDefinition getTableDefinition(String tableName) {
		...
		tableDefinition.setName("GroupBySegment");
	...
	private GroupBySegmentDomainFactory() {
