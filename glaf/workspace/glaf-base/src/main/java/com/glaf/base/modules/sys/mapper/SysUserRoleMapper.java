...
public interface SysUserRoleMapper {
	...
	List<String> getDepartRoleUsers(@Param("deptCodes")List<String> deptCodes,@Param("roleId")String roleId);
	
	List<String> getDepartRolesUsers(@Param("deptCode")String deptCode,@Param("roleIds")List<String> roleIds);
}
