...
public class SysDepartmentJsonFactory {
	...
	public static SysDepartment jsonToObject(JSONObject jsonObject) {
		...
		if (jsonObject.containsKey("tree")) {
			JSONObject json = jsonObject.getJSONObject("tree");
			SysTree tree = SysTreeJsonFactory.jsonToObject(json);
			model.setNode(tree);
		}

		if (jsonObject.containsKey("parent")) {
			JSONObject json = jsonObject.getJSONObject("parent");
			SysDepartment parent = jsonToObject(json);
	...
	public static JSONObject toJsonObject(SysDepartment model) {
		...
		if (model.getNode() != null) {
			jsonObject.put("tree", model.getNode().toJsonObject());
		}

		if (model.getParent() != null) {
			jsonObject.put("parent", model.getParent().toJsonObject());
		}
	...
	public static ObjectNode toObjectNode(SysDepartment model) {
		...
		if (model.getNode() != null) {
			jsonObject.set("tree", model.getNode().toObjectNode());
		}

		if (model.getParent() != null) {
			jsonObject.set("parent", model.getParent().toObjectNode());
		}
