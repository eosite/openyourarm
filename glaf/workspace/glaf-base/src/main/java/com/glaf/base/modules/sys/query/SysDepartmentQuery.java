...
public class SysDepartmentQuery extends DataQuery {
	...
	public SysDepartmentQuery createTimeGreaterThanOrEqual(Date createTimeGreaterThanOrEqual) {
	...
	public SysDepartmentQuery createTimeLessThanOrEqual(Date createTimeLessThanOrEqual) {
	...
	public SysDepartmentQuery levelGreaterThanOrEqual(Integer levelGreaterThanOrEqual) {
	...
	public SysDepartmentQuery sortGreaterThanOrEqual(Integer sortGreaterThanOrEqual) {
