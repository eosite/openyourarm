...
public interface SysRoleMapper {
	...
	List<SysRole> getSysRolesByAppId_oracle(long appId);

	List<SysRole> getSysRolesByAppId_postgresql(long appId);

	List<SysRole> getSysRolesOfUser(String actorId);
	
	List<SysRole> getSysRolesOfUser_oracle(String actorId);

	List<SysRole> getSysRolesOfUser_postgresql(String actorId);

	void insertSysRole(SysRole model);
	
	void insertSysRoleWithId(SysRole model);
