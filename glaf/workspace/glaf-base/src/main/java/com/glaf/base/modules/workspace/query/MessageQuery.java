...
public class MessageQuery extends DataQuery {
	...
	protected String recverId;
	protected List<String> recverIds;
	...
	public List<String> getRecverIds() {
		return recverIds;
	}
	...
	public MessageQuery recverId(String recverId) {
		if (recverId == null) {
	...
	public MessageQuery recverIds(List<String> recverIds) {
		if (recverIds == null) {
	...
	public void setRecverIds(List<String> recverIds) {
		this.recverIds = recverIds;
	}
