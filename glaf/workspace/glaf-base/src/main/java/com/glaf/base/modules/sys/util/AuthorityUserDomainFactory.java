 ...
 *
 */
public class AuthorityUserDomainFactory {

	public static final String TABLENAME = "SYS_AUTHORITY_USER";
	...
	public static TableDefinition getTableDefinition(String tableName) {
		...
		tableDefinition.setName("AuthorityUser");
	...
	private AuthorityUserDomainFactory() {
