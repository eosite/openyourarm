...
public class PostJsonFactory {

	public static java.util.List<Post> arrayToList(JSONArray array) {
		java.util.List<Post> list = new java.util.ArrayList<Post>();
		for (int i = 0; i < array.size(); i++) {
			JSONObject jsonObject = array.getJSONObject(i);
			Post model = jsonToObject(jsonObject);
			list.add(model);
		}
		return list;
	}

	public static Post jsonToObject(JSONObject jsonObject) {
		Post model = new Post();
	...
	public static JSONArray listToArray(java.util.List<Post> list) {
	...
	public static JSONObject toJsonObject(Post model) {
		JSONObject jsonObject = new JSONObject();
		jsonObject.put("id", model.getId());
		jsonObject.put("_id_", model.getId());
		jsonObject.put("_oid_", model.getId());
		jsonObject.put("postId", model.getId());
	...
	public static ObjectNode toObjectNode(Post model) {
