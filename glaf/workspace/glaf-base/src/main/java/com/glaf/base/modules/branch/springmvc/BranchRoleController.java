...
@Controller("/branch/role")
@RequestMapping("/branch/role")
public class BranchRoleController {
	private static final Log logger = LogFactory.getLog(BranchRoleController.class);
	...
	public ModelAndView batchDelete(HttpServletRequest request, ModelMap modelMap) {
		...
		if (ret) {// 成功
			messages.add(ViewMessages.GLOBAL_MESSAGE, new ViewMessage("role.delete_success"));
		} else {// 失败
			messages.add(ViewMessages.GLOBAL_MESSAGE, new ViewMessage("role.delete_failure"));
		}
	...
	public ModelAndView edit(HttpServletRequest request, ModelMap modelMap) {
		...
		return new ModelAndView("/modules/branch/role/edit", modelMap);
	}
	...
	public ModelAndView list(HttpServletRequest request, ModelMap modelMap) {
		...
		return new ModelAndView("/modules/branch/role/list", modelMap);
	}
	...
	public ModelAndView prepareAdd(HttpServletRequest request, ModelMap modelMap) {
		...
		// 显示列表页面
		return new ModelAndView("/modules/branch/role/role_add", modelMap);
	}
	...
	public ModelAndView prepareModify(HttpServletRequest request, ModelMap modelMap) {
		...
		// 显示列表页面
		return new ModelAndView("/modules/branch/role/role_modify", modelMap);
	}
	...
	public ModelAndView privilege(HttpServletRequest request, ModelMap modelMap) {
		...
		// 显示列表页面
		return new ModelAndView("/modules/branch/role/role_privilege", modelMap);
	}
	...
	public ModelAndView roleMenus(HttpServletRequest request, ModelMap modelMap) {
		...
		// 显示列表页面
		return new ModelAndView("/modules/branch/role/roleMenus", modelMap);
	}
	...
	public ModelAndView roleUsers(HttpServletRequest request, ModelMap modelMap) {
		...
		if (sysRole != null && (loginContext.isSystemAdministrator()
				|| StringUtils.equalsIgnoreCase(actorId, sysRole.getCreateBy()))) {
			request.setAttribute("bean", sysRole);
		...
		return new ModelAndView("/modules/branch/role/roleUsers", modelMap);
	}
	...
	public ModelAndView saveAdd(HttpServletRequest request, ModelMap modelMap) {
		...
		ViewMessages messages = new ViewMessages();
		if (ret) {// 保存成功
			messages.add(ViewMessages.GLOBAL_MESSAGE, new ViewMessage("role.add_success"));
		} else {// 保存失败
			messages.add(ViewMessages.GLOBAL_MESSAGE, new ViewMessage("role.add_failure"));
		}
		MessageUtils.addMessages(request, messages);
	...
	public ModelAndView saveModify(HttpServletRequest request, ModelMap modelMap) {
		...
		try {
			...
			if (bean != null) {
				if (loginContext.isSystemAdministrator()
						|| StringUtils.equalsIgnoreCase(loginContext.getActorId(), bean.getCreateBy())) {
					bean.setName(ParamUtil.getParameter(request, "name"));
					bean.setContent(ParamUtil.getParameter(request, "content"));
					bean.setIndexUrl(ParamUtil.getParameter(request, "indexUrl"));
					bean.setIsUseBranch(ParamUtil.getParameter(request, "isUseBranch"));
		...
		ViewMessages messages = new ViewMessages();
		if (ret) {// 保存成功
			messages.add(ViewMessages.GLOBAL_MESSAGE, new ViewMessage("role.modify_success"));
		} else {// 保存失败
			messages.add(ViewMessages.GLOBAL_MESSAGE, new ViewMessage("role.modify_failure"));
		}
		MessageUtils.addMessages(request, messages);
		// 显示列表页面
		return new ModelAndView("/show_msg", modelMap);
	...
	public ModelAndView showList(HttpServletRequest request, ModelMap modelMap) {
		...
		PageResult pager = sysRoleService.getSysRoleList(pageNo, pageSize, query);
		...
		// 显示列表页面
		return new ModelAndView("/modules/branch/role/role_list", modelMap);
	}

	@ResponseBody
	@RequestMapping("/sort")
	public byte[] sort(HttpServletRequest request) {
		long id = ParamUtil.getIntParameter(request, "id", 0);
