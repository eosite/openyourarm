...
import com.glaf.base.modules.sys.mapper.MyFiledotMapper;
...
public class FiledotServiceImpl implements IFiledotService {
	...
	protected MyFiledotMapper myFiledotMapper;
	...
	public int count(FiledotQuery query) {
		...
		return myFiledotMapper.getFiledotCountByQueryCriteria(query);
	}

	@Transactional
	public void deleteById(String id) {
		myFiledotMapper.deleteFiledotById(id);
	}
	...
	public Filedot getFiledot(String id) {
		...
		if (StringUtils.equals(DBUtils.POSTGRESQL,
			...
			filedot = myFiledotMapper.getFiledotById_postgres(id);
		} else {
			filedot = myFiledotMapper.getFiledotById(id);
		}
		return filedot;
	}
	...
	public int getFiledotCount(Map<String, Object> parameter) {
		return myFiledotMapper.getFiledotCount(parameter);
	}
	...
	public List<Filedot> getMyCellTaskFiles(int indexId, int intistasks) {
		...
		return myFiledotMapper.getMyCellTaskFiles(parameter);
	}
	...
	public List<Filedot> getFiledots(Map<String, Object> parameter) {
		return myFiledotMapper.getFiledots(parameter);
	}

	public List<Filedot> getFiledotsByCheckItemId(String proj_chkitem_id) {
		return myFiledotMapper.getFiledotsByCheckItemId(proj_chkitem_id);
	}
	...
	public List<Filedot> getFiledotsOfTreedot(int indexId) {
		return myFiledotMapper.getFiledotsOfTreedot(indexId);
	}
	...
	public List<Filedot> list(FiledotQuery query) {
		...
		List<Filedot> list = myFiledotMapper.getFiledotsByQueryCriteria(query);
		return list;
	}
	...
	public void save(Filedot filedot) {
		if (StringUtils.isEmpty(filedot.getFileID())) {
			...
			myFiledotMapper.insertFiledot(filedot);
		} else {
			...
			if (model != null) {
				...
				myFiledotMapper.updateFiledot(model);
			}
		}
	}
	...
	@javax.annotation.Resource 
	public void setMyFiledotMapper(MyFiledotMapper myFiledotMapper) {
		this.myFiledotMapper = myFiledotMapper;
	}
