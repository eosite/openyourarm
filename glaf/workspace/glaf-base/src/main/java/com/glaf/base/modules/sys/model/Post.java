...
@Entity
@Table(name = "sys_post")
public class Post implements java.lang.Comparable<Post>, Serializable, JSONable {
	...
	public Post jsonToObject(JSONObject jsonObject) {
		return PostJsonFactory.jsonToObject(jsonObject);
	}
	...
	public JSONObject toJsonObject() {
		return PostJsonFactory.toJsonObject(this);
	}

	public ObjectNode toObjectNode() {
		return PostJsonFactory.toObjectNode(this);
	}
