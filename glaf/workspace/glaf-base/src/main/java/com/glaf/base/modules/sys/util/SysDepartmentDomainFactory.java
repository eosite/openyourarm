...
public class SysDepartmentDomainFactory {
	...
	static {
		...
		columnMap.put("telphone", "TELPHONE");
		columnMap.put("principal", "PRINCIPAL");
		columnMap.put("level", "DEPTLEVEL");
		columnMap.put("name", "NAME");
		columnMap.put("anotherName", "ANOTHERNAME");
		columnMap.put("shortName", "SHORTNAME");
		columnMap.put("formalFlag", "FORMALFLAG");
		...
		javaTypeMap.put("telphone", "String");
		javaTypeMap.put("principal", "String");
		javaTypeMap.put("level", "Integer");
		javaTypeMap.put("name", "String");
		javaTypeMap.put("anotherName", "String");
		javaTypeMap.put("shortName", "String");
		javaTypeMap.put("formalFlag", "String");
	...
	public static TableDefinition getTableDefinition(String tableName) {
		...
		ColumnDefinition telphone = new ColumnDefinition();
		telphone.setName("telphone");
		telphone.setColumnName("TELPHONE");
		telphone.setJavaType("String");
		telphone.setLength(100);
		tableDefinition.addColumn(telphone);

		ColumnDefinition principal = new ColumnDefinition();
		principal.setName("principal");
		principal.setColumnName("PRINCIPAL");
		principal.setJavaType("String");
		principal.setLength(200);
		...
		ColumnDefinition anotherName = new ColumnDefinition();
		anotherName.setName("anotherName");
		anotherName.setColumnName("ANOTHERNAME");
		anotherName.setJavaType("String");
		anotherName.setLength(200);
		tableDefinition.addColumn(anotherName);

		ColumnDefinition shortName = new ColumnDefinition();
		shortName.setName("shortName");
		shortName.setColumnName("SHORTNAME");
		shortName.setJavaType("String");
		shortName.setLength(200);
		tableDefinition.addColumn(shortName);

		ColumnDefinition formalFlag = new ColumnDefinition();
		formalFlag.setName("formalFlag");
		formalFlag.setColumnName("FORMALFLAG");
		formalFlag.setJavaType("String");
		formalFlag.setLength(1);
		tableDefinition.addColumn(formalFlag);
