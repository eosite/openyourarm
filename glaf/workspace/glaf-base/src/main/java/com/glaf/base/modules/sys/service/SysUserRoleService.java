...
public interface SysUserRoleService {
	 ...
	 */
	@Transactional
	boolean addRole(String fromUserId, String toUserId, String startDate, String endDate, int mark, String processNames,
	 ...
	 * @return
	 */
	List<String> getDepartRolesUsers(String deptCode, List<String> roleIds);
	 ...
	 * @return
	 */
	List<String> getDepartRoleUsers(List<String> deptCodes, String roleId);
	 ...
	 */
	@Transactional
	void insertAgent(SysUser fromUser, SysUser toUser, String startDate, String endDate, int mark, String processNames);
	 ...
	 */
	@Transactional
	void saveRoleUsers(long roleId, int authorized, List<String> userIds);
	 ...
	 */
	@Transactional
	void saveUserRoles(String userId, int authorized, List<Long> roleIds);
