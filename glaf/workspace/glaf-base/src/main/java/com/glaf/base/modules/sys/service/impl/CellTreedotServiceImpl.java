...
import com.glaf.base.modules.sys.mapper.MyCellTreedotMapper;
...
public class CellTreedotServiceImpl implements ICellTreedotService {
	...
	protected MyCellTreedotMapper myCellTreedotMapper;
	...
	public int count(CellTreedotQuery query) {
		...
		return myCellTreedotMapper.getCellTreedotCountByQueryCriteria(query);
	}

	@Transactional
	public void deleteById(String id) {
		myCellTreedotMapper.deleteCellTreedotById(id);
	}

	public void deleteByPrimaryKey(int indexId) {
		myCellTreedotMapper.deleteCellTreedotByIndexId(indexId);
	}
	...
	public List<CellTreedot> getAllChildrenCellTreedots(int parentId) {
		...
		List<CellTreedot> list = myCellTreedotMapper
				.getCellTreedotsByQueryCriteria(query);
		return list;
	}

	public CellTreedot getCellTreedotById(String id) {
		CellTreedot cellTreedot = myCellTreedotMapper.getCellTreedotById(id);
		return cellTreedot;
	}

	public CellTreedot getCellTreedotByPrimaryKey(int indexId) {
		return myCellTreedotMapper.getCellTreedotByIndexId(indexId);
	}
	...
	public int getCellTreedotCount(Map<String, Object> parameter) {
		return myCellTreedotMapper.getCellTreedotCount(parameter);
	}
	...
	public List<CellTreedot> getCellTreedots(Map<String, Object> parameter) {
		return myCellTreedotMapper.getCellTreedots(parameter);
	}
	...
	public List<CellTreedot> getCellTreedotsByTopId(String topId) {
		return myCellTreedotMapper.getCellTreedotsByTopId(topId);
	}
	...
	public List<CellTreedot> getChildrenCellTreedots(int parentId) {
		return myCellTreedotMapper.getChildrenCellTreedots(parentId);
	}

	public List<CellTreedot> getSystemInitCellTreedots() {
		return myCellTreedotMapper.getCellTreedotsByTopId("system_init");
	}
	...
	public List<CellTreedot> getTopLevelCellTreedotsByTopId(String topId) {
		return myCellTreedotMapper.getTopLevelCellTreedotsByTopId(topId);
	}
	...
	public void save(CellTreedot cellTreedot) {
		if (cellTreedot.getIndexId() == 0) {
			...
			myCellTreedotMapper.insertCellTreedot(cellTreedot);
		} else {
			...
			if (model != null) {
				...
				myCellTreedotMapper.updateCellTreedot(model);
			}
		}
	}

	@javax.annotation.Resource 
	public void setMyCellTreedotMapper(MyCellTreedotMapper myCellTreedotMapper) {
		this.myCellTreedotMapper = myCellTreedotMapper;
	}
