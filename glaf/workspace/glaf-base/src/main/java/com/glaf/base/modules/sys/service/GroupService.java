...
public interface GroupService {
	 ...
	 * @return
	 */
	PageResult getGroupList(String type, String createBy, int pageNo, int pageSize);

	PageResult getGroupList(String type, String createBy, int pageNo, int pageSize, GroupQuery query);
	...
	@Transactional
	void saveOrUpdateGroupLeaders(String groupId, Set<String> userIds);

	@Transactional
	void saveOrUpdateGroupUsers(String groupId, Set<String> userIds);
