 ...
 *
 */
public class ProjectAccessDomainFactory {

	public static final String TABLENAME = "PROJECT_ACCESS";
	...
	public static TableDefinition getTableDefinition(String tableName) {
		...
		tableDefinition.setName("ProjectAccess");
	...
	private ProjectAccessDomainFactory() {
