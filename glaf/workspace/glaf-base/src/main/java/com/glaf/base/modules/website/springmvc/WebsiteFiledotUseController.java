...
@Controller("/cell/websiteFiledotUse")
@RequestMapping("/cell/websiteFiledotUse")
public class WebsiteFiledotUseController {
	protected static final Log logger = LogFactory.getLog(WebsiteFiledotUseController.class);
	...
	public WebsiteFiledotUseController() {
	...
	public void download(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		try {
			...
			if (filedotUse != null && filedotUse.getFileName() != null && filedotUse.getFileContent() != null) {
				ResponseUtils.download(request, response, filedotUse.getFileContent(), filedotUse.getFileName());
			}
		} catch (Exception ex) {
			ex.printStackTrace();
			logger.error(ex);
	...
	public ModelAndView edit(HttpServletRequest request, ModelMap modelMap) {
		...
		FiledotUse filedotUse = filedotUseService.getFiledotUseById(request.getParameter("fileID"));
		if (filedotUse != null) {
	...
	public byte[] json(HttpServletRequest request, ModelMap modelMap) throws IOException {
		...
		if (total > 0) {
			...
			List<FiledotUse> list = filedotUseService.getFiledotUsesByQueryCriteria(start, limit, query);
	...
	public ModelAndView list(HttpServletRequest request, ModelMap modelMap) {
		...
		if (StringUtils.isNotEmpty(frmType)) {
			List<FieldInterface> fields = fieldInterfaceService.getListShowFieldsByFrmType(frmType);
	...
	public @ResponseBody FiledotUse saveOrUpdate(HttpServletRequest request, @RequestBody Map<String, Object> model) {
		FiledotUse filedotUse = new FiledotUse();
		try {
