...
public class AttachmentController {
				...
				if (attachment != null) {
					try {
						String filePath = SystemProperties.getAppPath()
								+ SysConstants.UPLOAD_DIR + attachment.getUrl();
	...
	public void download(HttpServletRequest request,
		...
		String filePath = SystemProperties.getAppPath() + SysConstants.UPLOAD_DIR
				+ attachment.getUrl();
	...
	public void save(HttpServletRequest request,
		...
		if (StringUtils.isNotEmpty(json)) {
			...
			bean.setCreateId(RequestUtil.getLoginUser(request).getActorId());
