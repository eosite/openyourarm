...
public interface SysApplicationMapper {
	...
	List<SysApplication> getSysApplicationsByRoleId(long roleId);

	List<SysApplication> getSysApplicationsByUserId(String userId);

	List<SysApplication> getSysApplicationsByUserId_oracle(String userId);

	List<SysApplication> getSysApplicationsByUserId_postgresql(String userId);
