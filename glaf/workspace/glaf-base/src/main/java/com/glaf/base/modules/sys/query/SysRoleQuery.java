...
public class SysRoleQuery extends DataQuery {
	...
	public SysRoleQuery isUseDept(String isUseDept) {
		if (isUseDept == null) {
			throw new RuntimeException("isUseDept is null");
		}
		this.isUseDept = isUseDept;
		return this;
	}
	...
	public void setIsUseDept(String isUseDept) {
		this.isUseDept = isUseDept;
	}
