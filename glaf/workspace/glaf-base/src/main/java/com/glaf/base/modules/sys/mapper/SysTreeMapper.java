...
public interface SysTreeMapper {
	...
	List<SysTree> getRoleUserTrees_oracle(SysUserQuery query);
	
	List<SysTree> getRoleUserTrees_postgresql(SysUserQuery query);
	
	List<SysTree> getRoleTrees(SysUserRoleQuery query);
