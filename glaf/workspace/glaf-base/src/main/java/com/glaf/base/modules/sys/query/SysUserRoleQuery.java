...
public class SysUserRoleQuery extends DataQuery {
	...
	public SysUserRoleQuery availDateEndGreaterThanOrEqual(Date availDateEndGreaterThanOrEqual) {
	...
	public SysUserRoleQuery availDateEndLessThanOrEqual(Date availDateEndLessThanOrEqual) {
	...
	public SysUserRoleQuery availDateStartGreaterThanOrEqual(Date availDateStartGreaterThanOrEqual) {
	...
	public SysUserRoleQuery availDateStartLessThanOrEqual(Date availDateStartLessThanOrEqual) {
	...
	public String getProcessDescriptionLike() {
		if (processDescriptionLike != null && processDescriptionLike.trim().length() > 0) {
