...
public class SysRoleDomainFactory {
	...
	static {
		...
		columnMap.put("indexUrl", "INDEXURL");
		columnMap.put("isUseBranch", "ISUSEBRANCH");
		columnMap.put("isUseDept", "ISUSEDEPT");
		...
		javaTypeMap.put("indexUrl", "String");
		javaTypeMap.put("isUseBranch", "String");
		javaTypeMap.put("isUseDept", "String");
	...
	public static TableDefinition getTableDefinition(String tableName) {
		...
		ColumnDefinition indexUrl = new ColumnDefinition();
		indexUrl.setName("indexUrl");
		indexUrl.setColumnName("INDEXURL");
		indexUrl.setJavaType("String");
		indexUrl.setLength(500);
		tableDefinition.addColumn(indexUrl);
		...
		ColumnDefinition isUseDept = new ColumnDefinition();
		isUseDept.setName("isUseDept");
		isUseDept.setColumnName("ISUSEDEPT");
		isUseDept.setJavaType("String");
		isUseDept.setLength(10);
		tableDefinition.addColumn(isUseDept);
