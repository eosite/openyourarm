...
public class SysRoleJsonFactory {
	...
	public static SysRole jsonToObject(JSONObject jsonObject) {
		...
		if (jsonObject.containsKey("isUseDept")) {
			model.setIsUseDept(jsonObject.getString("isUseDept"));
		}
	...
	public static JSONObject toJsonObject(SysRole model) {
		...
		if (model.getIsUseDept() != null) {
			jsonObject.put("isUseDept", model.getIsUseDept());
		}
