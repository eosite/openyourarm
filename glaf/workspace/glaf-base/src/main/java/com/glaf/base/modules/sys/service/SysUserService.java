...
public interface SysUserService {
	 ...
	 * @param password
	 */
	void changePassword(String account, String password,int pwdUpdateFlag);
	 ...
	 * @return
	 */
	PageResult getSysUserList(long deptId, String fullName, int pageNo, int pageSize);

	/**
	 * 获取列表
	 * 
	 */
	PageResult getSysUserList(long deptId, String userName, String account, int pageNo, int pageSize);
	 ...
	 * @return
	 */
	List<SysUser> getSysUsersByRoleIds(List<Long> roleIds);
	 ...
	 */
	@Transactional
	boolean insertUserRole(SysUser user, Set<SysRole> newRoles);
	 ...
	 */
	@Transactional
	boolean deleteUserRole(SysUser user, Set<SysRole> newRoles);
