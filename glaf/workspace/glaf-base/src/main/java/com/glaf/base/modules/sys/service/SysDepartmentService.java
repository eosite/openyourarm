...
public interface SysDepartmentService {
	...
	@Transactional
	void createAll(List<SysDepartment> depts);
	 ...
	 * @return
	 */
	SysDepartment getSysDepartment(long departmentId);
	 ...
	 * @return
	 */
	SysDepartment getSysDepartmentWithAncestor(long departmentId);
	 ...
	 * @return
	 */
	List<SysDepartment> getSysDepartmentsByQueryCriteria(int start, int pageSize, SysDepartmentQuery query);
