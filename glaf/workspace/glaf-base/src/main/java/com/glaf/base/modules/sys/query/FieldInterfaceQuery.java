...
public class FieldInterfaceQuery extends DataQuery {
	...
	protected List<Integer> listShowIndexIds;
	...
	public FieldInterfaceQuery datapointGreaterThanOrEqual(Integer datapointGreaterThanOrEqual) {
	...
	public FieldInterfaceQuery datapointLessThanOrEqual(Integer datapointLessThanOrEqual) {
	...
	public FieldInterfaceQuery importTypeGreaterThanOrEqual(Integer importTypeGreaterThanOrEqual) {
	...
	public FieldInterfaceQuery importTypeLessThanOrEqual(Integer importTypeLessThanOrEqual) {
	...
	public List<Integer> getListShowIndexIds() {
		return listShowIndexIds;
	}

	public void setListShowIndexIds(List<Integer> listShowIndexIds) {
		this.listShowIndexIds = listShowIndexIds;
	}
