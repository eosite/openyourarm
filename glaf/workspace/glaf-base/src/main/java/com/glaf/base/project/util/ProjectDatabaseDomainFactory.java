 ...
 *
 */
public class ProjectDatabaseDomainFactory {

	public static final String TABLENAME = "PROJECT_DATABASE";
	...
	public static TableDefinition getTableDefinition(String tableName) {
		...
		tableDefinition.setName("ProjectDatabase");
	...
	private ProjectDatabaseDomainFactory() {
