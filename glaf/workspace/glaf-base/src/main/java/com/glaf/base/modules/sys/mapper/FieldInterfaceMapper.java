...
public interface FieldInterfaceMapper {
	...
	Map<String, Object> getRowDataById(TableEntity tableModel);

	int getRowDataCountByQueryCriteria(TableEntity tableModel);

	List<Map<String, Object>> getRowDataListByQueryCriteria(
	...
	FieldInterface getFieldInterface(Map<String, Object> parameter);
