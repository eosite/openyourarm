...
public class SysUserJsonFactory {
	...
	public static SysUser jsonToObject(JSONObject jsonObject) {
		...
		if (jsonObject.containsKey("mqLoginFlag")) {
			model.setMqLoginFlag(jsonObject.getString("mqLoginFlag"));
		}
	...
	public static JSONObject toJsonObject(SysUser user) {
		...
		if (user.getMqLoginFlag() != null) {
			jsonObject.put("mqLoginFlag", user.getMqLoginFlag());
		}
		...
		if (user.getDeadlineTime() != null) {
			jsonObject.put("deadlineTime", DateUtils.getDate(user.getDeadlineTime()));
		}
