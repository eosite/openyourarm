 ...
 *
 */
public class DepartmentCorrelationDomainFactory {

	public static final String TABLENAME = "SYS_DEPARTMENT_CORRELATION";
	...
	public static TableDefinition getTableDefinition(String tableName) {
		...
		tableDefinition.setName("DepartmentCorrelation");
	...
	private DepartmentCorrelationDomainFactory() {
