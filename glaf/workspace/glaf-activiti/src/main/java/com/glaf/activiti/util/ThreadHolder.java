...
public abstract class ThreadHolder {
	...
	static FastThreadLocal<ExtensionEntity> extensionThreadLocal = new FastThreadLocal<ExtensionEntity>();

	static FastThreadLocal<ExtensionEntity> extensionTaskThreadLocal = new FastThreadLocal<ExtensionEntity>();
