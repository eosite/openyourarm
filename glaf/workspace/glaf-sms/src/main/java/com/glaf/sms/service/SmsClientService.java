...
public interface SmsClientService {
	...
	@Transactional
	void bulkInsert(List<SmsClient> list);
	 ...
	 * @return
	 */
	int getSmsClientCountByQueryCriteria(SmsClientQuery query);
	 ...
	 * @return
	 */
	List<SmsClient> getSmsClientsByQueryCriteria(int start, int pageSize, SmsClientQuery query);
	 ...
	 * @return
	 */
	List<SmsClient> list(SmsClientQuery query);
