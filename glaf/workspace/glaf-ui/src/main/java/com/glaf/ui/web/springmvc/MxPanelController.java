...
public class MxPanelController {
	...
	public ModelAndView edit(
		...
		if (StringUtils.isNotEmpty(panelId)) {
			...
			List<PanelButton> panelButtons = panelButtonService
	...
	public ModelAndView save(ModelMap modelMap, HttpServletRequest request) {
		...
		if (panel.getCustom() == 1) {
			...
			panelButton.setId(RequestUtils.getString(request, "panelButtonId",
					null));
			panelButton
					.setOpenType(RequestUtils.getInt(request, "openType", 0));
			panelButton.setImgUrl(RequestUtils.getString(request, "imgUrl",
					null));
			panelButton.setHref(RequestUtils.getString(request, "href", null));
			panelButton.setPid(Integer.parseInt(panel.getId()));
			if (panelButton.getImgUrl() != null
					&& panelButton.getHref() != null) {
	...
	@javax.annotation.Resource
	public void setPanelPermissionService(
			PanelPermissionService panelPermissionService) {
