...
public class MxUserPortalServiceImpl implements UserPortalService {
	...
	@Override
	public List<UserPortal> getUserPortalsByDashboardId(String actorId,
			String dashboardId) {
		return userPortalMapper.getUserPortalsByDashboardId(actorId,dashboardId);
	}

	@Override
	public void saveByDashboardId(String actorId, List<UserPortal> userPortals,
			String dashboardId) {
		userPortalMapper.deleteUserPortalByActorIdAndDashboardId(actorId,dashboardId);
		for (UserPortal userPortal : userPortals) {
			userPortal.setActorId(actorId);
			userPortal.setCreateDate(new Date());
			userPortal.setId(idGenerator.getNextId());
