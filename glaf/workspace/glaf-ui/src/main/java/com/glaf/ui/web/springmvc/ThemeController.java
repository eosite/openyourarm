...
public class ThemeController {
		...
		if (StringUtils.isNotEmpty(ids)) {
			...
			while (token.hasMoreTokens()) {
				...
				if (StringUtils.isNotEmpty(x)) {
					 ...
					 */
					if (theme != null
							&& (StringUtils.equals(theme.getCreateBy(),
	...
	public ModelAndView edit(HttpServletRequest request, ModelMap modelMap) {
		...
		return new ModelAndView("/modules/ui/theme/edit", modelMap);
	}
	...
	public ModelAndView list(HttpServletRequest request, ModelMap modelMap) {
		...
		return new ModelAndView("/modules/ui/theme/list", modelMap);
	}
	...
	public ModelAndView query(HttpServletRequest request, ModelMap modelMap) {
		...
		return new ModelAndView("/modules/ui/theme/query", modelMap);
	}
	...
	public @ResponseBody Theme saveOrUpdate(HttpServletRequest request,
		...
		try {
			...
			theme.setBackgroundType(ParamUtils.getString(model,
					"backgroundType"));
	...
	public ModelAndView view(HttpServletRequest request, ModelMap modelMap) {
		...
		return new ModelAndView("/modules/ui/theme/view");
	}
