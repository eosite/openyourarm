...
public interface ITreeFolderService {
	 ...
	 */
	@Transactional
	void deleteByPrimaryKeyCascade(int indexId);
	
	/**
	 * 
	 * @param checkedTreeFolder
	 * @param selectedTreeFolder
	 */
	@Transactional
	void updateTreeFoldeByMove(TreeFolder checkedTreeFolder,
