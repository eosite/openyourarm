...
@Service("com.glaf.isdp.service.cellUpicInfoService")
@Transactional(readOnly = true)
public class CellUpicInfoServiceImpl implements ICellUpicInfoService {
	protected static final Log logger = LogFactory
			.getLog(CellUpicInfoServiceImpl.class);
	...
	public CellUpicInfoServiceImpl() {
	...
	public List<CellUpicInfo> getCellUpicInfos(CellUpicInfoQuery query) {
	...
	@javax.annotation.Resource(name="com.glaf.isdp.mapper.CellUpicInfoMapper")
	...
	public void deleteFolderById(String id) {
		cellUpicInfoMapper.deleteFolderById(id);
	}

	@Override
	public void saveFile(IsdpDataFile isdpFile) {
			IsdpDataFile model = this.getCellDataFileById(isdpFile.getId());
			if (model != null) {
				model.setId(isdpFile.getId());
				model.setFileName(isdpFile.getFileName());
				model.setFileSize(isdpFile.getFileSize());
				model.setFileContent(isdpFile.getFileContent());
				cellUpicInfoMapper.updateCellDataFile(model);
			}else{
				model = new IsdpDataFile();
				model.setId(isdpFile.getId());
				model.setFileName(isdpFile.getFileName());
				model.setFileSize(isdpFile.getFileSize());
				model.setFileContent(isdpFile.getFileContent());
				cellUpicInfoMapper.insertCellDataFile(model);
			}
	}

	@Override
	public int getCellUpicInfoCountByLikeId(String id) {
		return cellUpicInfoMapper.getCellUpicInfoCountByLikeId(id);
	}
}
