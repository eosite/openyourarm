...
public class FlowProcessJsonFactory {
	...
	public static FlowProcess jsonToObject(JSONObject jsonObject) {
		...
		if (jsonObject.containsKey("processDId")) {
			model.setProcessDId(jsonObject.getString("processDId"));
		}
	...
	public static JSONObject toJsonObject(FlowProcess model) {
		...
		if (model.getProcessDId() != null) {
			jsonObject.put("processDId", model.getProcessDId());
		}
