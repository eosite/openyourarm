...
public class AmountFunc {
     ...
     * @return
     */
    public static String ConvertAmountStr(Double amount)
    {
    	String amountStr=formatAmount(amount);	
    	return convert(amountStr);
    }
    /**
     * 通用convertAmount
     * @param amount
     * @return
     */
    public static String convertAmount(Object amount)
    {
    	if(amount instanceof Double)
    	{
    		return ConvertAmountStr((Double)amount);
    	}
    	else if(amount instanceof Float)
    	{
    		return ConvertAmountStr(((Float) amount).doubleValue());
    	}
    	else if(amount instanceof Integer)
    	{
    		return ConvertAmountStr(((Integer) amount).doubleValue());
    	}
    	else if(amount instanceof Long)
    	{
    		return ConvertAmountStr(((Long) amount).doubleValue());
    	}
    	else
    	{  
    		if(amount!=null&&amount.equals("test"))
    		{
    			return convert("1001000.11");
    		}
    ...
    /**
	 ...
	 public static String formatAmount(Object amount)
	 {
		    ...
		    if(amount!=null&&amount instanceof String &&amount.equals("test"))
    		{
    			return formatter.format("1001000.11");
    		}
		    return formatter.format(amount);
	 }
    public static void main(String[] args) {
        // log4j?
    	System.out.println(ConvertAmountStr(106409.00));
    	System.out.println(ConvertAmountStr(1006409.02));
    	System.out.println(ConvertAmountStr(50306409.02));
    }
}