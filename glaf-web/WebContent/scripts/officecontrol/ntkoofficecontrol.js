...
(function() {
	...
	document
			.write('<object id="TANGER_OCX" classid="clsid:A39F1330-3322-4a1d-9BF0-0BA2BB90E970"');
	document
			.write('codebase="'+contextPath+'/scripts/officecontrol/OfficeControl.cab#version=5,0,2,5" width="100%" height="100%">   ');
	...
	document
			.write('<SPAN STYLE="color:red">不能装载文档控件。请确认你可以连接网络或者检查浏览器的选项中安全设置。</SPAN>   ');
