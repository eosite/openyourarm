...
(function() {
	...
	document
			.write('codebase="<%=request.getContextPath() %>/scripts/officecontrol/OfficeControl.cab#version=5,0,2,5" width="100%" height="100%">   ');
	...
	document.write('<param name="WebUserName" value="华闽通达">   ');
