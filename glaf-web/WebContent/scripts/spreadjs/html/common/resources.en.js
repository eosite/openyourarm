    ...
    (function (Sheets) {
        (function (designer) {
            (function (cn_res) {
                ...
                cn_res.allSpreadFileFilter = '所有 Spreadsheet 文件(*.ssjson *.xlsx *.xls *.csv)';
                cn_res.spreadFileFilter = 'SpreadJS 文件(*.ssjson)';
                cn_res.ssJSONToJSFilter = 'Javascript 文件(*.js)';
                cn_res.allExcelFilter = "所有 Excel 文件(*.xlsx *.xls)";
                cn_res.excelFileFilter = 'Excel 2007 工作薄 (*.xlsx)';
                cn_res.excelFileFilter2 = 'Excel 97-2003 工作薄 (*.xls)';
                ...
                cn_res.fileMenu = {
                    ...
                    browse: "浏览",
                    saveAsExcelFile: "另存为 Excel 文件",
                    saveAsSpreadSheetFile: "另存为 SSJSON 文件",
                ...
                cn_res.filemenuOptionsDialog = {
                    title: "选项",
                    urlLabel: "Excel Service 链接地址:"
                };
                ...
                cn_res.compatibleSparklineDialog = {
                    ...
                    individual: "个别的",
                    custom: "自定义",
                    compatibleSparklineSetting: "Excel兼容图设置",
                    styleSetting: "样式设置",
                ...
                cn_res.barbaseSparklineDialog = {
                    hbarSparklineSetting: "水平条形图设置",
                    vbarSparklineSetting: "垂直条形图设置",
                    value: "值",
                    colorScheme: "主题颜色"
                };

                cn_res.variSparklineDialog = {
                    variSparklineSetting: "方差图设置",
                    variance: "方差",
                    reference: "参考",
                    mini: "最小",
                    maxi: "最大",
                ...
                cn_res.cascadeSparklineDialog = {
                    cascadeSparklineSetting: "组成瀑布图设置",
                    pointsRange: "点范围",
                    pointIndex: "点指数",
                    labelsRange: "标签范围",
                    minimum: "最小值",
                ...
                cn_res.paretoSparklineDialog = {
                    paretoSparklineSetting: "阶梯瀑布图设置",
                    points: "点",
                    pointIndex: "点指数",
                    colorRange: "颜色范围",
                    target: "目标",
                ...
                GcSpread.Sheets.designer.res = GcSpread.Sheets.designer.cn_res;
                GcSpread.Sheets.designer.res.name = "cn";
