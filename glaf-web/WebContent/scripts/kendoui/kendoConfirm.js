(function(kendo){
    kendo.message = function(newMessage , option , destoryFlag) {
        var $ = kendo.jQuery ;
        ...
        if(_kendoMessage&&destoryFlag==1){
    ...
    kendo.confirm = function(newMessage ,option,okTemplate,cancelTemplate,destoryFlag) {
        var $ = kendo.jQuery ;
        var _kendoConfirm = kendo['_kendoConfirm'] ;
        var _kendoConfirmDom = kendo['_kendoConfirmDom'] ;
        if(cancelTemplate==null)
        {
        	cancelTemplate={text:'&nbsp&nbsp取消&nbsp&nbsp',callback:function(kendoConfirm){kendoConfirm.close();}};
        }
        var defaultOption = {
                                width: "400px",
                                height: "150px" ,
        ...
        if(_kendoConfirm&&destoryFlag==1){
