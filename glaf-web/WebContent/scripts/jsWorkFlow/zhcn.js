...
var translations = {
	...
	// Labels
	'Append {type}' : '添加 {type}',
	'Add Lane above' : '在上面添加线路',
	'Divide into two Lanes' : '分为2个线路',
	'Divide into three Lanes' : '分为3个线路',
	...
	'Connect using DataInputAssociation' : '连接数据',
	'Remove' : '删除',
	'Activate the hand tool' : '移动',
	'Activate the lasso tool' : '范围选择',
	'Activate the create/remove space tool' : '对齐线',
	...
	'Sequential Multi Instance' : '连续多实例',
	'Loop' : '循环',
	'Ad-hoc' : 'Ad-hoc',
	'Create {type}' : '创建 {type}',
	'Task' : '任务',
	...
	'Exclusive Gateway' : '专属路由',
	'Parallel Gateway' : '并行路由',
	'Inclusive Gateway' : '包含路由',
	'Complex Gateway' : '复合路由',
	'Event based Gateway' : '事件路由',
	'Transaction' : '事物处理',
	'Sub Process' : '子流程',
	'Event Sub Process' : '子事件流程',
	'Collapsed Pool' : '关闭',
	'Expanded Pool' : '打开',

	// Errors
	'no parent for {element} in {parent}' : '在 {parent} 不包含 {element} ',
