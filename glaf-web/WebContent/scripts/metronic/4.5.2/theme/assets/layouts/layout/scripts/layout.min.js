...
var Layout = function () {
            ...
            if ($('body').hasClass("page-sidebar-closed")) {
                if ($('.sidebar-search').hasClass('open') === false) {
                    if ($('.page-sidebar-fixed').size() === 1) {
						if($('.page-sidebar .sidebar-toggler').size()>1){
							$('.page-sidebar .sidebar-toggler:first').click();
						}else{
    ...
    var handleSidebarToggler = function () {
        ...
        $('body').on('click', '.sidebar-toggler', function (e) {
            ...
            if (body.hasClass("page-sidebar-closed")) {
				...
				if($('.designer').get(0) && $('.designer').attr('style').indexOf('width')>0&&$('.designer').css("width")!='auto'){
                 //$('.designer').width($('.designer').width()-190);
			    }
                if ($.cookie) {
    ...
    return {
        ...
        initSidebar: function() {
            ...
            //×èÖ¹¸¸mouseleaveÊÂ¼þ
			$("#ui-select").on("mouseleave", function(e){
				e.preventDefault();
				//e.stopPropagation();
				return false;
			});
			$("#type-select").on("mouseleave", function(e){
				//e.stopPropagation();
				e.preventDefault();
				return false;
			});
