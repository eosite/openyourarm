var selectpicker_designer = {
	/**
	 * 设置内间距
	 */
	setPaddingTop : function(component, val) {
		var prop = "paddingTop";
		selectpicker_designer.setDataRule(component,prop,val);
		selectpicker_designer.setPadding(component, "top", val);
	},
	setPaddingBottom : function(component, val) {
		var prop = "paddingBottom";
		selectpicker_designer.setDataRule(component,prop,val);
		selectpicker_designer.setPadding(component, "bottom", val);
	},
	setPaddingLeft : function(component, val) {
		var prop = "paddingLeft";
		selectpicker_designer.setDataRule(component,prop,val);
		selectpicker_designer.setPadding(component, "left", val);
	},
	setPaddingRight : function(component, val) {
		var prop = "paddingRight";
		selectpicker_designer.setDataRule(component,prop,val);
		selectpicker_designer.setPadding(component, "right", val);
	},
	...
	setMarginTop : function(component, val) {
		var prop = "marginTop";
		selectpicker_designer.setDataRule(component,prop,val);
		selectpicker_designer.setMargin(component, "top", val);
	},
	setMarginBottom : function(component, val) {
		var prop = "marginBottom";
		selectpicker_designer.setDataRule(component,prop,val);
		selectpicker_designer.setMargin(component, "bottom", val);
	},
	setMarginLeft : function(component, val) {
		var prop = "marginLeft";
		selectpicker_designer.setDataRule(component,prop,val);
		selectpicker_designer.setMargin(component, "left", val);
	},
	setMarginRight : function(component, val) {
		var prop = "marginRight";
		selectpicker_designer.setDataRule(component,prop,val);
		selectpicker_designer.setMargin(component, "right", val);
	},
...
//			component.find('.select2-container').css('height', val+'px');
	...
	setDisabledColor: function(component, val,unit){
		...
		selectpicker_designer.setDataRule(component,prop,val,unit);
		selectpicker_designer.updateStyleByKey(component,'disabledColor',val);
	},
	/**
	 * 设置宽
	 */
	setWidthSize: function (component, val,unit){
		...
		if (val == '') {
			selectpicker_designer.updateStyleByKey(component,'spanWidth','auto');
		} else {
			if(unit==undefined){
				unit="px";
			}else{
				selectpicker_designer.updateStyleByKey(component,'spanWidth',val+unit);
			}
		}
	},
	/**
	...
	updateStyleByKey: function (component,key,val){
		var styler = selectpicker_designer.getStyler(component);
		styler[key] = val;
		selectpicker_designer.updateStyler(component,styler);
		selectpicker_designer.updateStylerBox(component,styler);
	},
	/**
	 * 获取styler数组
	 */
	getStyler: function (component){
		var sid = selectpicker_designer.getStylerId(component);
	...
	updateStylerBox: function(component,styler){
		...
		var stylebox = selectpicker_designer.getStyleBox(component);
	...
	setPlaceholder: function (component, val){
		...
		selectpicker_designer.updateConf(component, prop, val);
	},
	clearPlaceholder: function(component,val){
		...
		selectpicker_designer.updateConf(component, prop, val_);
	},
	/**
	 * 清楚按钮大小设置
	...
	setClearSize: function (component, val){
		...
		selectpicker_designer.updateStyleByKey(component,'clearSize',val);
	},
	setClearColor: function (component, val){
		var prop = "clearColor"; 
		selectpicker_designer.setDataRule(component,prop,val);
		
		selectpicker_designer.updateStyleByKey(component,'clearColor',val);
	},
	/**
	 * 输入检索
	 */
	...
	setWidgetState: function (component, val){
		...
		selectpicker_designer.updateConf(component, prop, component.find('.input-group-btn').css('display'));
	},
	/**
	 * 装饰
	 */
	...
	setDir: function (component, val){
		...
		selectpicker_designer.updateStyleByKey(component,'dir',ctl);
	...
	setDataRule : function(component,prop,val,unit){
        var lastVal = selectpicker_designer.getDataRule(component,prop)
	...
	*/
	 setBorderTopWidth:function(component,val){
		...
		selectpicker_designer.updateStyleByKey(component,'borderWidthTop',val);
	},
	 setBorderBottomWidth:function(component,val){
		...
		selectpicker_designer.updateStyleByKey(component,'borderWidthBottom',val);
	},
	 setBorderLeftWidth:function(component,val){
		...
		selectpicker_designer.updateStyleByKey(component,'borderWidthLeft',val);
	},
	 setBorderRightWidth:function(component,val){
		...
		selectpicker_designer.updateStyleByKey(component,'borderWidthRight',val);
	},
	/**
	*设置边框颜色
	*/
	 setBorderColor:function(component,val){
		...
		selectpicker_designer.updateStyleByKey(component,'borderColor',val);
	},
	...
	setStaticData : function(component,dataStr){
        ...
        if(dataStr){
            ...
            selectpicker_designer.setDataRule(component,prop,dataStr);
    ...
    setFontPaddingTop : function(component,val){
    	...
    	selectpicker_designer.updateStyleByKey(component,'fontPaddingTop',val);
    },
    setFontPaddingBottom : function(component,val){
    	...
    	selectpicker_designer.updateStyleByKey(component,'fontPaddingBottom',val);
    },
    setFontPaddingLeft : function(component,val){
    	...
    	selectpicker_designer.updateStyleByKey(component,'fontPaddingLeft',val);
    },
    setFontPaddingRight : function(component,val){
    	...
    	selectpicker_designer.updateStyleByKey(component,'fontPaddingRight',val);
    },
    setFontHeight : function(component,val){
    	...
    	selectpicker_designer.updateStyleByKey(component,'fontHeight',val);
    },
    setFontSize : function(component,val){
    	...
    	selectpicker_designer.updateStyleByKey(component,'fontSize',val);
    },
