...
var roundwater_designer = {
	...
	setName : function(component, val) {
		...
		var prop = "name";
		roundwater_designer.setDataRule(component,prop,val);
		if (val == '') {
	...
	setPaddingTop : function(component, val) {
		var prop = "paddingTop";
		roundwater_designer.setDataRule(component,prop,val);
		roundwater_designer.setPadding(component, "top", val);
	},
	setPaddingBottom : function(component, val) {
		var prop = "paddingBottom";
		roundwater_designer.setDataRule(component,prop,val);
		roundwater_designer.setPadding(component, "bottom", val);
	},
	setPaddingLeft : function(component, val) {
		var prop = "paddingLeft";
		roundwater_designer.setDataRule(component,prop,val);
		roundwater_designer.setPadding(component, "left", val);
	},
	setPaddingRight : function(component, val) {
		var prop = "paddingRight";
		roundwater_designer.setDataRule(component,prop,val);
		roundwater_designer.setPadding(component, "right", val);
	},
	setPadding : function(component, direct, val) {
		var obj = roundwater_designer.getBodyObject(component);
	...
	setMarginTop : function(component, val) {
		var prop = "marginTop";
		roundwater_designer.setDataRule(component,prop,val);
		roundwater_designer.setMargin(component, "top", val);
	},
	setMarginBottom : function(component, val) {
		var prop = "marginBottom";
		roundwater_designer.setDataRule(component,prop,val);
		roundwater_designer.setMargin(component, "bottom", val);
	},
	setMarginLeft : function(component, val) {
		var prop = "marginLeft";
		roundwater_designer.setDataRule(component,prop,val);
		roundwater_designer.setMargin(component, "left", val);
	},
	setMarginRight : function(component, val) {
		var prop = "marginRight";
		roundwater_designer.setDataRule(component,prop,val);
		roundwater_designer.setMargin(component, "right", val);
	},
	...
	setPositionTop : function(component, val) {
		var prop = "top";
		roundwater_designer.setDataRule(component,prop,val);
		roundwater_designer.setPositon(component, 'top', val);
	},
	setPositionBottom : function(component, val) {
		var prop = "bottom";
		roundwater_designer.setDataRule(component,prop,val);
		roundwater_designer.setPositon(component, 'bottom', val);
	},
	setPositionLeft : function(component, val) {
		var prop = "left";
		roundwater_designer.setDataRule(component,prop,val);
		roundwater_designer.setPositon(component, 'left', val);
	},
	setPositionRight : function(component, val) {
		var prop = "right";
		roundwater_designer.setDataRule(component,prop,val);
		roundwater_designer.setPositon(component, 'right', val);
	},
	...
	setBorderTopWidth : function(component, val) {
		...
		roundwater_designer.setDataRule(component,prop,val);
		roundwater_designer.setBorderWidth(component, 'top', val);
	},
	setBorderBottomWidth : function(component, val) {
		var prop = "borderBottomWidth";    
		roundwater_designer.setDataRule(component,prop,val);
		roundwater_designer.setBorderWidth(component, 'bottom', val);
	},
	setBorderLeftWidth : function(component, val) {
		var prop = "borderLeftWidth";  
		roundwater_designer.setDataRule(component,prop,val);
		roundwater_designer.setBorderWidth(component, 'left', val);
	},
	setBorderRightWidth : function(component, val) {
		var prop = "borderRightWidth"; 
		roundwater_designer.setDataRule(component,prop,val);
		roundwater_designer.setBorderWidth(component, 'right', val);
	},
...
//			],
	...
	setIconClass : function(component,val){
		...
		var prop = "iconClass";
		var iconClass = roundwater_designer.setDataRule(component,prop,val);
	...
	setIconColor:function(component,val){
		var prop = "iconColor";
		var iconColor = roundwater_designer.setDataRule(component,prop,val);
		if(component.closest("div").hasClass("input-icon")){
	...
	setDataRule : function(component,prop,val){
		...
		var lastVal = roundwater_designer.getDataRule(component,prop)
