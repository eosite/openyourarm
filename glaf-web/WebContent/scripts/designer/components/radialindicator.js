...
var radialindicator_designer = {
	...
	setName : function(component, val) {
		...
		var prop = "name";
		radialindicator_designer.setDataRule(component,prop,val);
		if (val == '') {
	...
	setPaddingTop : function(component, val) {
		var prop = "paddingTop";
		radialindicator_designer.setDataRule(component,prop,val);
		radialindicator_designer.setPadding(component, "top", val);
	},
	setPaddingBottom : function(component, val) {
		var prop = "paddingBottom";
		radialindicator_designer.setDataRule(component,prop,val);
		radialindicator_designer.setPadding(component, "bottom", val);
	},
	setPaddingLeft : function(component, val) {
		var prop = "paddingLeft";
		radialindicator_designer.setDataRule(component,prop,val);
		radialindicator_designer.setPadding(component, "left", val);
	},
	setPaddingRight : function(component, val) {
		var prop = "paddingRight";
		radialindicator_designer.setDataRule(component,prop,val);
		radialindicator_designer.setPadding(component, "right", val);
	},
	setPadding : function(component, direct, val) {
		var obj = radialindicator_designer.getBodyObject(component);
	...
	setMarginTop : function(component, val) {
		var prop = "marginTop";
		radialindicator_designer.setDataRule(component,prop,val);
		radialindicator_designer.setMargin(component, "top", val);
	},
	setMarginBottom : function(component, val) {
		var prop = "marginBottom";
		radialindicator_designer.setDataRule(component,prop,val);
		radialindicator_designer.setMargin(component, "bottom", val);
	},
	setMarginLeft : function(component, val) {
		var prop = "marginLeft";
		radialindicator_designer.setDataRule(component,prop,val);
		radialindicator_designer.setMargin(component, "left", val);
	},
	setMarginRight : function(component, val) {
		var prop = "marginRight";
		radialindicator_designer.setDataRule(component,prop,val);
		radialindicator_designer.setMargin(component, "right", val);
	},
	...
	setPositionTop : function(component, val) {
		var prop = "top";
		radialindicator_designer.setDataRule(component,prop,val);
		radialindicator_designer.setPositon(component, 'top', val);
	},
	setPositionBottom : function(component, val) {
		var prop = "bottom";
		radialindicator_designer.setDataRule(component,prop,val);
		radialindicator_designer.setPositon(component, 'bottom', val);
	},
	setPositionLeft : function(component, val) {
		var prop = "left";
		radialindicator_designer.setDataRule(component,prop,val);
		radialindicator_designer.setPositon(component, 'left', val);
	},
	setPositionRight : function(component, val) {
		var prop = "right";
		radialindicator_designer.setDataRule(component,prop,val);
		radialindicator_designer.setPositon(component, 'right', val);
	},
	...
	setBorderTopWidth : function(component, val) {
		...
		radialindicator_designer.setDataRule(component,prop,val);
		radialindicator_designer.setBorderWidth(component, 'top', val);
	},
	setBorderBottomWidth : function(component, val) {
		var prop = "borderBottomWidth";    
		radialindicator_designer.setDataRule(component,prop,val);
		radialindicator_designer.setBorderWidth(component, 'bottom', val);
	},
	setBorderLeftWidth : function(component, val) {
		var prop = "borderLeftWidth";  
		radialindicator_designer.setDataRule(component,prop,val);
		radialindicator_designer.setBorderWidth(component, 'left', val);
	},
	setBorderRightWidth : function(component, val) {
		var prop = "borderRightWidth"; 
		radialindicator_designer.setDataRule(component,prop,val);
		radialindicator_designer.setBorderWidth(component, 'right', val);
	},
...
//			],
	...
	setIconClass : function(component,val){
		...
		var prop = "iconClass";
		var iconClass = radialindicator_designer.setDataRule(component,prop,val);
	...
	setIconColor:function(component,val){
		var prop = "iconColor";
		var iconColor = radialindicator_designer.setDataRule(component,prop,val);
		if(component.closest("div").hasClass("input-icon")){
	...
	setDataRule : function(component,prop,val){
		...
		var lastVal = radialindicator_designer.getDataRule(component,prop)
