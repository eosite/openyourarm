...
var phoneTimePicker_designer = {
	...
	setName : function(component, val) {
		...
		var prop = "name";
		phoneTimePicker_designer.setDataRule(component,prop,val);
		if (val == '') {
	...
	setPaddingTop : function(component, val) {
		var prop = "paddingTop";
		phoneTimePicker_designer.setDataRule(component,prop,val);
		phoneTimePicker_designer.setPadding(component, "top", val);
	},
	setPaddingBottom : function(component, val) {
		var prop = "paddingBottom";
		phoneTimePicker_designer.setDataRule(component,prop,val);
		phoneTimePicker_designer.setPadding(component, "bottom", val);
	},
	setPaddingLeft : function(component, val) {
		var prop = "paddingLeft";
		phoneTimePicker_designer.setDataRule(component,prop,val);
		phoneTimePicker_designer.setPadding(component, "left", val);
	},
	setPaddingRight : function(component, val) {
		var prop = "paddingRight";
		phoneTimePicker_designer.setDataRule(component,prop,val);
		phoneTimePicker_designer.setPadding(component, "right", val);
	},
	setPadding : function(component, direct, val) {
		var obj = phoneTimePicker_designer.getBodyObject(component);
	...
	setMarginTop : function(component, val) {
		var prop = "marginTop";
		phoneTimePicker_designer.setDataRule(component,prop,val);
		phoneTimePicker_designer.setMargin(component, "top", val);
	},
	setMarginBottom : function(component, val) {
		var prop = "marginBottom";
		phoneTimePicker_designer.setDataRule(component,prop,val);
		phoneTimePicker_designer.setMargin(component, "bottom", val);
	},
	setMarginLeft : function(component, val) {
		var prop = "marginLeft";
		phoneTimePicker_designer.setDataRule(component,prop,val);
		phoneTimePicker_designer.setMargin(component, "left", val);
	},
	setMarginRight : function(component, val) {
		var prop = "marginRight";
		phoneTimePicker_designer.setDataRule(component,prop,val);
		phoneTimePicker_designer.setMargin(component, "right", val);
	},
	...
	setPositionTop : function(component, val) {
		var prop = "top";
		phoneTimePicker_designer.setDataRule(component,prop,val);
		phoneTimePicker_designer.setPositon(component, 'top', val);
	},
	setPositionBottom : function(component, val) {
		var prop = "bottom";
		phoneTimePicker_designer.setDataRule(component,prop,val);
		phoneTimePicker_designer.setPositon(component, 'bottom', val);
	},
	setPositionLeft : function(component, val) {
		var prop = "left";
		phoneTimePicker_designer.setDataRule(component,prop,val);
		phoneTimePicker_designer.setPositon(component, 'left', val);
	},
	setPositionRight : function(component, val) {
		var prop = "right";
		phoneTimePicker_designer.setDataRule(component,prop,val);
		phoneTimePicker_designer.setPositon(component, 'right', val);
	},
	...
	setBorderTopWidth : function(component, val) {
		...
		phoneTimePicker_designer.setDataRule(component,prop,val);
		phoneTimePicker_designer.setBorderWidth(component, 'top', val);
	},
	setBorderBottomWidth : function(component, val) {
		var prop = "borderBottomWidth";    
		phoneTimePicker_designer.setDataRule(component,prop,val);
		phoneTimePicker_designer.setBorderWidth(component, 'bottom', val);
	},
	setBorderLeftWidth : function(component, val) {
		var prop = "borderLeftWidth";  
		phoneTimePicker_designer.setDataRule(component,prop,val);
		phoneTimePicker_designer.setBorderWidth(component, 'left', val);
	},
	setBorderRightWidth : function(component, val) {
		var prop = "borderRightWidth"; 
		phoneTimePicker_designer.setDataRule(component,prop,val);
		phoneTimePicker_designer.setBorderWidth(component, 'right', val);
	},
...
//			],
	...
	setIconClass : function(component,val){
		...
		var prop = "iconClass";
		var iconClass = phoneTimePicker_designer.setDataRule(component,prop,val);
	...
	setIconColor:function(component,val){
		var prop = "iconColor";
		var iconColor = phoneTimePicker_designer.setDataRule(component,prop,val);
		if(component.closest("div").hasClass("input-icon")){
	...
	setDataRule : function(component,prop,val){
		...
		var lastVal = phoneTimePicker_designer.getDataRule(component,prop)
