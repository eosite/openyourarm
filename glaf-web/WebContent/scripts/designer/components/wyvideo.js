...
var wyvideo_designer = {
	...
	setName : function(component, val) {
		...
		var prop = "name";
		wyvideo_designer.setDataRule(component,prop,val);
		if (val == '') {
	...
	setPaddingTop : function(component, val) {
		var prop = "paddingTop";
		wyvideo_designer.setDataRule(component,prop,val);
		wyvideo_designer.setPadding(component, "top", val);
	},
	setPaddingBottom : function(component, val) {
		var prop = "paddingBottom";
		wyvideo_designer.setDataRule(component,prop,val);
		wyvideo_designer.setPadding(component, "bottom", val);
	},
	setPaddingLeft : function(component, val) {
		var prop = "paddingLeft";
		wyvideo_designer.setDataRule(component,prop,val);
		wyvideo_designer.setPadding(component, "left", val);
	},
	setPaddingRight : function(component, val) {
		var prop = "paddingRight";
		wyvideo_designer.setDataRule(component,prop,val);
		wyvideo_designer.setPadding(component, "right", val);
	},
	setPadding : function(component, direct, val) {
		var obj = wyvideo_designer.getBodyObject(component);
	...
	setMarginTop : function(component, val) {
		var prop = "marginTop";
		wyvideo_designer.setDataRule(component,prop,val);
		wyvideo_designer.setMargin(component, "top", val);
	},
	setMarginBottom : function(component, val) {
		var prop = "marginBottom";
		wyvideo_designer.setDataRule(component,prop,val);
		wyvideo_designer.setMargin(component, "bottom", val);
	},
	setMarginLeft : function(component, val) {
		var prop = "marginLeft";
		wyvideo_designer.setDataRule(component,prop,val);
		wyvideo_designer.setMargin(component, "left", val);
	},
	setMarginRight : function(component, val) {
		var prop = "marginRight";
		wyvideo_designer.setDataRule(component,prop,val);
		wyvideo_designer.setMargin(component, "right", val);
	},
	...
	setPositionTop : function(component, val) {
		var prop = "top";
		wyvideo_designer.setDataRule(component,prop,val);
		wyvideo_designer.setPositon(component, 'top', val);
	},
	setPositionBottom : function(component, val) {
		var prop = "bottom";
		wyvideo_designer.setDataRule(component,prop,val);
		wyvideo_designer.setPositon(component, 'bottom', val);
	},
	setPositionLeft : function(component, val) {
		var prop = "left";
		wyvideo_designer.setDataRule(component,prop,val);
		wyvideo_designer.setPositon(component, 'left', val);
	},
	setPositionRight : function(component, val) {
		var prop = "right";
		wyvideo_designer.setDataRule(component,prop,val);
		wyvideo_designer.setPositon(component, 'right', val);
	},
...
//		obj.css("justify-content",val);
	...
	*/
	setWidth:function (component,val,unit){ 
		var prop = "width";
		wyvideo_designer.setDataRule(component,prop,val,unit);
		
		wyvideo_designer.setSize(component,"width",val,unit);
	},
	setHeight:function (component,val,unit){ 
		var prop = "height";
		wyvideo_designer.setDataRule(component,prop,val,unit);
		if(component.find("img").length){
			wyvideo_designer.setSize(component.find("img"),"height",val,unit);
		}else{
			wyvideo_designer.setSize(component,"height",val,unit);
		}
	},
	...
	*/
	...
	setDataRule : function(component,prop,val){
		...
		var lastVal = wyvideo_designer.getDataRule(component,prop)
	...
	setIconClass : function(component,val){
		...
		var prop = "iconClass";
		var iconClass = wyvideo_designer.setDataRule(component,prop,val);
	...
	setIconColor:function(component,val){
		var prop = "iconColor";
		var iconColor = wyvideo_designer.setDataRule(component,prop,val);
		if(component.find("i").length>0){
	...
	*/
	...
	setImageRadius:function(component,val){
		...
		wyvideo_designer.setDataRule(component,prop,val);
		if(component.find("img").length>0){
			wyvideo_designer.setStyle(component.find("img")[0],"border-radius:"+val+"px!important");
		}else{
			wyvideo_designer.setStyle(component.find("img")[0],"border-radius:0px!important");
		}
	},
