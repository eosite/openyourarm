var phoneListView_designer = {
	...
	setName: function(component, val) {
		if (val !== '') {
			var prop = "name";
			phoneListView_designer.setDataRule(component, prop, val);
	...
	setContentFontColor: function(component, val) {
		if (val != '') {
			var prop = "color";
			phoneListView_designer.setDataRule(component, prop, val);
			component.find(".weui_cell_bd .paragraph").css("color",val);
		}
	},
	setContentFontStyle: function(component, val) {
		var prop = "fontStyle";
		phoneListView_designer.setDataRule(component, prop, val);
		var tg = component.find(".weui_cell_bd .paragraph");
	...
	setFontColor: function(component, val) {
		if (val != '') {
			var prop = "color";
			phoneListView_designer.setDataRule(component, prop, val);
			component.find(".weui_cell_bd .title").css("color",val);
		}
	},
	setFontStyle: function(component, val) {
		var prop = "fontStyle";
		phoneListView_designer.setDataRule(component, prop, val);
		var tg = component.find(".weui_cell_bd .title");
		var tgcss = $(tg).attr('style') || '';
		if (val == 'italic') {
			if (tgcss.indexOf('font-style: italic') == -1) {
				tg.css("font-style", 'italic');
	...
	setLineHeight: function(component, val) {
		if (val != '') {
			var prop = "lineHeight";
			phoneListView_designer.setDataRule(component, prop, val);
			component.find(".weui_cell_bd .title").css("line-height", val);
		} else {
			component.find(".weui_cell_bd .title").css("line-height", "");
		}
	},
	/**
	 *鼠标悬停效果
	...
	setDataRule: function(component, prop, val) {
		var lastVal = phoneListView_designer.getDataRule(component, prop)
	...
	setPaddingTop: function(component, val) {
		var prop = "paddingTop";
		phoneListView_designer.setDataRule(component, prop, val);
		phoneListView_designer.setPadding(component, "top", val);
	},
	setPaddingBottom: function(component, val) {
		var prop = "paddingBottom";
		phoneListView_designer.setDataRule(component, prop, val);
		phoneListView_designer.setPadding(component, "bottom", val);
	},
	setPaddingLeft: function(component, val) {
		var prop = "paddingLeft";
		phoneListView_designer.setDataRule(component, prop, val);
		phoneListView_designer.setPadding(component, "left", val);
	},
	setPaddingRight: function(component, val) {
		var prop = "paddingRight";
		phoneListView_designer.setDataRule(component, prop, val);
		phoneListView_designer.setPadding(component, "right", val);
	},
	...
	setMarginTop: function(component, val) {
		var prop = "marginTop";
		phoneListView_designer.setDataRule(component, prop, val);
		phoneListView_designer.setMargin(component, "top", val);
	},
	setMarginBottom: function(component, val) {
		var prop = "marginBottom";
		phoneListView_designer.setDataRule(component, prop, val);
		phoneListView_designer.setMargin(component, "bottom", val);
	},
	setMarginLeft: function(component, val) {
		var prop = "marginLeft";
		phoneListView_designer.setDataRule(component, prop, val);
		phoneListView_designer.setMargin(component, "left", val);
	},
	setMarginRight: function(component, val) {
		var prop = "marginRight";
		phoneListView_designer.setDataRule(component, prop, val);
		phoneListView_designer.setMargin(component, "right", val);
	},
	...
	setIconClass : function(component,val){
		...
		var prop = "iconClass";
		var iconClass = phoneListView_designer.setDataRule(component,prop,val);
	...
	setIconColor:function(component,val){
		var prop = "iconColor";
		var iconColor = phoneListView_designer.setDataRule(component,prop,val);
		if(component.find("i").length>0){
...
var phoneListView_proto = Object.create(phoneListView_designer);