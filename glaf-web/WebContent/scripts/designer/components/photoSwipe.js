var photoSwipe_designer = {
	...
	setName: function(component, val) {
		if (val !== '') {
			var prop = "name";
			photoSwipe_designer.setDataRule(component, prop, val);
	...
	setDataRule: function(component, prop, val) {
		var lastVal = photoSwipe_designer.getDataRule(component, prop)
	...
	setPaddingTop: function(component, val) {
		var prop = "paddingTop";
		photoSwipe_designer.setDataRule(component, prop, val);
		photoSwipe_designer.setPadding(component, "top", val);
	},
	setPaddingBottom: function(component, val) {
		var prop = "paddingBottom";
		photoSwipe_designer.setDataRule(component, prop, val);
		photoSwipe_designer.setPadding(component, "bottom", val);
	},
	setPaddingLeft: function(component, val) {
		var prop = "paddingLeft";
		photoSwipe_designer.setDataRule(component, prop, val);
		photoSwipe_designer.setPadding(component, "left", val);
	},
	setPaddingRight: function(component, val) {
		var prop = "paddingRight";
		photoSwipe_designer.setDataRule(component, prop, val);
		photoSwipe_designer.setPadding(component, "right", val);
	},
	...
	setMarginTop: function(component, val) {
		var prop = "marginTop";
		photoSwipe_designer.setDataRule(component, prop, val);
		photoSwipe_designer.setMargin(component, "top", val);
	},
	setMarginBottom: function(component, val) {
		var prop = "marginBottom";
		photoSwipe_designer.setDataRule(component, prop, val);
		photoSwipe_designer.setMargin(component, "bottom", val);
	},
	setMarginLeft: function(component, val) {
		var prop = "marginLeft";
		photoSwipe_designer.setDataRule(component, prop, val);
		photoSwipe_designer.setMargin(component, "left", val);
	},
	setMarginRight: function(component, val) {
		var prop = "marginRight";
		photoSwipe_designer.setDataRule(component, prop, val);
		photoSwipe_designer.setMargin(component, "right", val);
	},
	...
	setIconClass : function(component,val){
		...
		var prop = "iconClass";
		var iconClass = photoSwipe_designer.setDataRule(component,prop,val);
	...
	setIconColor:function(component,val){
		var prop = "iconColor";
		var iconColor = photoSwipe_designer.setDataRule(component,prop,val);
		if(component.find("i").length>0){
...
var phoneListView_proto = Object.create(photoSwipe_designer);