var mtbutton_designer = {
	...
	setName: function(component, val) {
		if (val !== '') {
			var prop = "name";
			mtbutton_designer.setDataRule(component, prop, val);
	...
	setDataRule: function(component, prop, val) {
		var lastVal = mtbutton_designer.getDataRule(component, prop)
	...
	setPaddingTop: function(component, val) {
		var prop = "paddingTop";
		mtbutton_designer.setDataRule(component, prop, val);
		mtbutton_designer.setPadding(component, "top", val);
	},
	setPaddingBottom: function(component, val) {
		var prop = "paddingBottom";
		mtbutton_designer.setDataRule(component, prop, val);
		mtbutton_designer.setPadding(component, "bottom", val);
	},
	setPaddingLeft: function(component, val) {
		var prop = "paddingLeft";
		mtbutton_designer.setDataRule(component, prop, val);
		mtbutton_designer.setPadding(component, "left", val);
	},
	setPaddingRight: function(component, val) {
		var prop = "paddingRight";
		mtbutton_designer.setDataRule(component, prop, val);
		mtbutton_designer.setPadding(component, "right", val);
	},
	...
	setMarginTop: function(component, val) {
		var prop = "marginTop";
		mtbutton_designer.setDataRule(component, prop, val);
		mtbutton_designer.setMargin(component, "top", val);
	},
	setMarginBottom: function(component, val) {
		var prop = "marginBottom";
		mtbutton_designer.setDataRule(component, prop, val);
		mtbutton_designer.setMargin(component, "bottom", val);
	},
	setMarginLeft: function(component, val) {
		var prop = "marginLeft";
		mtbutton_designer.setDataRule(component, prop, val);
		mtbutton_designer.setMargin(component, "left", val);
	},
	setMarginRight: function(component, val) {
		var prop = "marginRight";
		mtbutton_designer.setDataRule(component, prop, val);
		mtbutton_designer.setMargin(component, "right", val);
	},
	...
	setIconClass : function(component,val){
		...
		var prop = "iconClass";
		var iconClass = mtbutton_designer.setDataRule(component,prop,val);
	...
	setIconColor:function(component,val){
		var prop = "iconColor";
		var iconColor = mtbutton_designer.setDataRule(component,prop,val);
		if(component.find("i").length>0){
	...
	//手机段样式
	setPhoneColor : function(component,val){
		debugger
		var prop = "phoneColor";
		mtbutton_designer.setDataRule(component, prop, val);
		if(val == "btn-default"){
			component.addClass("mui-btn");
			component.removeClass("btn-default");
			component.removeClass("btn");
		}else{
			component.addClass("mui-btn");
			component.removeClass("btn-default");
			component.removeClass("btn");
	...
	//有底色无边框
	setOutline : function(component,val){
		var prop = "outline";
		mtbutton_designer.setDataRule(component, prop, val);
		if(val == "true"){
			component.addClass("mui-btn");
			component.addClass("mui-btn-outlined");
			component.removeClass("btn-default");
			component.removeClass("btn");
		}else if(val == "false"){
			component.addClass("mui-btn");
			component.removeClass("btn-default");
			component.removeClass("btn");
			component.removeClass("mui-btn-outlined");
			component.addClass(val);
		}
	},
	
	setLoading :function(component,val){
		debugger;
		var prop = "loading";
		mtbutton_designer.setDataRule(component, prop, val);
		if(val == "left"){
			component.addClass("mui-btn");
			component.addClass("mui-btn-primary");
			component.removeClass("btn-default");
			component.removeClass("btn");
			var id = component[0].id;
			document.getElementById(id).setAttribute("data-loading-text","");
			document.getElementById(id).setAttribute("data-loading-icon-position",val);
		}else if(val == "right"){
			component.addClass("mui-btn");
			component.addClass("mui-btn-primary");
			component.removeClass("btn-default");
...
var mtbutton_proto = Object.create(mtbutton_designer);