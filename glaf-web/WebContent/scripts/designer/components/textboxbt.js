...
var textboxbt_designer = {
	...
	setName : function(component, val) {
		...
		var prop = "name";
		textboxbt_designer.setDataRule(component,prop,val);
		if (val == '') {
	...
	setPaddingTop : function(component, val) {
		var prop = "paddingTop";
		textboxbt_designer.setDataRule(component,prop,val);
		textboxbt_designer.setPadding(component, "top", val);
	},
	setPaddingBottom : function(component, val) {
		var prop = "paddingBottom";
		textboxbt_designer.setDataRule(component,prop,val);
		textboxbt_designer.setPadding(component, "bottom", val);
	},
	setPaddingLeft : function(component, val) {
		var prop = "paddingLeft";
		textboxbt_designer.setDataRule(component,prop,val);
		textboxbt_designer.setPadding(component, "left", val);
	},
	setPaddingRight : function(component, val) {
		var prop = "paddingRight";
		textboxbt_designer.setDataRule(component,prop,val);
		textboxbt_designer.setPadding(component, "right", val);
	},
	setPadding : function(component, direct, val) {
		var obj = textboxbt_designer.getBodyObject(component);
	...
	setMarginTop : function(component, val) {
		var prop = "marginTop";
		textboxbt_designer.setDataRule(component,prop,val);
		textboxbt_designer.setMargin(component, "top", val);
	},
	setMarginBottom : function(component, val) {
		var prop = "marginBottom";
		textboxbt_designer.setDataRule(component,prop,val);
		textboxbt_designer.setMargin(component, "bottom", val);
	},
	setMarginLeft : function(component, val) {
		var prop = "marginLeft";
		textboxbt_designer.setDataRule(component,prop,val);
		textboxbt_designer.setMargin(component, "left", val);
	},
	setMarginRight : function(component, val) {
		var prop = "marginRight";
		textboxbt_designer.setDataRule(component,prop,val);
		textboxbt_designer.setMargin(component, "right", val);
	},
	...
	setPositionTop : function(component, val) {
		var prop = "top";
		textboxbt_designer.setDataRule(component,prop,val);
		textboxbt_designer.setPositon(component, 'top', val);
	},
	setPositionBottom : function(component, val) {
		var prop = "bottom";
		textboxbt_designer.setDataRule(component,prop,val);
		textboxbt_designer.setPositon(component, 'bottom', val);
	},
	setPositionLeft : function(component, val) {
		var prop = "left";
		textboxbt_designer.setDataRule(component,prop,val);
		textboxbt_designer.setPositon(component, 'left', val);
	},
	setPositionRight : function(component, val) {
		var prop = "right";
		textboxbt_designer.setDataRule(component,prop,val);
		textboxbt_designer.setPositon(component, 'right', val);
	},
	...
	setWidth : function(component, val) {
		...
		if (val == '') {
			...
			var obj = textboxbt_designer.getBodyObject(component);
			var id = obj[0].id;
			var fine = $(".mui-input-row").html();
			if(fine){
				$("#"+id).parent().css("width",val)
		}
	...
	setBorderTopWidth : function(component, val) {
		...
		textboxbt_designer.setDataRule(component,prop,val);
		textboxbt_designer.setBorderWidth(component, 'top', val);
	},
	setBorderBottomWidth : function(component, val) {
		var prop = "borderBottomWidth";    
		textboxbt_designer.setDataRule(component,prop,val);
		textboxbt_designer.setBorderWidth(component, 'bottom', val);
	},
	setBorderLeftWidth : function(component, val) {
		var prop = "borderLeftWidth";  
		textboxbt_designer.setDataRule(component,prop,val);
		textboxbt_designer.setBorderWidth(component, 'left', val);
	},
	setBorderRightWidth : function(component, val) {
		var prop = "borderRightWidth"; 
		textboxbt_designer.setDataRule(component,prop,val);
		textboxbt_designer.setBorderWidth(component, 'right', val);
	},
...
//			],
	...
	setIconClass : function(component,val){
		...
		var prop = "iconClass";
		var iconClass = textboxbt_designer.setDataRule(component,prop,val);
	...
	setIconColor:function(component,val){
		var prop = "iconColor";
		var iconColor = textboxbt_designer.setDataRule(component,prop,val);
		if(component.closest("div").hasClass("input-icon")){
	...
	//手机端样式
	setInputSearch:function(component,val){
		var prop = "inputSearch"; 
		textboxbt_designer.setDataRule(component,prop,val);
		var obj = textboxbt_designer.getBodyObject(component);
		if(val=="yes"){
			var id = obj[0].id;
			var widt = $("#"+id).outerWidth();
			var fine = $(".mui-input-row").html();
			if(typeof(fine) == "undefined"){
				$("#"+id).wrap("<div class='mui-input-row mui-search mui-active'></div>");
			}
			$("#"+id).parent().css("width",widt)
			obj.addClass("mui-input-clear");
			obj.removeClass("nlayout_elem");
			obj.attr('type','search');
		}
		
	},
	setInputPassword:function(component,val){
		var prop = "inputPassword"; 
		textboxbt_designer.setDataRule(component,prop,val);
		var obj = textboxbt_designer.getBodyObject(component);
		if(val=="yes"){
			...
			var fine = $(".mui-input-row").html();
			if(typeof(fine) == "undefined"){
				$("#"+id).wrap("<div class='mui-input-row mui-active'></div>");
			}
			
			$("#"+id).parent().css("width",widt)
			obj.attr('type','password');
			obj.addClass("mui-input-password");
			obj.removeClass("nlayout_elem");
			obj.attr('placeholder','请输入密码');
		}
	},
	setInputClear:function(component,val){
		var prop = "inputClear"; 
		textboxbt_designer.setDataRule(component,prop,val);
		var obj = textboxbt_designer.getBodyObject(component);
		var id=obj[0].id;
		if(val=="yes"){
			...
			$("#"+id).parent().css("width",widt)
			obj.addClass("mui-input-clear mui-active");
			obj.removeClass("nlayout_elem");
	...
	setDataRule : function(component,prop,val){
		...
		var lastVal = textboxbt_designer.getDataRule(component,prop)
	...
	setReaonlyColor : function(component,val){
		var prop = "reaonlyColor"; 
		textboxbt_designer.setDataRule(component,prop,val);
		
		if (val == '') {
			component.removeAttr("reaonlyColor");
		} else {
			component.attr("reaonlyColor",val);
		}
	},
	setNatureType : function(component,val){
		var prop = "natureType"; 
		textboxbt_designer.setDataRule(component,prop,val);
