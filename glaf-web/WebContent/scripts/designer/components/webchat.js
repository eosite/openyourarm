...
var webchat_designer = {
	...
	setName : function(component, val) {
		...
		var prop = "name";
		webchat_designer.setDataRule(component,prop,val);
		if (val == '') {
	...
	setPaddingTop : function(component, val) {
		var prop = "paddingTop";
		webchat_designer.setDataRule(component,prop,val);
		webchat_designer.setPadding(component, "top", val);
	},
	setPaddingBottom : function(component, val) {
		var prop = "paddingBottom";
		webchat_designer.setDataRule(component,prop,val);
		webchat_designer.setPadding(component, "bottom", val);
	},
	setPaddingLeft : function(component, val) {
		var prop = "paddingLeft";
		webchat_designer.setDataRule(component,prop,val);
		webchat_designer.setPadding(component, "left", val);
	},
	setPaddingRight : function(component, val) {
		var prop = "paddingRight";
		webchat_designer.setDataRule(component,prop,val);
		webchat_designer.setPadding(component, "right", val);
	},
	setPadding : function(component, direct, val) {
		var obj = webchat_designer.getBodyObject(component);
	...
	setMarginTop : function(component, val) {
		var prop = "marginTop";
		webchat_designer.setDataRule(component,prop,val);
		webchat_designer.setMargin(component, "top", val);
	},
	setMarginBottom : function(component, val) {
		var prop = "marginBottom";
		webchat_designer.setDataRule(component,prop,val);
		webchat_designer.setMargin(component, "bottom", val);
	},
	setMarginLeft : function(component, val) {
		var prop = "marginLeft";
		webchat_designer.setDataRule(component,prop,val);
		webchat_designer.setMargin(component, "left", val);
	},
	setMarginRight : function(component, val) {
		var prop = "marginRight";
		webchat_designer.setDataRule(component,prop,val);
		webchat_designer.setMargin(component, "right", val);
	},
	...
	setPositionTop : function(component, val) {
		var prop = "top";
		webchat_designer.setDataRule(component,prop,val);
		webchat_designer.setPositon(component, 'top', val);
	},
	setPositionBottom : function(component, val) {
		var prop = "bottom";
		webchat_designer.setDataRule(component,prop,val);
		webchat_designer.setPositon(component, 'bottom', val);
	},
	setPositionLeft : function(component, val) {
		var prop = "left";
		webchat_designer.setDataRule(component,prop,val);
		webchat_designer.setPositon(component, 'left', val);
	},
	setPositionRight : function(component, val) {
		var prop = "right";
		webchat_designer.setDataRule(component,prop,val);
		webchat_designer.setPositon(component, 'right', val);
	},
...
//		obj.css("justify-content",val);
	...
	*/
	setWidth:function (component,val,unit){ 
		var prop = "width";
		webchat_designer.setDataRule(component,prop,val,unit);
		
		webchat_designer.setSize(component,"width",val,unit);
	},
	setHeight:function (component,val,unit){ 
		var prop = "height";
		webchat_designer.setDataRule(component,prop,val,unit);
		if(component.find("img").length){
			webchat_designer.setSize(component.find("img"),"height",val,unit);
		}else{
			webchat_designer.setSize(component,"height",val,unit);
		}
	},
	...
	*/
	...
	setDataRule : function(component,prop,val){
		...
		var lastVal = webchat_designer.getDataRule(component,prop)
	...
	setIconClass : function(component,val){
		...
		var prop = "iconClass";
		var iconClass = webchat_designer.setDataRule(component,prop,val);
	...
	setIconColor:function(component,val){
		var prop = "iconColor";
		var iconColor = webchat_designer.setDataRule(component,prop,val);
		if(component.find("i").length>0){
	...
	*/
	...
	setImageRadius:function(component,val){
		...
		webchat_designer.setDataRule(component,prop,val);
		if(component.find("img").length>0){
			webchat_designer.setStyle(component.find("img")[0],"border-radius:"+val+"px!important");
		}else{
			webchat_designer.setStyle(component.find("img")[0],"border-radius:0px!important");
		}
	},
