...
var mdatepicker_designer = {
	...
	setName : function(component, val) {
		...
		var prop = "name";
		mdatepicker_designer.setDataRule(component,prop,val);
		if (val == '') {
	...
	setPlaceholder : function(component, val) {
		...
		mdatepicker_designer.setDataRule(component,prop,val);
		if (val == '') {
			$component.find("input.weui-input").attr("placeholder", "");
		} else {
			$component.find("input.weui-input").attr("placeholder", val);
		}
	},
	/**
	 * 设置内间距
	...
	setPaddingTop : function(component, val) {
		var prop = "paddingTop";
		mdatepicker_designer.setDataRule(component,prop,val);
		mdatepicker_designer.setPadding(component, "top", val);
	},
	setPaddingBottom : function(component, val) {
		var prop = "paddingBottom";
		mdatepicker_designer.setDataRule(component,prop,val);
		mdatepicker_designer.setPadding(component, "bottom", val);
	},
	setPaddingLeft : function(component, val) {
		var prop = "paddingLeft";
		mdatepicker_designer.setDataRule(component,prop,val);
		mdatepicker_designer.setPadding(component, "left", val);
	},
	setPaddingRight : function(component, val) {
		var prop = "paddingRight";
		mdatepicker_designer.setDataRule(component,prop,val);
		mdatepicker_designer.setPadding(component, "right", val);
	},
	setPadding : function(component, direct, val) {
		var obj = mdatepicker_designer.getBodyObject(component);
	...
	setMarginTop : function(component, val) {
		var prop = "marginTop";
		mdatepicker_designer.setDataRule(component,prop,val);
		mdatepicker_designer.setMargin(component, "top", val);
	},
	setMarginBottom : function(component, val) {
		var prop = "marginBottom";
		mdatepicker_designer.setDataRule(component,prop,val);
		mdatepicker_designer.setMargin(component, "bottom", val);
	},
	setMarginLeft : function(component, val) {
		var prop = "marginLeft";
		mdatepicker_designer.setDataRule(component,prop,val);
		mdatepicker_designer.setMargin(component, "left", val);
	},
	setMarginRight : function(component, val) {
		var prop = "marginRight";
		mdatepicker_designer.setDataRule(component,prop,val);
		mdatepicker_designer.setMargin(component, "right", val);
	},
	...
	setPositionTop : function(component, val) {
		var prop = "top";
		mdatepicker_designer.setDataRule(component,prop,val);
		mdatepicker_designer.setPositon(component, 'top', val);
	},
	setPositionBottom : function(component, val) {
		var prop = "bottom";
		mdatepicker_designer.setDataRule(component,prop,val);
		mdatepicker_designer.setPositon(component, 'bottom', val);
	},
	setPositionLeft : function(component, val) {
		var prop = "left";
		mdatepicker_designer.setDataRule(component,prop,val);
		mdatepicker_designer.setPositon(component, 'left', val);
	},
	setPositionRight : function(component, val) {
		var prop = "right";
		mdatepicker_designer.setDataRule(component,prop,val);
		mdatepicker_designer.setPositon(component, 'right', val);
	},
	...
	setBorderTopWidth : function(component, val) {
		...
		mdatepicker_designer.setDataRule(component,prop,val);
		mdatepicker_designer.setBorderWidth(component, 'top', val);
	},
	setBorderBottomWidth : function(component, val) {
		var prop = "borderBottomWidth";    
		mdatepicker_designer.setDataRule(component,prop,val);
		mdatepicker_designer.setBorderWidth(component, 'bottom', val);
	},
	setBorderLeftWidth : function(component, val) {
		var prop = "borderLeftWidth";  
		mdatepicker_designer.setDataRule(component,prop,val);
		mdatepicker_designer.setBorderWidth(component, 'left', val);
	},
	setBorderRightWidth : function(component, val) {
		var prop = "borderRightWidth"; 
		mdatepicker_designer.setDataRule(component,prop,val);
		mdatepicker_designer.setBorderWidth(component, 'right', val);
	},
...
//			],
	...
	setIconClass : function(component,val){
		...
		var prop = "iconClass";
		var iconClass = mdatepicker_designer.setDataRule(component,prop,val);
	...
	setIconColor:function(component,val){
		var prop = "iconColor";
		var iconColor = mdatepicker_designer.setDataRule(component,prop,val);
		if(component.closest("div").hasClass("input-icon")){
	...
	setDataRule : function(component,prop,val){
		...
		var lastVal = mdatepicker_designer.getDataRule(component,prop)
