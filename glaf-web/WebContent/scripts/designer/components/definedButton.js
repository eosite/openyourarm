var definedButton_designer = {
	...
	setName: function(component, val) {
		if (val !== '') {
			var prop = "name";
			definedButton_designer.setDataRule(component, prop, val);
	...
	setDataRule: function(component, prop, val) {
		var lastVal = definedButton_designer.getDataRule(component, prop)
	...
	setPaddingTop: function(component, val) {
		var prop = "paddingTop";
		definedButton_designer.setDataRule(component, prop, val);
		definedButton_designer.setPadding(component, "top", val);
	},
	setPaddingBottom: function(component, val) {
		var prop = "paddingBottom";
		definedButton_designer.setDataRule(component, prop, val);
		definedButton_designer.setPadding(component, "bottom", val);
	},
	setPaddingLeft: function(component, val) {
		var prop = "paddingLeft";
		definedButton_designer.setDataRule(component, prop, val);
		definedButton_designer.setPadding(component, "left", val);
	},
	setPaddingRight: function(component, val) {
		var prop = "paddingRight";
		definedButton_designer.setDataRule(component, prop, val);
		definedButton_designer.setPadding(component, "right", val);
	},
	...
	setMarginTop: function(component, val) {
		var prop = "marginTop";
		definedButton_designer.setDataRule(component, prop, val);
		definedButton_designer.setMargin(component, "top", val);
	},
	setMarginBottom: function(component, val) {
		var prop = "marginBottom";
		definedButton_designer.setDataRule(component, prop, val);
		definedButton_designer.setMargin(component, "bottom", val);
	},
	setMarginLeft: function(component, val) {
		var prop = "marginLeft";
		definedButton_designer.setDataRule(component, prop, val);
		definedButton_designer.setMargin(component, "left", val);
	},
	setMarginRight: function(component, val) {
		var prop = "marginRight";
		definedButton_designer.setDataRule(component, prop, val);
		definedButton_designer.setMargin(component, "right", val);
	},
	...
	setIconClass : function(component,val){
		...
		var prop = "iconClass";
		var iconClass = definedButton_designer.setDataRule(component,prop,val);
	...
	setIconColor:function(component,val){
		var prop = "iconColor";
		var iconColor = definedButton_designer.setDataRule(component,prop,val);
		if(component.find("i").length>0){
...
var mtbutton_proto = Object.create(definedButton_designer);