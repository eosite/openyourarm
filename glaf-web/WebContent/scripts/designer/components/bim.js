...
var bim_designer = {
	...
	setName : function(component, val) {
		...
		var prop = "name";
		bim_designer.setDataRule(component,prop,val);
		if (val == '') {
	...
	setPaddingTop : function(component, val) {
		var prop = "paddingTop";
		bim_designer.setDataRule(component,prop,val);
		bim_designer.setPadding(component, "top", val);
	},
	setPaddingBottom : function(component, val) {
		var prop = "paddingBottom";
		bim_designer.setDataRule(component,prop,val);
		bim_designer.setPadding(component, "bottom", val);
	},
	setPaddingLeft : function(component, val) {
		var prop = "paddingLeft";
		bim_designer.setDataRule(component,prop,val);
		bim_designer.setPadding(component, "left", val);
	},
	setPaddingRight : function(component, val) {
		var prop = "paddingRight";
		bim_designer.setDataRule(component,prop,val);
		bim_designer.setPadding(component, "right", val);
	},
	setPadding : function(component, direct, val) {
		var obj = bim_designer.getBodyObject(component);
	...
	setMarginTop : function(component, val) {
		var prop = "marginTop";
		bim_designer.setDataRule(component,prop,val);
		bim_designer.setMargin(component, "top", val);
	},
	setMarginBottom : function(component, val) {
		var prop = "marginBottom";
		bim_designer.setDataRule(component,prop,val);
		bim_designer.setMargin(component, "bottom", val);
	},
	setMarginLeft : function(component, val) {
		var prop = "marginLeft";
		bim_designer.setDataRule(component,prop,val);
		bim_designer.setMargin(component, "left", val);
	},
	setMarginRight : function(component, val) {
		var prop = "marginRight";
		bim_designer.setDataRule(component,prop,val);
		bim_designer.setMargin(component, "right", val);
	},
	...
	setPositionTop : function(component, val) {
		var prop = "top";
		bim_designer.setDataRule(component,prop,val);
		bim_designer.setPositon(component, 'top', val);
	},
	setPositionBottom : function(component, val) {
		var prop = "bottom";
		bim_designer.setDataRule(component,prop,val);
		bim_designer.setPositon(component, 'bottom', val);
	},
	setPositionLeft : function(component, val) {
		var prop = "left";
		bim_designer.setDataRule(component,prop,val);
		bim_designer.setPositon(component, 'left', val);
	},
	setPositionRight : function(component, val) {
		var prop = "right";
		bim_designer.setDataRule(component,prop,val);
		bim_designer.setPositon(component, 'right', val);
	},
...
//		obj.css("justify-content",val);
	...
	*/
	setWidth:function (component,val,unit){ 
		var prop = "width";
		bim_designer.setDataRule(component,prop,val,unit);
		
		bim_designer.setSize(component,"width",val,unit);
	},
	setHeight:function (component,val,unit){ 
		var prop = "height";
		bim_designer.setDataRule(component,prop,val,unit);
		if(component.find("img").length){
			bim_designer.setSize(component.find("img"),"height",val,unit);
		}else{
			bim_designer.setSize(component,"height",val,unit);
		}
	},
	...
	*/
	...
	setDataRule : function(component,prop,val){
		...
		var lastVal = bim_designer.getDataRule(component,prop)
	...
	setIconClass : function(component,val){
		...
		var prop = "iconClass";
		var iconClass = bim_designer.setDataRule(component,prop,val);
	...
	setIconColor:function(component,val){
		var prop = "iconColor";
		var iconColor = bim_designer.setDataRule(component,prop,val);
		if(component.find("i").length>0){
	...
	*/
	...
	setImageRadius:function(component,val){
		...
		bim_designer.setDataRule(component,prop,val);
		if(component.find("img").length>0){
			bim_designer.setStyle(component.find("img")[0],"border-radius:"+val+"px!important");
		}else{
			bim_designer.setStyle(component.find("img")[0],"border-radius:0px!important");
		}
	},
