...
var loadMore_designer = {
	...
	setName : function(component, val) {
		...
		var prop = "name";
		loadMore_designer.setDataRule(component,prop,val);
		if (val == '') {
	...
	setPaddingTop : function(component, val) {
		var prop = "paddingTop";
		loadMore_designer.setDataRule(component,prop,val);
		loadMore_designer.setPadding(component, "top", val);
	},
	setPaddingBottom : function(component, val) {
		var prop = "paddingBottom";
		loadMore_designer.setDataRule(component,prop,val);
		loadMore_designer.setPadding(component, "bottom", val);
	},
	setPaddingLeft : function(component, val) {
		var prop = "paddingLeft";
		loadMore_designer.setDataRule(component,prop,val);
		loadMore_designer.setPadding(component, "left", val);
	},
	setPaddingRight : function(component, val) {
		var prop = "paddingRight";
		loadMore_designer.setDataRule(component,prop,val);
		loadMore_designer.setPadding(component, "right", val);
	},
	setPadding : function(component, direct, val) {
		var obj = loadMore_designer.getBodyObject(component);
	...
	setMarginTop : function(component, val) {
		var prop = "marginTop";
		loadMore_designer.setDataRule(component,prop,val);
		loadMore_designer.setMargin(component, "top", val);
	},
	setMarginBottom : function(component, val) {
		var prop = "marginBottom";
		loadMore_designer.setDataRule(component,prop,val);
		loadMore_designer.setMargin(component, "bottom", val);
	},
	setMarginLeft : function(component, val) {
		var prop = "marginLeft";
		loadMore_designer.setDataRule(component,prop,val);
		loadMore_designer.setMargin(component, "left", val);
	},
	setMarginRight : function(component, val) {
		var prop = "marginRight";
		loadMore_designer.setDataRule(component,prop,val);
		loadMore_designer.setMargin(component, "right", val);
	},
	...
	setPositionTop : function(component, val) {
		var prop = "top";
		loadMore_designer.setDataRule(component,prop,val);
		loadMore_designer.setPositon(component, 'top', val);
	},
	setPositionBottom : function(component, val) {
		var prop = "bottom";
		loadMore_designer.setDataRule(component,prop,val);
		loadMore_designer.setPositon(component, 'bottom', val);
	},
	setPositionLeft : function(component, val) {
		var prop = "left";
		loadMore_designer.setDataRule(component,prop,val);
		loadMore_designer.setPositon(component, 'left', val);
	},
	setPositionRight : function(component, val) {
		var prop = "right";
		loadMore_designer.setDataRule(component,prop,val);
		loadMore_designer.setPositon(component, 'right', val);
	},
	...
	setBorderTopWidth : function(component, val) {
		...
		loadMore_designer.setDataRule(component,prop,val);
		loadMore_designer.setBorderWidth(component, 'top', val);
	},
	setBorderBottomWidth : function(component, val) {
		var prop = "borderBottomWidth";    
		loadMore_designer.setDataRule(component,prop,val);
		loadMore_designer.setBorderWidth(component, 'bottom', val);
	},
	setBorderLeftWidth : function(component, val) {
		var prop = "borderLeftWidth";  
		loadMore_designer.setDataRule(component,prop,val);
		loadMore_designer.setBorderWidth(component, 'left', val);
	},
	setBorderRightWidth : function(component, val) {
		var prop = "borderRightWidth"; 
		loadMore_designer.setDataRule(component,prop,val);
		loadMore_designer.setBorderWidth(component, 'right', val);
	},
...
//			],
	...
	setIconClass : function(component,val){
		...
		var prop = "iconClass";
		var iconClass = loadMore_designer.setDataRule(component,prop,val);
	...
	setIconColor:function(component,val){
		var prop = "iconColor";
		var iconColor = loadMore_designer.setDataRule(component,prop,val);
		if(component.closest("div").hasClass("input-icon")){
	...
	setDataRule : function(component,prop,val){
		...
		var lastVal = loadMore_designer.getDataRule(component,prop)
