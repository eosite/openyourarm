...
var bridgeseam_designer = {
	...
	setName : function(component, val) {
		...
		var prop = "name";
		bridgeseam_designer.setDataRule(component,prop,val);
		if (val == '') {
	...
	setPaddingTop : function(component, val) {
		var prop = "paddingTop";
		bridgeseam_designer.setDataRule(component,prop,val);
		bridgeseam_designer.setPadding(component, "top", val);
	},
	setPaddingBottom : function(component, val) {
		var prop = "paddingBottom";
		bridgeseam_designer.setDataRule(component,prop,val);
		bridgeseam_designer.setPadding(component, "bottom", val);
	},
	setPaddingLeft : function(component, val) {
		var prop = "paddingLeft";
		bridgeseam_designer.setDataRule(component,prop,val);
		bridgeseam_designer.setPadding(component, "left", val);
	},
	setPaddingRight : function(component, val) {
		var prop = "paddingRight";
		bridgeseam_designer.setDataRule(component,prop,val);
		bridgeseam_designer.setPadding(component, "right", val);
	},
	setPadding : function(component, direct, val) {
		var obj = bridgeseam_designer.getBodyObject(component);
	...
	setMarginTop : function(component, val) {
		var prop = "marginTop";
		bridgeseam_designer.setDataRule(component,prop,val);
		bridgeseam_designer.setMargin(component, "top", val);
	},
	setMarginBottom : function(component, val) {
		var prop = "marginBottom";
		bridgeseam_designer.setDataRule(component,prop,val);
		bridgeseam_designer.setMargin(component, "bottom", val);
	},
	setMarginLeft : function(component, val) {
		var prop = "marginLeft";
		bridgeseam_designer.setDataRule(component,prop,val);
		bridgeseam_designer.setMargin(component, "left", val);
	},
	setMarginRight : function(component, val) {
		var prop = "marginRight";
		bridgeseam_designer.setDataRule(component,prop,val);
		bridgeseam_designer.setMargin(component, "right", val);
	},
	...
	setPositionTop : function(component, val) {
		var prop = "top";
		bridgeseam_designer.setDataRule(component,prop,val);
		bridgeseam_designer.setPositon(component, 'top', val);
	},
	setPositionBottom : function(component, val) {
		var prop = "bottom";
		bridgeseam_designer.setDataRule(component,prop,val);
		bridgeseam_designer.setPositon(component, 'bottom', val);
	},
	setPositionLeft : function(component, val) {
		var prop = "left";
		bridgeseam_designer.setDataRule(component,prop,val);
		bridgeseam_designer.setPositon(component, 'left', val);
	},
	setPositionRight : function(component, val) {
		var prop = "right";
		bridgeseam_designer.setDataRule(component,prop,val);
		bridgeseam_designer.setPositon(component, 'right', val);
	},
...
//		obj.css("justify-content",val);
	...
	*/
	setWidth:function (component,val,unit){ 
		var prop = "width";
		bridgeseam_designer.setDataRule(component,prop,val,unit);
		
		bridgeseam_designer.setSize(component,"width",val,unit);
	},
	setHeight:function (component,val,unit){ 
		var prop = "height";
		bridgeseam_designer.setDataRule(component,prop,val,unit);
		if(component.find("img").length){
			bridgeseam_designer.setSize(component.find("img"),"height",val,unit);
		}else{
			bridgeseam_designer.setSize(component,"height",val,unit);
		}
	},
	...
	*/
	...
	setDataRule : function(component,prop,val){
		...
		var lastVal = bridgeseam_designer.getDataRule(component,prop)
	...
	setIconClass : function(component,val){
		...
		var prop = "iconClass";
		var iconClass = bridgeseam_designer.setDataRule(component,prop,val);
	...
	setIconColor:function(component,val){
		var prop = "iconColor";
		var iconColor = bridgeseam_designer.setDataRule(component,prop,val);
		if(component.find("i").length>0){
	...
	*/
	...
	setImageRadius:function(component,val){
		...
		bridgeseam_designer.setDataRule(component,prop,val);
		if(component.find("img").length>0){
			bridgeseam_designer.setStyle(component.find("img")[0],"border-radius:"+val+"px!important");
		}else{
			bridgeseam_designer.setStyle(component.find("img")[0],"border-radius:0px!important");
		}
	},
