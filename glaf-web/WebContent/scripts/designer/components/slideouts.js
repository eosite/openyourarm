var slideouts_designer = {
	...
	setName: function(component, val) {
		if (val !== '') {
			var prop = "name";
			slideouts_designer.setDataRule(component, prop, val);
	...
	setTitleBackgroundColor: function(component, val) {
		var prop = "titleBackgroundColor";
		slideouts_designer.setDataRule(component, prop, val);
		component.find(".menu-header").css("background-color",val);
	},
	setTitleBackgroundImageColor : function(component,val){
		var prop = "titleBackgroundImageColor";
		slideouts_designer.setDataRule(component, prop, val);
		component.find(".menu-header").css("background-size","cover");
		component.find(".menu-header").css("background-image","url("+contextPath+val+")");
	},
	/**
	 *设置背景色
	 */
	setContentBackgroundColor: function(component, val) {
		var prop = "contentBackgroundColor";
		slideouts_designer.setDataRule(component, prop, val);
		component.find(".menu-section").css("background-color",val);
	},
	setContentBackgroundImage : function(component,val){
		var prop = "contentBackgroundImage";
		slideouts_designer.setDataRule(component, prop, val);
		component.find(".menu-section").css("background-size","cover");
		component.find(".menu-section").css("background-image","url("+contextPath+val+")");
	},
	/**
	 *设置边框颜色
	 */
	 ...
	 *设置字体
	 */
	setTitleFontFamily: function(component, val) {
		if (val != '') {
			var tg = component.find('span');
			tg.css("font-family", val);
		}
	},
	setTitleFontColor: function(component, val) {
		if (val != '') {
			var prop = "titleColor";
			slideouts_designer.setDataRule(component, prop, val);
			component.find(".menu-header").css("color",val);
		}
	},
	setTitleFontStyle: function(component, val) {
		var prop = "titleFontStyle";
		slideouts_designer.setDataRule(component, prop, val);
		
		var tgcss = component.find(".menu-header").attr('style') || '';
		if (val == 'italic') {
			if (tgcss.indexOf('font-style: italic') == -1) {
				component.find(".menu-header").css("font-style", 'italic');
			} else {
				component.find(".menu-header").css("font-style", '');
			}
		} else if (val == 'bold') {
			if (tgcss.indexOf('font-weight: bold') == -1) {
				component.find(".menu-header").css("font-weight", 'bold');
			} else {
				component.find(".menu-header").css("font-weight", '');
			}
		}
	},
	/**
	 *设置字体大小
	 */
	setTitleFontSize: function(component, val) {
		if (val != '') {
			var prop = "titleFontSize";
			slideouts_designer.setDataRule(component, prop, val);
			component.find(".menu-header").css("font-size", val + "px");
		}
	},
	setTitleLineHeight: function(component, val) {
		if (val != '') {
			var prop = "titleLineHeight";
			slideouts_designer.setDataRule(component, prop, val);
			component.find(".menu-header").css("line-height", val);
		} else {
			component.find(".menu-header").css("line-height", "");
		}
	},
	setContentFontColor: function(component, val) {
		if (val != '') {
			var prop = "contentColor";
			slideouts_designer.setDataRule(component, prop, val);
			component.find(".menu-section a").css("color",val);
		}
	},
	setContentFontStyle: function(component, val) {
		var prop = "contentFontStyle";
		slideouts_designer.setDataRule(component, prop, val);
		var tg = component.find(".menu-section");
	 ...
	 *设置字体大小
	 */
	setContentFontSize: function(component, val) {
		if (val != '') {
			var prop = "contentFontSize";
			slideouts_designer.setDataRule(component, prop, val);
			var tg = component.find(".menu-section");
			tg.css("font-size", val + "px");
		}
	},
	setContentLineHeight: function(component, val) {
		if (val != '') {
			var prop = "contentLineHeight";
			slideouts_designer.setDataRule(component, prop, val);
			component.find(".menu-section").css("line-height", val);
		} else {
			component.find(".menu-section").css("line-height", "");
		}
	},
	/**
	 *鼠标悬停效果
	...
	setDataRule: function(component, prop, val) {
		var lastVal = slideouts_designer.getDataRule(component, prop)
	...
	setPaddingTop: function(component, val) {
		var prop = "paddingTop";
		slideouts_designer.setDataRule(component, prop, val);
		slideouts_designer.setPadding(component, "top", val);
	},
	setPaddingBottom: function(component, val) {
		var prop = "paddingBottom";
		slideouts_designer.setDataRule(component, prop, val);
		slideouts_designer.setPadding(component, "bottom", val);
	},
	setPaddingLeft: function(component, val) {
		var prop = "paddingLeft";
		slideouts_designer.setDataRule(component, prop, val);
		slideouts_designer.setPadding(component, "left", val);
	},
	setPaddingRight: function(component, val) {
		var prop = "paddingRight";
		slideouts_designer.setDataRule(component, prop, val);
		slideouts_designer.setPadding(component, "right", val);
	},
	...
	setMarginTop: function(component, val) {
		var prop = "marginTop";
		slideouts_designer.setDataRule(component, prop, val);
		slideouts_designer.setMargin(component, "top", val);
	},
	setMarginBottom: function(component, val) {
		var prop = "marginBottom";
		slideouts_designer.setDataRule(component, prop, val);
		slideouts_designer.setMargin(component, "bottom", val);
	},
	setMarginLeft: function(component, val) {
		var prop = "marginLeft";
		slideouts_designer.setDataRule(component, prop, val);
		slideouts_designer.setMargin(component, "left", val);
	},
	setMarginRight: function(component, val) {
		var prop = "marginRight";
		slideouts_designer.setDataRule(component, prop, val);
		slideouts_designer.setMargin(component, "right", val);
	},
	...
	setIconClass : function(component,val){
		...
		var prop = "iconClass";
		var iconClass = slideouts_designer.setDataRule(component,prop,val);
	...
	setIconColor:function(component,val){
		var prop = "iconColor";
		var iconColor = slideouts_designer.setDataRule(component,prop,val);
		if(component.find("i").length>0){
...
var phoneListView_proto = Object.create(slideouts_designer);