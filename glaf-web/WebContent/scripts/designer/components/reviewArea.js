var reviewArea_designer = {
	...
	setName: function(component, val) {
		if (val !== '') {
			var prop = "name";
			reviewArea_designer.setDataRule(component, prop, val);
	...
	setDataRule: function(component, prop, val) {
		var lastVal = reviewArea_designer.getDataRule(component, prop)
	...
	setPaddingTop: function(component, val) {
		var prop = "paddingTop";
		reviewArea_designer.setDataRule(component, prop, val);
		reviewArea_designer.setPadding(component, "top", val);
	},
	setPaddingBottom: function(component, val) {
		var prop = "paddingBottom";
		reviewArea_designer.setDataRule(component, prop, val);
		reviewArea_designer.setPadding(component, "bottom", val);
	},
	setPaddingLeft: function(component, val) {
		var prop = "paddingLeft";
		reviewArea_designer.setDataRule(component, prop, val);
		reviewArea_designer.setPadding(component, "left", val);
	},
	setPaddingRight: function(component, val) {
		var prop = "paddingRight";
		reviewArea_designer.setDataRule(component, prop, val);
		reviewArea_designer.setPadding(component, "right", val);
	},
	...
	setMarginTop: function(component, val) {
		var prop = "marginTop";
		reviewArea_designer.setDataRule(component, prop, val);
		reviewArea_designer.setMargin(component, "top", val);
	},
	setMarginBottom: function(component, val) {
		var prop = "marginBottom";
		reviewArea_designer.setDataRule(component, prop, val);
		reviewArea_designer.setMargin(component, "bottom", val);
	},
	setMarginLeft: function(component, val) {
		var prop = "marginLeft";
		reviewArea_designer.setDataRule(component, prop, val);
		reviewArea_designer.setMargin(component, "left", val);
	},
	setMarginRight: function(component, val) {
		var prop = "marginRight";
		reviewArea_designer.setDataRule(component, prop, val);
		reviewArea_designer.setMargin(component, "right", val);
	},
	...
	setIconClass : function(component,val){
		...
		var prop = "iconClass";
		var iconClass = reviewArea_designer.setDataRule(component,prop,val);
	...
	setIconColor:function(component,val){
		var prop = "iconColor";
		var iconColor = reviewArea_designer.setDataRule(component,prop,val);
		if(component.find("i").length>0){
...
var phoneListView_proto = Object.create(reviewArea_designer);