...
var a_designer = {
	...
	setName : function(component, val) {
		...
		var prop = "name";
		a_designer.setDataRule(component,prop,val);
		if (val == '') {
	...
	setPaddingTop : function(component, val) {
		var prop = "paddingTop";
		a_designer.setDataRule(component,prop,val);
		a_designer.setPadding(component, "top", val);
	},
	setPaddingBottom : function(component, val) {
		var prop = "paddingBottom";
		a_designer.setDataRule(component,prop,val);
		a_designer.setPadding(component, "bottom", val);
	},
	setPaddingLeft : function(component, val) {
		var prop = "paddingLeft";
		a_designer.setDataRule(component,prop,val);
		a_designer.setPadding(component, "left", val);
	},
	setPaddingRight : function(component, val) {
		var prop = "paddingRight";
		a_designer.setDataRule(component,prop,val);
		a_designer.setPadding(component, "right", val);
	},
	setPadding : function(component, direct, val) {
		var obj = a_designer.getBodyObject(component);
	...
	setMarginTop : function(component, val) {
		var prop = "marginTop";
		a_designer.setDataRule(component,prop,val);
		a_designer.setMargin(component, "top", val);
	},
	setMarginBottom : function(component, val) {
		var prop = "marginBottom";
		a_designer.setDataRule(component,prop,val);
		a_designer.setMargin(component, "bottom", val);
	},
	setMarginLeft : function(component, val) {
		var prop = "marginLeft";
		a_designer.setDataRule(component,prop,val);
		a_designer.setMargin(component, "left", val);
	},
	setMarginRight : function(component, val) {
		var prop = "marginRight";
		a_designer.setDataRule(component,prop,val);
		a_designer.setMargin(component, "right", val);
	},
	...
	setPositionTop : function(component, val) {
		var prop = "top";
		a_designer.setDataRule(component,prop,val);
		a_designer.setPositon(component, 'top', val);
	},
	setPositionBottom : function(component, val) {
		var prop = "bottom";
		a_designer.setDataRule(component,prop,val);
		a_designer.setPositon(component, 'bottom', val);
	},
	setPositionLeft : function(component, val) {
		var prop = "left";
		a_designer.setDataRule(component,prop,val);
		a_designer.setPositon(component, 'left', val);
	},
	setPositionRight : function(component, val) {
		var prop = "right";
		a_designer.setDataRule(component,prop,val);
		a_designer.setPositon(component, 'right', val);
	},
...
//		obj.css("justify-content",val);
	...
	*/
	setWidth:function (component,val,unit){ 
		var prop = "width";
		a_designer.setDataRule(component,prop,val,unit);
		
		a_designer.setSize(component,"width",val,unit);
	},
	setHeight:function (component,val,unit){ 
		var prop = "height";
		a_designer.setDataRule(component,prop,val,unit);
		if(component.find("img").length){
			a_designer.setSize(component.find("img"),"height",val,unit);
		}else{
			a_designer.setSize(component,"height",val,unit);
		}
	},
	...
	*/
	...
	setFontStyle : function(component, val) {
		var prop = "fontStyle"; 
		a_designer.setDataRule(component,prop,val);
		if (val == 'italic' || $(this).val() == 'italic') {
			if (val) {
				component.css("font-style", 'italic');
			} else {
				component.css("font-style", '');
			}
		} else if (val == 'bold' || $(this).val() == 'bold') {
			if (val) {
	...
	setDataRule : function(component,prop,val){
		...
		var lastVal = a_designer.getDataRule(component,prop)
	...
	setIconClass : function(component,val){
		...
		var prop = "iconClass";
		var iconClass = a_designer.setDataRule(component,prop,val);
	...
	setIconColor:function(component,val){
		var prop = "iconColor";
		var iconColor = a_designer.setDataRule(component,prop,val);
		if(component.find("i").length>0){
	...
	*/
	...
	setImageRadius:function(component,val){
		...
		a_designer.setDataRule(component,prop,val);
		if(component.find("img").length>0){
			a_designer.setStyle(component.find("img")[0],"border-radius:"+val+"px!important");
		}else{
			a_designer.setStyle(component.find("img")[0],"border-radius:0px!important");
		}
	},
