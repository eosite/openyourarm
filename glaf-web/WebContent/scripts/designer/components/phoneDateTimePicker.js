 ...
 * textboxbt
 */
var phoneDateTimePicker_designer = {
	...
	setName : function(component, val) {
		...
		var prop = "name";
		phoneDateTimePicker_designer.setDataRule(component,prop,val);
		if (val == '') {
	...
	setPaddingTop : function(component, val) {
		var prop = "paddingTop";
		phoneDateTimePicker_designer.setDataRule(component,prop,val);
		phoneDateTimePicker_designer.setPadding(component, "top", val);
	},
	setPaddingBottom : function(component, val) {
		var prop = "paddingBottom";
		phoneDateTimePicker_designer.setDataRule(component,prop,val);
		phoneDateTimePicker_designer.setPadding(component, "bottom", val);
	},
	setPaddingLeft : function(component, val) {
		var prop = "paddingLeft";
		phoneDateTimePicker_designer.setDataRule(component,prop,val);
		phoneDateTimePicker_designer.setPadding(component, "left", val);
	},
	setPaddingRight : function(component, val) {
		var prop = "paddingRight";
		phoneDateTimePicker_designer.setDataRule(component,prop,val);
		phoneDateTimePicker_designer.setPadding(component, "right", val);
	},
	setPadding : function(component, direct, val) {
		var obj = phoneDateTimePicker_designer.getBodyObject(component);
	...
	setMarginTop : function(component, val) {
		var prop = "marginTop";
		phoneDateTimePicker_designer.setDataRule(component,prop,val);
		phoneDateTimePicker_designer.setMargin(component, "top", val);
	},
	setMarginBottom : function(component, val) {
		var prop = "marginBottom";
		phoneDateTimePicker_designer.setDataRule(component,prop,val);
		phoneDateTimePicker_designer.setMargin(component, "bottom", val);
	},
	setMarginLeft : function(component, val) {
		var prop = "marginLeft";
		phoneDateTimePicker_designer.setDataRule(component,prop,val);
		phoneDateTimePicker_designer.setMargin(component, "left", val);
	},
	setMarginRight : function(component, val) {
		var prop = "marginRight";
		phoneDateTimePicker_designer.setDataRule(component,prop,val);
		phoneDateTimePicker_designer.setMargin(component, "right", val);
	},
	...
	setPositionTop : function(component, val) {
		var prop = "top";
		phoneDateTimePicker_designer.setDataRule(component,prop,val);
		phoneDateTimePicker_designer.setPositon(component, 'top', val);
	},
	setPositionBottom : function(component, val) {
		var prop = "bottom";
		phoneDateTimePicker_designer.setDataRule(component,prop,val);
		phoneDateTimePicker_designer.setPositon(component, 'bottom', val);
	},
	setPositionLeft : function(component, val) {
		var prop = "left";
		phoneDateTimePicker_designer.setDataRule(component,prop,val);
		phoneDateTimePicker_designer.setPositon(component, 'left', val);
	},
	setPositionRight : function(component, val) {
		var prop = "right";
		phoneDateTimePicker_designer.setDataRule(component,prop,val);
		phoneDateTimePicker_designer.setPositon(component, 'right', val);
	},
	...
	setBorderTopWidth : function(component, val) {
		...
		phoneDateTimePicker_designer.setDataRule(component,prop,val);
		phoneDateTimePicker_designer.setBorderWidth(component, 'top', val);
	},
	setBorderBottomWidth : function(component, val) {
		var prop = "borderBottomWidth";    
		phoneDateTimePicker_designer.setDataRule(component,prop,val);
		phoneDateTimePicker_designer.setBorderWidth(component, 'bottom', val);
	},
	setBorderLeftWidth : function(component, val) {
		var prop = "borderLeftWidth";  
		phoneDateTimePicker_designer.setDataRule(component,prop,val);
		phoneDateTimePicker_designer.setBorderWidth(component, 'left', val);
	},
	setBorderRightWidth : function(component, val) {
		var prop = "borderRightWidth"; 
		phoneDateTimePicker_designer.setDataRule(component,prop,val);
		phoneDateTimePicker_designer.setBorderWidth(component, 'right', val);
	},
...
//			],
	...
	setIconClass : function(component,val){
		...
		var prop = "iconClass";
		var iconClass = phoneDateTimePicker_designer.setDataRule(component,prop,val);
	...
	setIconColor:function(component,val){
		var prop = "iconColor";
		var iconColor = phoneDateTimePicker_designer.setDataRule(component,prop,val);
		if(component.closest("div").hasClass("input-icon")){
	...
	setDataRule : function(component,prop,val){
		...
		var lastVal = phoneDateTimePicker_designer.getDataRule(component,prop)
