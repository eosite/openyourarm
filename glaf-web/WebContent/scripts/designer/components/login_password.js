...
var login_password_designer = {
	...
	setName : function(component,val){
		var prop = "name";
		login_password_designer.setDataRule(component,prop,val);
	...
	setMarginTop : function(component, val) {
		var prop = "marginTop";
		login_password_designer.setDataRule(component,prop,val);
		login_password_designer.setMargin(component, "top", val);
	},
	setMarginBottom : function(component, val) {
		var prop = "marginBottom";
		login_password_designer.setDataRule(component,prop,val);
		login_password_designer.setMargin(component, "bottom", val);
	},
	setMarginLeft : function(component, val) {
		var prop = "marginLeft";
		login_password_designer.setDataRule(component,prop,val);
		login_password_designer.setMargin(component, "left", val);
	},
	setMarginRight : function(component, val) {
		var prop = "marginRight";
		login_password_designer.setDataRule(component,prop,val);
		login_password_designer.setMargin(component, "right", val);
	},
	...
	setHeight : function(component, val) {
		var obj = login_password_designer.getBodyObject(component);
		var prop = "height";
		login_password_designer.setDataRule(component,prop,val);
	...
	setBorderTopWidth : function(component, val) {
		...
		login_password_designer.setDataRule(component,prop,val);
		login_password_designer.setBorderWidth(component, 'top', val);
	},
	setBorderBottomWidth : function(component, val) {
		var prop = "borderBottomWidth";    
		login_password_designer.setDataRule(component,prop,val);
		login_password_designer.setBorderWidth(component, 'bottom', val);
	},
	setBorderLeftWidth : function(component, val) {
		var prop = "borderLeftWidth";  
		login_password_designer.setDataRule(component,prop,val);
		login_password_designer.setBorderWidth(component, 'left', val);
	},
	setBorderRightWidth : function(component, val) {
		var prop = "borderRightWidth"; 
		login_password_designer.setDataRule(component,prop,val);
		login_password_designer.setBorderWidth(component, 'right', val);
	},
	...
	setIconClass : function(component,val){
		...
		var prop = "iconClass";
		var iconClass = login_password_designer.setDataRule(component,prop,val);
	...
	initIconClass: function(template,value){
		var template = $("<div class=\"input-group\"><i></i><span></span><span class=\"input-group-btn\"><button class=\"btn blue input-sm\" type=\"button\" onclick=\"javascript:login_password_designer.selectIcon(this);\" >...</button></span></div>");
	...
	setIconColor:function(component,val){
		...
		var prop = "iconColor";
		var iconColor = login_password_designer.setDataRule(component,prop,val);
	...
	setDataRule : function(component,prop,val){
		...
		var lastVal = login_password_designer.getDataRule(component,prop)
