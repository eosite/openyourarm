...
+function ($) {
  ...
  $(document).on("click",".weui-navbar__item, .weui-tabbar__item", function(e) {
		var that = $(this), 
	    component = $(that).closest(".weui-tab"),
	    dcolor = component.attr("data-color"),
	    scolor = component.attr("select-color");
	
	that.find(".weui-tabbar__label").css("color",scolor);
	that.find(".weui-tabbar__icon i").css("color",scolor);
	var items = component.find(".weui-tabbar a");
	$.each(items,function(i,item){
		if($(item).attr("href") != that.attr("href")){
			$(item).find(".weui-tabbar__label").css("color",dcolor);
			$(item).find(".weui-tabbar__icon i").css("color",dcolor);
		}
	});
    var $a = $(e.currentTarget);
    var href = $a.attr("href");
    if($a.hasClass(ITEM_ON)){
    	if(component.data("tabbar") != undefined){
        	var opt = component.data("tabbar").option;
        	opt.events.tabClick();
        }
    	return;
    } 
