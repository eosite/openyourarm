...
function openBlackPopup(url,width,height,onCloseCallBack,iframeId){
  ...
  if(window.name!=iframeId)
    bg.css({backgroundImage:"url('"+contextPath+"/scripts/plugins/bootstrap/gantt/res/black_70.png')"});
  ...
  bdiv.append("<img src=\""+contextPath+"/scripts/plugins/bootstrap/gantt/res/closeBig.png\" style='cursor:pointer;position:absolute;right:-40px;top:30px;'>");
...
function createBlackPage(width,height,onCloseCallBack){
  ...
  var bg=$("<div>").attr("id","__blackpopup__");
  bg.css({position:'fixed',top:"0px",paddingTop:"50px", left:0,width:'100%',height:'100%',  backgroundImage:"url('"+contextPath+"/scripts/plugins/bootstrap/gantt/res/img/black_70.png')"});
  ...
  var img=$("<img src='"+contextPath+"/scripts/plugins/bootstrap/gantt/res/closeBig.png' style='cursor:pointer;position:absolute;right:-40px;top:5px;' title='close'>");
  bdiv.append(img);
  img.click( function(){
    bg.trigger("close");
  });
