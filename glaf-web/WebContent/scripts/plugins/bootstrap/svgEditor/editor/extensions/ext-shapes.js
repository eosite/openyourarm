...
methodDraw.addExtension("shapes", function() {
  ...
  function loadLibrary(cat_id) {
    ...
    if(!lib) {
      ...
      $.getJSON(baseUrl+'/extensions/shapelib/' + cat_id + '.json', function(result, textStatus) {
  ...
  return {
    svgicons: baseUrl+"/extensions/ext-shapes.xml",
    buttons: [{
      id: "tool_shapelib",
      type: "mode_flyout", // _flyout
      position: 6,
      title: "图形库",
      icon: baseUrl+"/extensions/ext-shapes.png",
      events: {
        "click": function() {
