...
(function() {
  ...
  if(!window.methodDraw) window.methodDraw = function($) {
    ...
    curConfig = {
      ...
      initOpacity: 1,
      imgPath: baseUrl+"/"+'images/',
      extPath: baseUrl+"/"+'extensions/',
      jGraduatePath: baseUrl+"/"+'lib/jgraduate/images/',
      extensions: [],
      initTool: 'select',
      wireframe: false,
      ...
      uiStrings = Editor.uiStrings = {
        ...
        notification: {
          ...
          "noContentToFitTo":"无内容，不适用填充内容",
          "dupeLayerName":"There is already a layer named that!",
          "enterUniqueLayerName":"Please enter a unique layer name",
          "enterNewLayerName":"Please enter the new layer name",
          "layerHasThatName":"Layer already has that name",
          "QmoveElemsToLayer":"Move selected elements to layer \"%s\"?",
          "QwantToClear":"<strong>确认清除画布吗?</strong>\n并且会清除操作记录",
      ...
      */
      ...
      var clickExport = function() {
        ...
        if(window.canvg) {
          ...
          $.getScript(baseUrl+'/lib/canvg/rgbcolor.js', function() {
            $.getScript(baseUrl+'/lib/canvg/canvg.js', function() {
              svgCanvas.rasterExport();
            });
          });
        }
...
//        var opacity = (picker == 'stroke' ? $('#stroke_opacity') : $('#fill_opacity'));
      ...
      setTimeout(function() {
        svgCanvas.embedImage(baseUrl+'/'+'images/placeholder.svg', function(datauri) {
          if(!datauri) {
            // Disable option
