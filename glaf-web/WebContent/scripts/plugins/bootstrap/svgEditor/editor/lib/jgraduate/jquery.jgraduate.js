  ...
  function(options) {
    ...
    return this.each( function() {
      ...
      if ($this.paint.type == "none") {
        $this.paint = $.jGraduate.Paint({solidColor: 'ffffff'});
            ...
            $this.html('<ul class="jGraduate_tabs">' +
                    '<li class="jGraduate_tab_color jGraduate_tab_current" data-type="col">单色</li>' +
                    '<li class="jGraduate_tab_lingrad" data-type="lg">渐变色</li>' +
                    '<li class="jGraduate_tab_radgrad" data-type="rg">放射渐变填充</li>' +
                  '</ul>' +
      ...
      var gradPicker = $(idref + '> .jGraduate_gradPick');
            ...
            gradPicker.html(
              ...
              '<div class="jGraduate_Form jGraduate_Points jGraduate_lg_field">' +
                '<div class="jGraduate_StopSection">' +
                  '<label class="jGraduate_Form_Heading">开始位置</label>' +
                ...
                '</div>' +
                '<div class="jGraduate_StopSection">' +
                  '<label class="jGraduate_Form_Heading">结束位置</label>' +
                  '<div class="jGraduate_Form_Section">' +
                    '<label>x:</label>' +
          ...
          '</div>' +
          '<div class="jGraduate_StopSection">' +
            '<label class="jGraduate_Form_Heading">聚焦点</label>' +
            '<div class="jGraduate_Form_Section">' +
              '<label>匹配中点: <input type="checkbox" checked="checked" id="' + id + '_jGraduate_match_ctr"/></label><br/>' +
              '<label>x:</label>' +
