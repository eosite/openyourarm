	...
	$.fn.fullpage = function(options) {
		...
		*/
		...
		$('.fp-section').each(function(index){
			...
			if (numSlides > 1) {
				...
				var elem = $(slides[1]).parent('.fp-slidesContainer').attr('cd');
				
				var sliderWidth = numSlides * 100;
				var slideWidth = 100 / numSlides;
				
				if(elem!="a"){
					slides.wrapAll('<div class="fp-slidesContainer" cd="a"/>');
				...
				if(options.controlArrowColor!='#fff'){
					...
					if(options.controlArrows){
						...
						var ki=$(this).find('.fp-controlArrow');
						if(ki.length!=0){
		...
		*/
		function destroyStructure(){
			...
			var elem=$('.fp-tableCell, .fp-slidesContainer, .fp-slides');
			elem.each(function(){
				$(this).replaceWith(this.childNodes);
			});
