var navtab;
layui.config({
    base: contextPath+'/themes/larry/backstage/js/lib/' //layui自定义layui组件目录
}).extend({
    larry: 'larry',
    navtab: 'navtab',
    elemnts: 'elements',
...
layui.use(['elements', 'jquery', 'layer', 'larry', 'navtab', 'form', 'common'], function () {
    ...
    $(document).ready(function () {
		...
		var childScriptsMap =  {};
		if(rootScripts && rootScripts.children && rootScripts.children.length){
			result = [];
			$.each(rootScripts.children,function(i,children){
				children._children = children.children;
				children.children = null;
				children.icon = "";
				children.pid = children.id;
				childScriptsMap[children.pid] = children._children;
    ...
    $('#logout').on('click', function () {
        var url = contextPath+'/mx/login/logout';
