...
layui.define(['jquery','elements','layer','common'],function(exports){
   ...
   var $ = layui.jquery,
	...
	LarryTab.prototype.tabAdd = function(data) {
		...
		if (tabIndex === -1) {
			globalTabIdIndex++;
			var content = '<iframe src="' + (window.contextPath||"")+data.href + '" data-id="' + globalTabIdIndex + '"   name="ifr_' + globalTabIdIndex +  '"   id="ifr' + globalTabIdIndex + '" class="larry-iframe"></iframe>';
			var title = '';
