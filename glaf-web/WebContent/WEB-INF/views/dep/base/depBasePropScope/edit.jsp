...
<script type="text/javascript">
  ...
  jQuery(function() {
    var viewModel = kendo.observable({
        "id": "${depBasePropScope.id}",
        "creator": "${depBasePropScope.creator}",
        "createDateTime": "<fmt:formatDate value='${depBasePropScope.createDateTime}' pattern='MM/dd/yyyy'/>",
        "ruleId": "${depBasePropScope.ruleId}"
    });
   ...
   function save(){
	   ...
	   var link = "<%=request.getContextPath()%>/mx/dep/base/depBasePropScope/saveDepBasePropScope";
...
<div class="x_content_title"><img
	src="<%=request.getContextPath()%>/images/window.png" alt="编辑规则适用范围信息">&nbsp;
编辑规则适用范围信息</div>
<br>
<form id="iForm" name="iForm" method="post" data-role="validator" novalidate="novalidate">
<input type="hidden" id="ruleId" name="ruleId" value="${depBasePropScope.ruleId}"/>
<table width="95%" align="center" border="0" cellspacing="0" cellpadding="5">
  <tr>
    <td width="2%" align="left">&nbsp;</td>
    <td align="left">
	<label for="id" class="required">UI标识&nbsp;</label>
        <input id="id" name="id" type="text" class="k-textbox"  
	   data-bind="value: id"
	   value="${depBasePropScope.id}" validationMessage="请输入UI标识"/>
  ...
  <tr>
	...
	<label for="creator" class="required">创建人&nbsp;</label>
	   ...
	   value="${depBasePropScope.creator}" validationMessage="请输入创建人"/>
  ...
  <tr>
	...
	<input id="createDateTime" name="createDateTime" type="text" class="k-textbox" 
	       ...
	       value="<fmt:formatDate value="${depBasePropScope.createDateTime}" pattern="yyyy-MM-dd"/>" 
