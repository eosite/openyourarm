  ...
  <table class="easyui-form" style="width:640px;" align="center">
	...
	<tr>
		...
		<td align="left">
			...
			</select> &nbsp;（提示：访问权限为公开时任何人可读）
			<script type="text/javascript">
			     document.getElementById("accessType").value="${sysData.accessType}";
			</script>
		</td>
	</tr>
	<tr>
		<td width="15%" align="left">访问角色</td>
		<td align="left">
			...
			<input type="button" name="button" value="添加" class="button btnGray" 
			       onclick="javascript:selectRole('iForm', 'perms','x_roles_name');"> 
			&nbsp;
			<input type="button" name="button" value="清空" class="button btnGray" 
	...
	<tr>
		<td width="15%" align="left">缓存数据</td>
        <td>
		  <input type="radio" name="cacheFlag" value="Y" <c:if test="${sysData.cacheFlag == 'Y'}">checked</c:if>/>是
          <input type="radio" name="cacheFlag" value="N" <c:if test="${sysData.cacheFlag == 'N'}">checked</c:if>/>否
        </td>
	</tr>
	<tr>
