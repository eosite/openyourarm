...
<body>
<html:form action="${contextPath}/mx/sys/role/saveModify" method="post"  onsubmit="return verifyAll(this);">
<input type="hidden" name="id" value="<%=bean.getId()%>">
<div class="nav-title"><span class="Title" style="font-size: 13px;font-weight: bold">角色管理</span><span class="Title" style="font-size: 13px;font-weight: bold">&gt;&gt;修改角色</span></div>
  ...
  <tr>
    <td><table width="95%" align="center" border="0" cellspacing="0" cellpadding="5">
       ...
       <label class="col-xs-3 " for="name" style="text-align: right;">角色名称*:</label>
          <div class="col-xs-9">
          <input name="name" type="text" size="35" class="form-control" datatype="string" nullable="no" maxsize="20" chname="角色名称" value="<%=bean.getName()%>"  style="width:300px;display: inline-block;">
          </div>
      </div>
      ...
      <div class="form-group row">
       <label class="col-xs-3 " for="code" style="text-align: right;">代码*:</label>
          <div class="col-xs-9">
          <input name="code" type="text" size="35" value="<%=bean.getCode() != null ? bean.getCode() : ""%>"  class="form-control" datatype="string" nullable="no" maxsize="20" chname="代码"   style="width:300px;display: inline-block;">
          </div>
      </div>
	  ...
	  <div class="form-group row">
       <label class="col-xs-3 " for="content" style="text-align: right;">描　　述:</label>
          ...
          <textarea name="content" cols="40" rows="3" class="form-control"  style="width:300px;height:90px;"
		   nullable="yes" maxsize="100" chname="描述"><%=bean.getContent() != null ? bean.getContent() : ""%></textarea>
          </div>
      </div>
      ...
      <div class="form-group row">
       <label class="col-xs-3 " for="content" style="text-align: right;">首页链接:</label>
          ...
          <textarea name="indexUrl" cols="40" rows="5" class="form-control"  style="width:300px;height:90px;"
		   nullable="yes" maxsize="100" chname="首页链接"><%=bean.getIndexUrl() != null ? bean.getIndexUrl() : ""%></textarea>
          </div>
      </div>
	  ...
	  <div class="form-group row">
       <label class="col-xs-3 " for="isUseDept" style="text-align: right;">是否开放机构管理:</label>
          <div class="col-xs-9">
          <select id="isUseDept" name="isUseDept" class="form-control"  style="width:300px;">
			    <option value="" selected>----请选择----</option>
			    <option value="Y">开放</option>
				<option value="N">不开放</option>
		    </select>
		    <script type="text/javascript">
			     document.getElementById("isUseDept").value="<%=bean.getIsUseDept() != null ? bean.getIsUseDept() : ""%>";
			</script>
          </div>
      </div>
