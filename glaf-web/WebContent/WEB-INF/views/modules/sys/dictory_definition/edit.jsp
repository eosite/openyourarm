...
<script type="text/javascript">
        ...
        function saveChanges(){
		    ...
		    jQuery.ajax({
				   type: "POST",
				   url: '<%=request.getContextPath()%>/mx/sys/dictoryDefinition/saveDictoryDefinition?nodeId=${nodeId}&target=${target}',
				   data: params,
				   dataType:  'json',
				   error: function(data){
					   alert('服务器处理错误！');
  ...
  <div data-options="region:'center',border:true">
	 <table id="dg" class="easyui-datagrid" 
			data-options="
				...
				singleSelect: true,
				toolbar: '#tb',
				url: '<%=request.getContextPath()%>/mx/sys/dictoryDefinition/json?nodeId=${nodeId}&target=${target}',
		...
		<thead>
			<tr>
				...
				<th data-options="field:'title', width:250, editor:'text'">标题</th>
