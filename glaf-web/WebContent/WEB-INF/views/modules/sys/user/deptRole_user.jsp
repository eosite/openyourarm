...
function addUser(){
  var url="<%=request.getContextPath()%>/mx/sys/user/showSelUser?deptId=<%=deptId%>&roleId=<%=roleId%>";
  var width=500;
  var height=350;
  var scroll="no";
...
<html:form action="${contextPath}/mx/sys/user/delRoleUser" method="post" target="_self"> 
