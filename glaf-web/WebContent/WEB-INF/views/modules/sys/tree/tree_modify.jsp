...
<html:form action="${contextPath}/mx/sys/tree/saveModify" method="post"  onsubmit="return checkForm(this);"> 
 ...
 <table width="95%" align="center" border="0" cellspacing="0" cellpadding="5">
	  ...
	  <tr>
        ...
        <td>
		  ...
		  <script type="text/javascript">
		   document.getElementById("allowedFizeSize").value="<%=bean.getAllowedFizeSize()%>";
		</script>
        </td>
      </tr>
	  <tr>
        ...
        <td>
		<textarea id="allowedFileExts" name="allowedFileExts" cols="30" rows="6" class="easyui-validatebox" datatype="string" nullable="yes" maxsize="200" chname="允许文件列表"><%=bean.getAllowedFileExts() != null ? bean.getAllowedFileExts(): ""%></textarea>
