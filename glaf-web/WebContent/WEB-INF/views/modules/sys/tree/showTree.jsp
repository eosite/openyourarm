...
<script type="text/javascript">
	 ...
	 var setting = {
			async: {
				enable: true,
				url: "<%=request.getContextPath()%>/rs/sys/tree/allTreeJson",
				dataFilter: filter
			},
			check: {
				enable: true
	...
	function exportTrees(){
        ...
        $("#nodeIds").val(sx);
        document.iForm.action="<%=request.getContextPath()%>/mx/sys/tree/exportTrees";
...
<span class="x_content_title">树节点</span>
&nbsp;
<input type="button" name="save" value=" 导 出 " class="btnGray" onclick="javascript:exportTrees();"> 
</div> 
<div>
