...
<body>
<html:form action="${contextPath}/mx/sys/post/saveAdd" method="post" onsubmit="return verifyAll(this);" >
<div class="nav-title"><span class="Title">岗位管理</span>&gt;&gt;增加岗位</div>
  ...
  <tr>
    <td class="box-mm"><table width="95%" align="center" border="0" cellspacing="0" cellpadding="5">
      <tr>
        ...
        <td><input name="name" type="text" size="35" class="input" datatype="string" nullable="no" maxsize="20" chname="岗位名称"></td>
      </tr>
	  <tr>
