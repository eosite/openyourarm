  ...
  function checkForm(form){
    if(verifyAll(form)){
     if(form.password.value!=form.password2.value){
         ...
         document.getElementById("name").value=account+"<br>"+showName;
	     return true;
	 }
    }
     return false;
...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="box">
  ...
  <tr>
    <td class="box-mm"><table width="95%" align="center" border="0" cellspacing="0" cellpadding="5">
      <tr>
        <td width="20%" class="input-box2">登录账号*</td>
        <td width="80%">
		<input id="account" name="account" type="text" size="30" class="x-text" datatype="string" 
		       nullable="no" maxsize="10" chname="登录账号">
		</td>
      </tr>
	  <tr>
        <td class="input-box2" valign="top">姓　名*</td>
        <td>
		<input name="showName" id="showName" type="text" size="30" class="x-text" datatype="string" nullable="no" 
		       maxsize="20" chname="显示名称">
		</td>
      </tr>
      <tr>
        <td class="input-box2" valign="top">密　码*</td>
        <td>
		<input name="password" type="password" size="30" class="x-text" datatype="string" nullable="no"
		       minsize="6" maxsize="20" chname="密码">
		</td>
      </tr>
      <tr>
        <td class="input-box2" valign="top">确认密码*</td>
        <td>
		<input name="password2" type="password" size="30" class="x-text"  datatype="string" nullable="no" 
		       minsize="6" maxsize="20" chname="确认密码">
		</td>
      </tr>
      <!-- <tr>
        <td class="input-box2" valign="top">姓　名*</td>
        <td>
		<input name="name" type="text" size="30" class="x-text" datatype="string" nullable="no" maxsize="20" chname="姓名">
		</td>
      </tr> -->
	  <tr>
        <td  class="input-box2" valign="top">身份证号</td>
        <td>
		<input id="code" name="code" type="text" size="30" class="x-text" datatype="string" nullable="no" 
		       maxsize="20" chname="编码">
		</td>
      </tr>
      <tr>
	  ...
	  <tr>
        ...
        <td>
          ...
          <textarea cols="40" id="x_users_name" name="x_users_name" rows="8"  wrap="yes" readonly  
             onclick="javascript:selectUser('iForm', 'superiorIds','x_users_name');" class="x-textarea"
		     style="height:25px;width:230px;color: #000066; background: #ffffff;"></textarea>
           <br>       
		  </td>
      </tr>
      <tr>
