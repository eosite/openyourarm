  ...
  <tr>
    <td class="box-mm"><table width="95%" align="center" border="0" cellspacing="0" cellpadding="5">
      ...
      <tr>
        ...
        <td>
		<select id="deptId" name="deptId" onchange="javascript:setValue(this);">
          <%
			if(list!=null){
      ...
      <!-- <tr>
        ...
        <td>
		    <input name="name" type="text" size="30" class="x-text" value="<%=bean.getName()%>" datatype="string" nullable="no" maxsize="20" chname="姓名">
		</td>
      </tr> -->
	  <tr>
        <td class="input-box2" valign="top">姓　名*</td>
        <td>
		    <input id="showName" name="showName" type="text" size="30" class="x-text" 
		           value="<%=bean.getShowName() != null ? bean.getShowName() : ""%>" 
		           datatype="string" nullable="no" maxsize="30" chname="显示名称">
		</td>
      </tr>
	  <tr>
        <td class="input-box2" valign="top">身份证号</td>
        <td>
		    <input id="code" name="code" type="text" size="28" class="x-text"
			       value="<%=bean.getCode() != null ? bean.getCode() : ""%>" 
		           datatype="string" nullable="no" maxsize="20" chname="编码">
		</td>
      </tr>
      <tr>
	  ...
	  <tr>
        ...
        <td>
		  ...
		  <textarea cols="40" id="x_users_name" name="x_users_name" rows="8"  wrap="yes" readonly  
		     ...
		     style="height:25px;width:230px;color: #000066; background: #ffffff;">${x_users_name}</textarea>       
		</td>
      </tr>
      <tr>
      ...
      <tr>
        <td colspan="2" align="center" valign="bottom" height="30">&nbsp;
              <input name="btn_save2" type="submit" value=" 确定 " class="btnGray">
	    </td>
      </tr>
    </table></td>
  </tr>
