...
<body>
<html:form action="${contextPath}/mx/branch/role/saveAdd" method="post" onsubmit="return verifyAll(this);" >
  ...
  <tr>
    <td class="box-mm"><table width="95%" align="center" border="0" cellspacing="0" cellpadding="5">
      ...
      <tr>
        ...
        <td>
		<textarea name="content" cols="40" rows="3" class="input-multi" datatype="string" nullable="yes" maxsize="100" chname="描述"></textarea>        
		</td>
      </tr>
	  <tr>
        <td class="input-box2" valign="top">首页链接</td>
        <td>
		<textarea name="indexUrl" cols="40" rows="5" class="input-multi" datatype="string" nullable="yes" maxsize="100" chname="首页链接"></textarea>  
        </td>
      </tr>
      <tr>
