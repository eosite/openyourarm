...
<script type="text/javascript">
    function openMoreMsg() {
	    openMMWindow('<%=request.getContextPath()%>/mx/workspace/message/showReceiveList', 600, 450);
	}

	function openMsg(id) {
		openMMWindow('<%=request.getContextPath()%>/mx/workspace/message/showMessage?id=' + id, 600, 450);
	}
</script>
