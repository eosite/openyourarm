...
<body>
<html:form action="${contextPath}/mx/identity/group/saveModify" method="post"  onsubmit="return verifyAll(this);">
  ...
  <tr>
    <td class="box-mm"><table width="95%" align="center" border="0" cellspacing="0" cellpadding="5">
      <tr>
        ...
        <td>
		<input name="name" type="text" size="35" class="input" datatype="string" nullable="no" maxsize="20" chname="群组名称"
		       value="<%=bean.getName()%>">
		</td>
      </tr>
	  <tr>
        <td class="input-box">群组代码</td>
        <td>
		<input name="code" type="text" size="35" class="input" datatype="string" nullable="no" maxsize="20" chname="群组代码" 
