...
<script type="text/javascript">
    ...
    var setting = {
			async: {
				enable: true,
				url: "<%=request.getContextPath()%>/rs/identity/group/jsonLeader?groupId=${groupId}"
			},
			check: {
				enable: true
			}
	...
	function saveMyFormData(){
		...
		jQuery.ajax({
				   type: "POST",
				   url: '<%=request.getContextPath()%>/mx/identity/group/saveGroupLeaders',
				   data: params,
				   dataType:  'json',
				   error: function(data){
					   alert('服务器处理错误！');
...
<div class="easyui-layout" data-options="fit:true">  
  ...
  <form id="iForm" name="iForm" method="post">
    <input type="hidden" id="rowId" name="rowId" value="${groupId}">
