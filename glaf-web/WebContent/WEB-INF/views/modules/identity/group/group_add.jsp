...
<body>
<html:form action="${contextPath}/mx/identity/group/saveAdd" method="post" onsubmit="return verifyAll(this);" >
  ...
  <tr>
    <td class="box-mm"><table width="95%" align="center" border="0" cellspacing="0" cellpadding="5">
      <tr>
		...
		chname="群组名称" style="width:300px;" >
		</td>
      </tr>
	  <tr>
        <td class="input-box">群组代码*</td>
        <td>
		<input name="code" type="text" size="35" class="input" datatype="string" nullable="no" maxsize="20"
		chname="群组代码" style="width:300px;" >
		</td>
      </tr>
      <tr>
		...
		chname="描述" style="width:300px;height:90px;"></textarea>        
		</td>
      </tr>
      <tr>
