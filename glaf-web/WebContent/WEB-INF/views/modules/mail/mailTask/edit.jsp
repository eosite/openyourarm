...
<%
	String htmlData = "";
	MailTask mailTask = (MailTask) request.getAttribute("mailTask");
	if (mailTask != null && mailTask.getContent() != null) {
		htmlData = htmlspecialchars(mailTask.getContent());
	}
		...
		<tbody>
			...
			<tr>
				...
				<div id="x-content" align="left" style="padding-left: 20px;"><textarea
					...
					style="width: 715px; height: 450px; text-align: left;"><%=htmlData%></textarea></div>
				</td>
			</tr>
			<tr>
