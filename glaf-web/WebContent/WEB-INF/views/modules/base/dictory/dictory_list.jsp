...
function sort(id, operate){  
  //DictoryAjaxService.sort(<%=parent%>, id, operate, {callback:function (){reloadPage();}});
    	jQuery.ajax({
			type: "POST",
			url: '<%=request.getContextPath()%>/mx/base/dictory/sort?parent=<%=parent%>&id='+id+'&operate='+operate,
			dataType:  'json',
				error: function(data){
					alert('服务器处理错误！');
				},
...
<html:form id="DictoryForm" name="DictoryForm" action="${contextPath}/mx/base/dictory/batchDelete" method="post" target="_self">
  ...
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr> 
	  ...
	  <jsp:include page="/WEB-INF/views/inc/show_page.jsp" flush="true"> 
              ...
              <jsp:param name="url" value="dictory"/>
