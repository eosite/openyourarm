...
<script type="text/javascript">
   ...
   jQuery(function(){
		jQuery('#mydatagrid').datagrid({
				...
				striped: true,
				collapsible:true,
				url:'<%=request.getContextPath()%>/mx/base/group/listJson?type=${type}',
				sortName: 'groupId',
				sortOrder: 'desc',
				remoteSort: false,
				singleSelect:true,
	...
	function groupUser(){
		...
		if (selected ){
		  var link = "<%=request.getContextPath()%>/mx/base/group/groupUsers?groupId="+selected.groupId;
		  var width=450;
		  var height=480;
		  var scroll="yes";
	...
	function editSelected2(){
		...
		var selected = jQuery('#mydatagrid').datagrid('getSelected');
		if (selected ){
			var url="group/prepareModify?type=${type}&groupId="+selected.groupId;
			var width=450;
			var height=280;
			var scroll="no";
			openWindow(url, width, height, scroll);
