...
<script type="text/javascript">  
	...
	Ext.onReady(function(){  
	         tree = new Ext.tree.TreePanel({
	          ...
	          dataUrl:'<%=request.getContextPath()%>/rs/base/identity/choose/userJson?selecteds=${selecteds}&parentId=${parentId}',
			  root: {
...
<br>
 <form name="iForm" method="post">
	...
	<td noWrap>
	<div id="append_div">
		<select multiple style="height:460px;width:200px;border:1px solid #c3daf9;float:left;" id="sel_id" name="sel_id">
		</select>
