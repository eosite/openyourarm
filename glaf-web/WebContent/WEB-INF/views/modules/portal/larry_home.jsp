...
<%
  ...
  if(StringUtils.isEmpty(logoPicPath)){
    logoPicPath="scripts/home/default/images/chissLOGO.png";
  }else{
...
<head>
    ...
    <title><%=SystemConfig.getString("res_system_name")%></title>
	   <meta name="keywords" content="<%=SystemConfig.getString("res_system_name")%>" />
    <meta name="description" content="<%=SystemConfig.getString("res_system_name")%>" />
	...
	<!-- load css -->
	<link rel="stylesheet" type="text/css" href="${contextPath}/themes/larry/common/layui/css/layui.css" media="all">
	<link rel="stylesheet" type="text/css" href="${contextPath}/themes/larry/common/css/global.css" media="all">
	<link rel="stylesheet" type="text/css" href="${contextPath}/themes/larry/backstage/css/font_bmgv5kod196q1tt9.css">
	<link rel="stylesheet" type="text/css" href="${contextPath}/themes/larry/backstage/css/backstage.css" media="all">
...
<div class="layui-layout layui-layout-admin" id="layui_layout">
	...
	<div class="layui-header header-menu">
		<div class="logo posb" id="log"><img src="${contextPath}/${logoPicPath}"></div>
        ...
        <div class="layui-tab" id="larry-tab" lay-filter="larryTab">
             ...
             <div class="layui-tab-content">
                  <div class="layui-tab-item layui-show">
                      <iframe class="larry-iframe" data-id='0' name="ifr_0" id='ifr0' src="<%=indexUrl.startsWith("http")?indexUrl:(context+indexUrl)%>"></iframe>
                  </div>
             </div>
        </div>
    </div>
    ...
    <div class="layui-footer layui-larry-foot psob" id="larry-footer">
    	   <div class="layui-main">
               <p><%=SystemConfig.getString("res_copyright")%></p> 
         </div>
    </div>
    <!-- footer end -->
...
<!-- 加载js文件-->
<script type="text/javascript" src="${contextPath}/themes/larry/common/layui/layui.js"></script> 
<script type="text/javascript" src="${contextPath}/themes/larry/backstage/js/larrycms.js"></script>
<!-- 主题配置 -->
