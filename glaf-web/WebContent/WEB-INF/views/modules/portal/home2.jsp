...
<!-- <script type="text/javascript" src='<%=request.getContextPath()%>/scripts/outlook4.js'> </script> -->
<style type="text/css">
    .icon {
	   background:url('<%=request.getContextPath()%>/images/submit.gif') no-repeat ;
	}
	.icon1 {
	   background:url('<%=request.getContextPath()%>/images/class.gif') no-repeat ;
	}
</style>
...
<div region="north" split="true" border="false" style="overflow: hidden; height: 63px;
		...
		<img src="<%=request.getContextPath()%>/images/logo.png" border="0" align="absmiddle" /> 
...
<!--views\modules\portal\home2.jsp-->