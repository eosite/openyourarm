...
<%
	...
	if(StringUtils.isEmpty(logoPicPath)){
		logoPicPath="/scripts/home/"+homeTheme+"/images/yellow_chissLOGOg.png";
	}else{
		logoPicPath=logoPicPath.trim();
	}
	if(!logoPicPath.startsWith("/")){
		logoPicPath="/"+logoPicPath.trim();
	}
...
<body>
	<div style="background:#000;height:88px;">
	<div class="topleft">
   ...
   <div class="user">
	...
	<div class="place">
   	    <div class="topmenu">
		<ul>
			<li><img src="${contextPath}/images/home.png" style="vertical-align: middle;margin-right: 3px;"/><a href="#" onclick="goHome()">首页</a></li>
		</ul>
		</div>
	 -->
	</div>
	<script type="text/javascript">
	 ...
	 function logout(){
		 window.parent.parent.location="${contextPath}/mx/login/logout";
	 }
	 $(function(){
