        ...
        },
		{
			"command": [{
                ...
                "click": function showDetails(e) {
					  ...
					  if(dataItem.sort != null){
					     document.getElementById("sort").value=dataItem.sort;
					  } else {
					  ...
					  if(dataItem.indexUrl != null){
					     document.getElementById("indexUrl").value=dataItem.indexUrl;
					  } else {
						 document.getElementById("indexUrl").value="";
					  }
	...
	function saveModify(){
		...
		jQuery.ajax({
				   ...
				   success: function(data){
					  ...
					  dataItem.sort = document.getElementById("sort").value ;
					  dataItem.content = document.getElementById("content").value ;
					  dataItem.indexUrl = document.getElementById("indexUrl").value ;
 ...
 <form id="iForm" name="iForm">
  <table width="95%" align="center" border="0" cellspacing="0" cellpadding="5">
	  ...
	  <tr>
        ...
        <td>
		<input id="code" name="code" type="text" size="30" class="k-textbox" value=""  datatype="string" nullable="no" minsize="6" maxsize="20" chname="角色编码" style=" width:240px;">
		</td>
      </tr>
	  <tr>
	  ...
	  <tr>
        <td class="input-box2" valign="top">首页链接</td>
        <td>
		<textarea id="indexUrl" name="indexUrl" rows="6" cols="46" class="k-textbox" style="height:120px; width:240px;" ></textarea>
		</td>
      </tr>
      <tr>
