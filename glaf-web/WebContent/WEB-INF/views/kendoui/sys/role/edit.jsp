	...
	<c:otherwise>
	  ...
	  <tr>
        ...
        <td>
			...
			<script type="text/javascript">
			   document.getElementById("sort").value="${sysRole.sort}";
			</script>
			&nbsp;（顺序小的排在前面）
		</td>
      </tr>
	  ...
	  <tr>
        ...
        <td>
          <textarea id="indexUrl" name="indexUrl" rows="6" cols="46" class="k-textbox" style="height:60px; width:240px;"></textarea>        
		</td>
      </tr>
