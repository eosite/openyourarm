...
<script type="text/javascript">
  ...
  jQuery(function() {
    var viewModel = kendo.observable({
		"transformId": "${matrixTableTransform.transformId}",
        "title": "${matrixTableTransform.title}",
        "tableName": "${matrixTableTransform.tableName}",
        "primaryKey": "${matrixTableTransform.primaryKey}",
        "sort": "${matrixTableTransform.sort}",
        "locked": "${matrixTableTransform.locked}"
    });
    ...
    function openQx(){
        ...
        var link = '<%=request.getContextPath()%>/mx/sys/matrixTableTransform/chooseColumns?elementId=transformColumns&elementName=transformColumns&selected='+
			selected+"&databaseIds="+databaseIds+"&tableName="+tableName+"&transformId=${matrixTableTransform.transformId}";
        var x=100;
        var y=100;
        if(is_ie) {
        	x=document.body.scrollLeft+event.clientX-event.offsetX-200;
   ...
   function save(){
       ...
       if (validator.validate()) {
	     var link = "<%=request.getContextPath()%>/mx/sys/matrixTableTransform/saveMatrixTableTransform";
...
<input type="hidden" id="transformId" name="transformId" value="${matrixTableTransform.transformId}">
<table width="95%" align="center" border="0" cellspacing="0" cellpadding="5">
  <tr>
    ...
    <td align="left">
		...
		<c:choose>
		<c:when test="${!empty matrixTableTransform.tableName}">
		${matrixTableTransform.tableName}
		<input type="hidden" id="tableName" name="tableName" value="${matrixTableTransform.tableName}">
		</c:when>
		<c:otherwise>
  ...
  <tr>
    ...
    <td align="left">
        ...
        <input id="title" name="title" type="text" class="k-textbox"  
               ...
               value="${matrixTableTransform.title}" validationMessage="请输入标题"/>
  ...
  <tr>
    ...
    <td align="left">
		...
		<input type="hidden" id="databaseIds" name="databaseIds" value="${matrixTableTransform.databaseIds}">
  ...
  <tr>
    ...
    <td align="left">
        ...
        <input id="primaryKey" name="primaryKey" type="text" class="k-textbox"  
               ...
               value="${matrixTableTransform.primaryKey}" validationMessage="请输入主键列"/>
  ...
  <tr>
    ...
    <td align="left">
        ...
        <textarea id="transformColumns" name="transformColumns" rows="12" cols="68" class="k-textbox"
				  style="width:380px;height:150px;" readonly="true">${matrixTableTransform.transformColumns}</textarea>
		&nbsp;
  ...
  <tr>
    ...
    <td align="left">
        ...
        <textarea id="sqlCriteria" name="sqlCriteria" rows="12" cols="68" class="k-textbox"
				  style="width:380px;height:80px;" >${matrixTableTransform.sqlCriteria}</textarea>&nbsp;
  ...
  <tr>
    ...
    <td align="left">
		...
		<script type="text/javascript">
            document.getElementById("sort").value="${matrixTableTransform.sort}";
		</script>
  ...
  <tr>
    ...
    <td align="left">
	    ...
	    <script type="text/javascript">
            document.getElementById("locked").value="${matrixTableTransform.locked}";
	    </script>
    </td>
  </tr>
