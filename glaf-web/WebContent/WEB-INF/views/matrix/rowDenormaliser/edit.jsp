...
<script type="text/javascript">
  ...
  jQuery(function() {
    var viewModel = kendo.observable({
		"id": "${rowDenormaliser.id}",
        "title": "${rowDenormaliser.title}",
        "sourceTableName": "${rowDenormaliser.sourceTableName}",
		"aggregateColumns": "${rowDenormaliser.aggregateColumns}",
        "primaryKey": "${rowDenormaliser.primaryKey}",
		"transformColumn": "${rowDenormaliser.transformColumn}",
		"syncColumns": "${rowDenormaliser.syncColumns}",
		"dateDimensionColumn": "${rowDenormaliser.dateDimensionColumn}",
		"incrementColumn": "${rowDenormaliser.incrementColumn}",
	    "delimiter": "${rowDenormaliser.delimiter}",
		"sqlCriteria": "${rowDenormaliser.sqlCriteria}",
		"databaseIds": "${rowDenormaliser.databaseIds}",
		"targetTableName": "${rowDenormaliser.targetTableName}",
		"targetColumn": "${rowDenormaliser.targetColumn}",
		"targetColumnType": "${rowDenormaliser.targetColumnType}",
		"scheduleFlag": "${rowDenormaliser.scheduleFlag}",
        "sort": "${rowDenormaliser.sort}",
        "locked": "${rowDenormaliser.locked}"
    });
    ...
    function openQx(){
        ...
        var link = '<%=request.getContextPath()%>/mx/sys/rowDenormaliser/chooseColumns?elementId=syncColumns&elementName=syncColumns&selected='+
    ...
    function openQx2(){
		...
		var databaseIds = jQuery("#databaseIds").val();
		var tableName = jQuery("#sourceTableName").val();
        var link = '<%=request.getContextPath()%>/mx/sys/rowDenormaliser/chooseAaggregateColumns?elementId=aggregateColumns&elementName=aggregateColumns&selected='+
			selected+"&databaseIds="+databaseIds+"&tableName="+tableName+"&transformId=${rowDenormaliser.id}";
        var x=100;
        var y=100;
        if(is_ie) {
   ...
   function save(){
       ...
       if (validator.validate()) {
	     var link = "<%=request.getContextPath()%>/mx/sys/rowDenormaliser/save";
...
<div class="x_content_title"><img
	src="<%=request.getContextPath()%>/images/window.png" alt="编辑行转列信息">&nbsp;
编辑行转列信息</div>
<br>
...
<table width="98%" align="center" border="0" cellspacing="0" cellpadding="5">
  ...
  <tr>
    ...
    <td align="left">
        ...
        <textarea id="aggregateColumns" name="aggregateColumns" rows="12" cols="68" class="k-textbox"
  ...
  <tr>
    ...
    <td align="left">
        ...
        <input id="transformColumn" name="transformColumn" rows="12" cols="68" class="k-textbox"
  ...
  <tr>
    ...
    <td align="left">
        ...
        <input id="dateDimensionColumn" name="dateDimensionColumn" rows="12" cols="68" class="k-textbox"
  ...
  <tr>
    ...
    <td align="left">
        ...
        <input id="incrementColumn" name="incrementColumn" rows="12" cols="68" class="k-textbox"
  ...
  <tr>
    ...
    <td align="left">
        ...
        <input id="delimiter" name="delimiter" rows="12" cols="68" class="k-textbox"
  ...
  <tr>
    ...
    <td align="left">
        ...
        <input id="targetTableName" name="targetTableName" rows="12" cols="68" class="k-textbox"
  ...
  <tr>
    ...
    <td align="left">
        ...
        <input id="targetColumn" name="targetColumn" rows="12" cols="68" class="k-textbox"
