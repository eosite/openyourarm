...
<script type="text/javascript">
  ...
  jQuery(function() {
    var viewModel = kendo.observable({
        "title": "${matrixColumnTransform.title}",
        "columnName": "${matrixColumnTransform.columnName}",
		"targetColumnName": "${matrixColumnTransform.targetColumnName}",
		"targetColumnPrecision": "${matrixColumnTransform.targetColumnPrecision}",
		"targetType": "${matrixColumnTransform.targetType}",
        "transformIfTargetColumnNotEmpty": "${matrixColumnTransform.transformIfTargetColumnNotEmpty}",
        "type": "${matrixColumnTransform.type}",
        "sort": "${matrixColumnTransform.sort}",
        "locked": "${matrixColumnTransform.locked}",
        "id": "${matrixColumnTransform.id}"
    });
    ...
    function saveData(){
        ...
        if (validator.validate()) {
	       var link = "<%=request.getContextPath()%>/mx/sys/matrixColumnTransform/saveMatrixColumnTransform";
...
<div class="x_content_title"><img
	src="<%=request.getContextPath()%>/images/window.png" alt="编辑字段转换信息">&nbsp;
编辑字段转换信息</div>
<br>
<form id="iForm" name="iForm" method="post" data-role="validator" novalidate="novalidate">
<input type="hidden" id="id" name="id" value="${matrixColumnTransform.id}"/>
...
<table width="98%" align="center" border="0" cellspacing="0" cellpadding="5">
  <!-- <tr>
    ...
    <td align="left">
        ...
        <input id="name" name="name" type="text" class="k-textbox"  
               data-bind="value: name" maxlength="50" style="width:320px;"
               value="${matrixColumnTransform.name}" validationMessage="请输入名称"/>
  ...
  <tr>
    ...
    <td align="left">
        ...
        <input id="title" name="title" type="text" class="k-textbox"  
               ...
               value="${matrixColumnTransform.title}" validationMessage="请输入标题"/>
  ...
  <tr>
    ...
    <td align="left">
		...
		<script type="text/javascript">
			document.getElementById("columnName").value="${matrixColumnTransform.columnName}";
		</script>
  ...
  <tr>
    ...
    <td align="left">
		...
		<script type="text/javascript">
			document.getElementById("targetColumnName").value="${matrixColumnTransform.targetColumnName}";
		</script>
  ...
  <tr>
    ...
    <td align="left">
		...
		<script type="text/javascript">
			document.getElementById("targetType").value="${matrixColumnTransform.targetType}";
		</script>
    ...
    <td align="left">
		...
		<script type="text/javascript">
			document.getElementById("targetColumnPrecision").value="${matrixColumnTransform.targetColumnPrecision}";
		</script>
  ...
  <tr>
    ...
    <td align="left">
		...
		<script type="text/javascript">
			document.getElementById("type").value="${matrixColumnTransform.type}";
		</script> 
  ...
  <tr>
    ...
    <td align="left">
	    ...
	    <script type="text/javascript">
           document.getElementById("transformIfTargetColumnNotEmpty").value="${matrixColumnTransform.transformIfTargetColumnNotEmpty}";
	    </script>
    </td>
  </tr>
  ...
  <tr>
    ...
    <td align="left">
        ...
        <!-- <input id="condition" name="condition" type="text" class="k-textbox"  
               data-bind="value: condition" maxlength="500" style="width:320px;"
               value="${matrixColumnTransform.condition}" validationMessage="请输入Java EL转换条件"/> -->
		<textarea id="condition" name="condition" rows="5" cols="48" class="k-textbox"
				  style="width:320px;height:90px;" >${matrixColumnTransform.condition}</textarea>
  ...
  <tr>
    ...
    <td align="left">
        ...
        <!-- <input id="expression" name="expression" type="text" class="k-textbox"  
               data-bind="value: expression" maxlength="500" style="width:320px;"
               value="${matrixColumnTransform.expression}" validationMessage="请输入转换表达式"/> -->
		<textarea id="expression" name="expression" rows="5" cols="48" class="k-textbox"
				  style="width:320px;height:90px;" >${matrixColumnTransform.expression}</textarea>
  ...
  <tr>
    ...
    <td align="left">
		...
		<script type="text/javascript">
            document.getElementById("sort").value="${matrixColumnTransform.sort}";
		</script>
  ...
  <tr>
    ...
    <td align="left">
	    ...
	    <script type="text/javascript">
            document.getElementById("locked").value="${matrixColumnTransform.locked}";
	    </script>
    </td>
  </tr>
  ...
  <tr>
    <td colspan="2" align="center" valign="bottom" height="30">&nbsp;
     <div>
	   ...
	   <button type="button" id="iconButton"  class="k-button" style="width: 90px" onclick="javascript:saveAsData();">另存</button>
	</div>
	</td>
  </tr>
</table>   
