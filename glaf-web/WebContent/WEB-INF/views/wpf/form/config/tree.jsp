...
<script type="text/javascript">
	 ...
	 var setting = {
			async: {
				enable: true,
				url: "<%=request.getContextPath()%>/mx/wpf/form/config/treeJson?databaseId=${databaseId}&searchWord_enc=${searchWord_enc}",
				dataFilter: filter
			},
			check: {
				enable: true,
	...
	function chooseWPFMenus(){
		...
		parent_window.document.getElementById("systemFlag").value="WPF";
	...
	function switchDB(){
		var databaseId=document.getElementById("databaseId").value;
		document.iForm.action="<%=request.getContextPath()%>/mx/wpf/form/config?databaseId="+databaseId+"&elementId=${elementId}&elementName=${elementName}";
...
&nbsp;
<input type="button" name="save" value=" 确定 " class="button" onclick="javascript:chooseWPFMenus();"> 
</div> 
<div>
	<script type="text/javascript">
