            ...
            <div class="tab-content" style="height:100%;">
                ...
                <div class="tab-pane" id="tab_2" style="height:100%;">
                    <div class="row" id="content2" style="height:100%;">
                        <div class="col-md-3" style="height:100%;padding:0px 5px;">
                        ...
                        <div class="col-md-6 " style="height:100%;padding:0px 5px;">
                            <div class="border_div" style="height:161px; padding:3px 3px;">
                                <!-- 已勾选的表格信息 -->
                                <div class="">
