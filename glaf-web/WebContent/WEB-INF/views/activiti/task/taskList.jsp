  ...
  YAHOO.example.DynamicData = ( function() {
	...
	function onMyDblClickRow(oArgs) {
	 ...
	 var formatFunKey = function(elCell, oRecord, oColumn, oData) {
		...
		var link2 ='<%=request.getContextPath()%>/mx/activiti/image/viewImage?processInstanceId='+processInstanceId;
 	...
 	var myRowFormatter = function(elTr, oRecord) {
	  ...
	  var myColumnDefs = [ 
        ...
        {label: '功能键', key: 'functionKey', resizeable: true, width: 135, align: 'center', formatter: formatFunKey}
       ];
