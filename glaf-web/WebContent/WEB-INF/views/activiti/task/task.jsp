...
<div class="x_content_title"> <img
 ...
 流程实例信息<c:if test="${param.parentProInstanceId ne null && param.parentProInstanceId ne ''}"><a href="#" onclick="javascript:gotoMainPro('${param.parentProInstanceId}')"><img src="<%=request.getContextPath()%>/images/back.gif">返回主流程</a></c:if>
</div>
<br>
...
<script type="text/javascript">
   function gotoMainPro(proInstId){
	   window.location="<%=request.getContextPath()%>/mx/activiti/view?processInstanceId="+proInstId;
   }
</script>
</body>
</html>