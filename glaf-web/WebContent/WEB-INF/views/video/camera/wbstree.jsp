...
<script type="text/javascript">
	...
	function switchDB(){
		...
		document.iForm.action="<%=request.getContextPath()%>/mx/video/camera/wbstree?databaseId="+databaseId+"&elementId=${elementId}&elementName=${elementName}";
	...
	function search(){
		var databaseId=document.getElementById("databaseId").value;
		//var searchWord=document.getElementById("searchWord").value;
		document.iForm.action="<%=request.getContextPath()%>/mx/isdp/table/data/treepinfoJson?databaseId="+databaseId+"&elementId=${elementId}&elementName=${elementName}";
		document.iForm.submit();
	}
