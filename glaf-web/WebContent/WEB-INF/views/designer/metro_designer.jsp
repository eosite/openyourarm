...
<meta http-equiv="X-UA-Compatible" content="IE=edge">
        ...
        <link rel='stylesheet' type='text/css' href='${contextPath}/scripts/weui/style/weui.css' />
        <!-- jquery fileupload -->
        ...
        <link rel="stylesheet" href="${contextPath}/scripts/designer/metro_designer.css">
        ...
        <script type='text/javascript' src='${contextPath}/scripts/jquery-weui-master/src/lib/weui.js'></script>
...
|---------------------------------------------------------|
-->
 <body class="page-sidebar-closed-hide-logo page-content-white edit page-sidebar-closed page-header-fixed page-sidebar-fixed dev" ng-app="mainApp">
        <!-- BEGIN HEADER -->
        <div class="page-header navbar navbar-fixed-top">
            ...
            <div class="page-header-inner  main-header">
				...
				<div class="btn-group">
					...
					<div class="btn-group">
					    <button type="button" id="layoutDefined" class="btn  btn-icon-only btn-default"  style="width:54px;" title="自定义布局" >
				    ...
				    <!--
				    <button type="button" id="pageRuleTemplate" class="btn  btn-icon-only btn-default"  style="width:54px;" title="规则模板" >
						<img src="${contextPath}/scripts/designer/images/toolbar/template.png"/>
						<span>规则模板</span>
				    </button>
				    -->
...
<%--         <script src="${contextPath}/scripts/plugins/bootstrap/select/jquery.metroselect_m.extends.js"></script> --%>
        ...
        <script src="${contextPath}/scripts/designer/metro_designer.js"></script>
		...
		<script src="${contextPath}/scripts/plugins/bootstrap/select/jquery.metroselect.extends.js"></script>
		<script src="${contextPath}/scripts/plugins/bootstrap/ztree/js/jquery.ztree.extends.js"></script>
		<script src="${contextPath}/scripts/plugins/bootstrap/calendar/ext/jquery.calendar.extends.js"></script>
		<script src="${contextPath}/scripts/plugins/bootstrap/diagrambt/js/jquery.diagrambt.extends.js"></script>
        <script src="${contextPath}/scripts/plugins/bootstrap/diagrambt/js/jquery.orgchart.js"></script>
		<script src="${contextPath}/scripts/plugins/bootstrap/nestable/js/jquery.nestable.min.js"></script>
		<script src="${contextPath}/scripts/plugins/bootstrap/gantt/js/iframeGantt.js"></script>
		<script src="${contextPath}/scripts/plugins/bootstrap/definedCard/ext/jquery.definedCard.extend.js"></script>
		<script src="${contextPath}/scripts/plugins/bootstrap/list/jquery.list.extends.js"></script>
        <script src="${contextPath}/scripts/plugins/bootstrap/carousel/js/jquery.carousel.extends.js"></script>
		...
		<script type='text/javascript' src='${contextPath}/scripts/plugins/bootstrap/charts/js/jquery.charts.extends.js'></script>
    </body>
</html>
