        ...
        <div class="easyui-layout" data-options="fit:true">  
           <div data-options="region:'north',split:true,border:true" style="height:265px"> 
             ...
             <div>
               ...
               <tr>
				<td width="20%">岗位</td>
				<td width="80%"><input type="text" name="rolename" value="${role.rolename}"></td>
               </tr>
               <tr>
               ...
               <tr>
				<td width="20%">描述</td>
				<td width="80%">
				   <textarea name="content" rows="5" cols="38">${role.content}</textarea>
				</td>
               </tr>
               </table>
			 </div>
...
<!--end of isdp/sys/permission/edit.jsp-->