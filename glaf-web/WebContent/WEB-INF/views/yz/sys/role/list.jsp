...
<script type="text/javascript" src="${contextPath}/scripts/ztree/js/jquery.ztree.all.min.js"></script>
    <script type="text/javascript">
		...
		var setting = {
			async: {
				enable: true,
				url:"${contextPath}/rs/isdp/sys/role/functionPerms",
		...
		var setting2 = {
			async: {
				enable: true,
				url:"${contextPath}/rs/isdp/sys/role/dataPerms",
				//autoParam:["id", "qq=n", "level=lv"],
				//otherParam:{"otherParam":"zTreeAsyncTest"},
				dataFilter: filter
			},
        ...
        <div class="easyui-layout" data-options="fit:true">  
           <div data-options="region:'north',split:true,border:true" style="height:265px"> 
             <div style="background:#fafafa;padding:2px;border:1px solid #ddd;font-size:12px"> 
			   ...
			   <a href="${contextPath}/mx/isdp/sys/user/list" class="easyui-linkbutton" data-options="plain:true, iconCls:'icon-actor'">用户管理</a>
             </div>  
            <table id="myGridData" class="easyui-datagrid" 
				data-options="url:'${contextPath}/rs/isdp/sys/role/list',fitColumns:true,nowrap:false,rownumbers:false,striped:true,onClickRow:onMyClickRow,onDblClickRow:onMyDblClickRow,singleSelect:true">
			  <thead>
				<tr>
