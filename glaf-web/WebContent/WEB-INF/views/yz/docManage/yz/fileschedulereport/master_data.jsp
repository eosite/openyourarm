...
<body class="easyui-layout" style="margin: 1px">  
     <table border="0" cellspacing="1" cellpadding="0" class="list-box" style="width:100%">
	  <tr class="list-title"> 
	    ...
	    <td width="10%" align="center" rowspan="2">项目名称</td>
	    <c:if test="${isMonth }">
	  ...
	  <c:forEach items="${muiProjLists }" var="muiProjList" varStatus="indexStatus">
	  	<c:set var="model"  value="${modelSumMap[muiProjList.indexId] }"/>
		  <tr > 
		    <td class="td-no">${indexStatus.index+1 }</td>
		    <td class="td-text" title="${muiProjList.projName }">${muiProjList.projName }</td>
