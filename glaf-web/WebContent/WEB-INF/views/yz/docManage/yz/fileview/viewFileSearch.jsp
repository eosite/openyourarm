	...
	function searchKeyWord(pageNumber){
		...
		jQuery("#dataTable").datagrid({
			...
			onDblClickRow:function(rowIndex, row){
				...
				window.showModalDialog("<%=request.getContextPath()%>/mx/docManage/yz/fileview/image/show?useDatabase=<%=useDatabase%>&method=fileAtt&topId="+row.id_enc,"viewFile","dialogHeight="+height+";dialogWidth="+width+";center=true;status=no;scroll=yes");
			}
		});
	}
