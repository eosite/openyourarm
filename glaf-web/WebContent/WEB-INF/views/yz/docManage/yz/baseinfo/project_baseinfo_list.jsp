...
<script type="text/javascript">
	jQuery(function(){
		jQuery("#myTable").datagrid({
			...
			columns:[[
			    ...
			    {field:"content",title:"说明",width:"280",align:"center"},
			    {field:"fileName",title:"文件名称",width:"290"},
	...
	function deleteSelections(){
		...
		if(ids.length > 0 && confirm("确定要删除所选择的记录吗？")){
			var rowIds = ids.join(',');
			jQuery.ajax({
				   type: "POST",
	...
	<div style="margin:0;"></div>  
 	<div class="easyui-layout" data-options="fit:true">
		<div data-options="region:'north',split:true,border:true" style="height:40px"> 
			...
			&nbsp;<span class="x_content_title">项目基本情况列表</span>
