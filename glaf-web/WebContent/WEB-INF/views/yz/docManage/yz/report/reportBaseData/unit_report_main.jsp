...
<script type="text/javascript">
	...
	function searchData(){
		...
		var url = "<%=request.getContextPath()%>/mx/docManage/yz/report/reportBaseData?method=unitReport&systemName="+useDatabase;
	...
	function gotoPage(pageno){
		var useDatabase = jQuery("#useDatabase").val();
		var url = "<%=request.getContextPath()%>/mx/docManage/yz/report/reportBaseData?method=unitReport&systemName="+useDatabase+"&page_no="+pageno;
		var p = jQuery(document.body).layout('panel','center');
		p.panel("refresh",url);
	}
</script>
