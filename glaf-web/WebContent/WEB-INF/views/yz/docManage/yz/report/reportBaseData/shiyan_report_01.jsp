...
<div style="margin:0;"></div> 
	<c:if test="${dataFlag }">
		...
		<table border="0" cellspacing="1" cellpadding="0" style="width:100%;">
			<tr align="center">
				<td rowspan="3" align="right" >数据统计分析&nbsp;&nbsp;</td>
				<td align="right" >试件组数&nbsp;&nbsp;</td>
				<td>${pager.totalRecordCount }</td>
				<td align="right" >最大值（MPa）&nbsp;&nbsp;</td>
				<td>${maxValue }</td>
				<td align="right" >最小值（MPa）&nbsp;&nbsp;</td>
				<td>${minValue }</td>
				<td align="right" >平均值（MPa）&nbsp;&nbsp;</td>
				<td><fmt:formatNumber pattern="0.00" value="${avgValue }" /></td>
			</tr>
			<tr align="center">
				<td colspan="2" align="right" >标准差（MPa）&nbsp;&nbsp;</td>
				<td><fmt:formatNumber pattern="0.00" value="${stdevValue }" /></td>
				<td colspan="3" align="right" >强度不低于规定强度等级的百分率（%）&nbsp;&nbsp;</td>
				<td colspan="2"><fmt:formatNumber pattern="0.0%" value="${mpaCount/pager.totalRecordCount }" /></td>
			</tr>
			<tr>
				<td colspan="4" align="right" >混凝土生产质量水平类别&nbsp;&nbsp;</td>
				<td colspan="4">&nbsp;</td>
			</tr>
		</table>
