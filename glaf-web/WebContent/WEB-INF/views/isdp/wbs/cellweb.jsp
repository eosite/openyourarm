...
if(DetectActiveX()==true){
	...
	var url = "${pageContext.request.contextPath}/mx/cell/filedot/download?databaseCode=${param.databaseCode}&fileID=${param.fileID}";
	if("${param.type}"=="1"){
		url = "${pageContext.request.contextPath}/mx/cell/filedotUse/download?databaseCode=${param.databaseCode}&fileID=${param.fileID}";
	}
