...
<script type="text/javascript">
	...
	$(function(){
		...
		var idKeyValue=prefixTableName+'treeid',pIdKeyValue=prefixTableName+'parent_id',textNameValue,iconValue,
			...
			startValue,endValue,durationValue,preTaskValue;
		for (var i = 0; i < fieldJson.length; i++) {
			switch (fieldJson[i].columnType) {
				...
				case "pIdKey":
					...
					break;
				case "startKey":
					startValue = fieldJson[i].ColumnName==undefined ? '' : fieldJson[i].ColumnName ;
					break;
				case "endKey":
					endValue = fieldJson[i].ColumnName==undefined ? '' : fieldJson[i].ColumnName ;
					break;
				case "durationKey":
					durationValue = fieldJson[i].ColumnName==undefined ? '' : fieldJson[i].ColumnName ;
					break;
				case "preTaskKey":
					preTaskValue = fieldJson[i].ColumnName==undefined ? '' : fieldJson[i].ColumnName ;
					break;
				case "nameKey":
	...
	function confirm_field_click(){
		...
		//startKey
		dataItem = $("#startKey").data("kendoDropDownList").dataItem();
		if(dataItem){
			fieldId.push(dataItem.FieldId);
			name.push(dataItem.fname);
			temp = {};
		...
		//endKey
		dataItem = $("#endKey").data("kendoDropDownList").dataItem();
		if(dataItem){
			fieldId.push(dataItem.FieldId);
			name.push(dataItem.fname);
			temp = {};
		...
		//durationKey
		dataItem = $("#durationKey").data("kendoDropDownList").dataItem();
		if(dataItem){
			fieldId.push(dataItem.FieldId);
			name.push(dataItem.fname);
			temp = {};
		...
		//preTaskKey
		dataItem = $("#preTaskKey").data("kendoDropDownList").dataItem();
		if(dataItem){
			fieldId.push(dataItem.FieldId);
			name.push(dataItem.fname);
			temp = {};
...
<table style="width: 100%;text-align: center;">
	...
	<tr>
		...
		<td>
		<input type="text" id="startKey" style="width:200px"
			data-role="dropdownlist" 
			data-text-field="fname"
            data-value-field="dname"
            data-bind="
	...
	<tr>
		...
		<td>
		<input type="text" id="endKey" style="width:200px"
			data-role="dropdownlist" 
			data-text-field="fname"
            data-value-field="dname"
            data-bind="
	...
	<tr>
		<td>
		持续时间<span style="color: red;">*</span>：
		</td>
		<td>
		<input type="text" id="durationKey" style="width:200px"
			data-role="dropdownlist" 
			data-text-field="fname"
            data-value-field="dname"
            data-bind="
	...
	<tr>
		<td>
		前置任务<span style="color: red;">*</span>：
		</td>
		<td>
		<input type="text" id="preTaskKey" style="width:200px"
			data-role="dropdownlist" 
			data-text-field="fname"
            data-value-field="dname"
            data-bind="
