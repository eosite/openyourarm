...
var _menus = {
	"menus": [{
		...
		"menus": [ 
		{
			...
			"menuname": "待办事项",
			"icon": "icon-users",
			"url": "${contextPath}/mx/isdp/task/taskList?databaseId=${databaseId}&taskType=RN"
		},
		{
			"menuid": "12",
			"menuname": "已办事项",
			"icon": "icon-users",
			"url": "${contextPath}/mx/isdp/task/taskList?databaseId=${databaseId}&taskType=WD"
		},
		{
			"menuid": "13",
			"menuname": "退回事项",
			"icon": "icon-users",
			"url": "${contextPath}/mx/isdp/task/taskList?databaseId=${databaseId}&taskType=FB"
		},
		{
			"menuid": "14",
			"menuname": "全部事项",
			"icon": "icon-users",
			"url": "${contextPath}/mx/isdp/task/taskList?databaseId=${databaseId}&taskType=ALL"
		}]
	}]
};
