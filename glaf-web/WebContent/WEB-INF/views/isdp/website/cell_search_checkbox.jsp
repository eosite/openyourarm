...
<%
	...
	//String data = JSON.toJSONString(databases);
	////System.out.println("=======================打印测试："+data);
...
function doSubmit(){
	$("#nDiv",window.parent.document).empty();
	...
	for(var i=0;i<datas.length;i++){
		...
		rows.push(row);
		$("#nDiv",window.parent.document).append(row.fileName +" | " + row.url + " | " + row.systemName + " <br>" );
	}
...
<body class="easyui-layout">
	<div title="工程划分WBS" data-options="region:'west'" style="width:250px">
		<!-- systemName:<input type="text" value="${systemName}">databaseId:<input type="text" value="${databaseId}"> -->
	<p>
	...
	<div id="tb" style="height: 25px">
		...
		<a href="#" class="easyui-linkbutton" onclick="javascript:getChk()">返回编号</a>
	</div>
</body>
</html>