...
<script type="text/javascript">
  ...
  jQuery(function() {
    var viewModel = kendo.observable({
        "title": "${columnTransform.title}",
        "columnName": "${columnTransform.columnName}",
		"targetColumnName": "${columnTransform.targetColumnName}",
		"targetColumnPrecision": "${columnTransform.targetColumnPrecision}",
        "targetType": "${columnTransform.targetType}",
		"transformIfTargetColumnNotEmpty": "${columnTransform.transformIfTargetColumnNotEmpty}",
        "type": "${columnTransform.type}",
        "sort": "${columnTransform.sort}",
        "locked": "${columnTransform.locked}",
        "id": "${columnTransform.id}"
    });
    ...
    function saveData(){
        ...
        if (validator.validate()) {
	       var link = "<%=request.getContextPath()%>/mx/sys/columnTransform/saveColumnTransform";
  ...
  <!-- <tr>
    ...
    <td align="left">
        ...
        <input id="name" name="name" type="text" class="k-textbox"  
               ...
               value="${columnTransform.name}" validationMessage="请输入名称"/>
