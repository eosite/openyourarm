...
<script id="template" type="text/x-kendo-template">
   <div class="toolbar">
      <span class="x_content_title">数据源列表</span>&nbsp;&nbsp;
...
<script type="text/javascript">
    		...
    		"columns": [
	            ...
	            {"command": [{
	                ...
	                "click": function showDetails(e) {
				                ...
				                //alert(dataItem.id);
				           		var link = "${contextPath}/mx/etl/model/datasrcedit?id="+dataItem.id;
				           	 	editRow(link);
	                ...
	                "click": function deleteItem(e) {
	                            ...
	                            if(confirm("数据删除后不能恢复，确定删除吗？")){
	                                var link= "${contextPath}/mx/datasrc/deleteDataSource?sourceId="+dataItem.id;
	                ...
	                "click": function showSqlbuilder(e) {
	                            ...
	                            //alert(JSON.stringify(dataItem));
			                    //alert(dataItem.id);
				                var link = "${contextPath}/mx/etl/model/datain?id="+dataItem.id;
				                window.open(link);
			                }
	                }]
          		}]
    ...
    function zTreeOnClick(event, treeId, treeNode, clickFlag) {
 	...
 	function reloadGrid(){
		var link="${contextPath}/mx/datasrc/listDataSources";
    ...
    function addRow(){
        ...
        editRow('${contextPath}/mx/etl/model/datasrcedit');
    }

	function searchData(){
		var keywordsLike=document.getElementById("keywordsLike").value;
		keywordsLike = jQuery.base64.encode(keywordsLike);
		var link="${contextPath}/mx/datasrc/listDataSources?keywordsLike_base64="+keywordsLike;
