...
<script type="text/javascript">
    ...
    function saveData(){
		...
		jQuery.ajax({
				   type: "POST",
				   url: "<%=request.getContextPath()%>/mx/datamgr/dynamicSqlTree/saveSort?moduleId=${moduleId}&businessKey=${businessKey}&items="+str,
				   dataType:  'json',
				   error: function(data){
					   alert('服务器处理错误！');
				   },
...
<body>
        ...
        <div id="example">
            ...
            <div id="pages">
                ...
                <div id="sortable">
				<c:forEach items="${dynamicSqlTrees}" var="tree">
				  <c:if test="${tree.locked == 0}">
                    <div class="item">
            ...
            <style>
                ...
                .handler {
                    ...
                    background: url('<%=request.getContextPath()%>/images/handle.png') no-repeat 50% 50% #52aef7;
                }
