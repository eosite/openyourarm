...
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/scripts/bootstrap/css/bootstrap.min.css" media="all">
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/scripts/bootstrap/css/bootstrap-responsive.min.css" media="all">
                        ...
                        <div class="box-content">
                            ...
                            <form id="iForm" name="iForm" 
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="name" id="name" class="input-medium valid" data-rule-required="true" value="${wxUser.name}" style="width:320px;"><span class="maroon">*</span>
								...
								<div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="wxAppId" id="wxAppId" class="input-medium" data-rule-required="false" value="${wxUser.wxAppId}" style="width:320px;">
                                    </div>
                                </div>
								<div class="control-group">
                                    <label for="wechat_id" class="control-label">微信应用密码AppSecret：</label>
                                    <div class="controls">
                                        <input type="text" name="wxAppSecret" id="wxAppSecret" class="input-medium" data-rule-required="false" value="${wxUser.wxAppSecret}" style="width:320px;">
                                    </div>
                                </div>
								...
								<div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="lbsPosition" id="lbsPosition" class="input-medium" data-rule-required="false" value="${wxUser.lbsPosition}"  style="width:60px;">（米）
                                    </div>
                                </div>
