...
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/scripts/bootstrap/css/bootstrap.css" media="all">
                                        ...
                                        <tbody>
                                           <c:forEach items="${users}" var="user">
										     <tr>
												...
												<td>${user.token}</td>                                            
                                                <td>
                                                    <a href="<%=request.getContextPath()%>/mx/wx/wxUser/editAccount?id=${user.id}" class="btn" rel="tooltip" title="修改"><i class="icon-edit">修改</i></a>
                                                    <a href="#" onclick="parent.location.href='<%=request.getContextPath()%>/mx/wechat/index?accountId=${user.id}'" class="btn" rel="tooltip" title="管理"><i class="icon-cog">管理</i></a>
                                                </td>
                                            </tr>
                                           </c:forEach>
										  </tbody>
