...
<title>Cron表达式定义工具</title>
<link href="${contextPath}/scripts/Cron/themes/bootstrap/easyui.min.css" rel="stylesheet" type="text/css" />
<link href="${contextPath}/scripts/Cron/themes/icon.css" rel="stylesheet" type="text/css" />
<link href="${contextPath}/scripts/Cron/icon.css" rel="stylesheet" type="text/css" />
<style type="text/css">
        .line
        {
            height: 25px;
...
<body>
        <div class="easyui-layout" style="width:100%;height:560px; border: 1px rgb(202, 196, 196) solid;
            ...
            <div data-options="region:'south',border:false" style="height:250px">
                <fieldset style="border-radius: 3px; height: 220px;">
                    ...
                    <table style="height: 100px;">
                        <tbody>
                            ...
                            <tr>
                                <td colspan="8" id="runTime" style="text-align: center;">
                                   <button class="btStyle" id="save">确定</button>
                                   <button class="btStyle" id="reset">重置</button>
                                </td>
                            </tr>
                        </tbody>
                    </table>
		        ...
		        <script src="${contextPath}/scripts/Cron/jquery-1.6.2.min.js" type="text/javascript"></script>
			    <script src="${contextPath}/scripts/Cron/jquery.easyui.min.js" type="text/javascript"></script>
			    <script src="${contextPath}/scripts/Cron/cron.js" type="text/javascript"></script>
		        <script type="text/javascript">
                        /*killIe*/
                        $.parser.parse($("body"));
                        var cpro_id = "u1331261";
                        //初始化
                        var cronVal="${param.cronVal}";
                        $("#cron").val(cronVal);
                        btnFan();
                        function btnFan() {
                            //获取参数中表达式的值
                        ...
                        function initDay(strVal) {
                            ...
                            if (strVal == "*") {
                                ...
                                ary = strVal.split(",");
                                $(".dayList input").prop("checked", false);
                                for (var i = 0; i < ary.length; i++) {
                        ...
                        function initMonth(strVal) {
                            ...
                            if (strVal == "*") {
                                ...
                                objRadio.eq(4).attr("checked", "checked");
                                $(".mouthList input").prop("checked", false);
                                ary = strVal.split(",");
                                for (var i = 0; i < ary.length; i++) {
                        ...
                        function initWeek(strVal) {
                            ...
                            if (strVal == "*") {
                                ...
                                objRadio.eq(5).attr("checked", "checked");
                                ary = strVal.split(",");
                                $(".weekList input").prop("checked", false);
                                for (var i = 0; i < ary.length; i++) {
                      ...
                      //确认按钮点击事件绑定
                		$("#save").bind("click",function(e) {
                			...
                			if(cronVal&&cronVal!=""){
                				parent.setCronPropertyVal(cronVal);
