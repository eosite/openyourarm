...
<body>
	...
	<script type="text/javascript">
					...
					"command": [
						{
					               ...
					               "click": function showDetails(e) {
									 ...
									 viewProcessDef(dataItem.id,dataItem.name);
									},
								    "width" : "100px",
									},{
		...
		//查看流程定义
		function viewProcessDef(processDefinitionId,processName){
			$("#addDialog")
			.kendoWindow(
					{
						width : "95%",
			        ...
			        var url = "/mx/workflow/management/viewProcessDef?processDefinitionId="+processDefinitionId+"&processName="+processName;
