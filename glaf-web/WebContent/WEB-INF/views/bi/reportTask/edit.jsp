...
<script type="text/javascript">
    ...
    KindEditor.ready(function(K) {
       			    editor1 = K.create('textarea[id="sendContent"]', {
       				allowFileManager : true
       			});
    });

	function saveData(){
		document.getElementById("sendContent").value=editor1.html();
	...
	<tr>
		...
		<td align="left">
			<textarea type="textarea" id="sendContent" name="sendContent"  
				      class="x-textarea"  style="width:725px;height:420px;"><%=htmlData%></textarea>
		</td>
	</tr>
	<tr>
