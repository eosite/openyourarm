...
<div class="x_content_title"><img
	...
	alt="数据集列表">&nbsp;数据集列表</div>
<form id="iForm" name="iForm" method="post" action="<%=request.getContextPath()%>/mx/bi/chart/chartDatasetList?elementId=${elementId}&elementName=${elementName}&chartId=${chart.id}&xtype=${xtype}">
