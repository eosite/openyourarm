...
<script type="text/javascript">
  ...
  jQuery(function() {
   ...
   function save(){
	   ...
	   //form.method="post";
	   //form.action = "<%=request.getContextPath()%>/mx/chart/combination/saveChartCombination";
	   //form.submit();
	   var link = "<%=request.getContextPath()%>/mx/chart/combination/saveChartCombination";
    ...
    function openChart2(){
        var link = '<%=request.getContextPath()%>/mx/chart/combination/chooseChart?id=${chartCombination.id}&elementId=chartIds&elementName=chartNames';
		var x=100;
		var y=100;
		if(is_ie) {
				x=document.body.scrollLeft+event.clientX-event.offsetX-200;
...
<div class="x_content_title"><img
	src="<%=request.getContextPath()%>/images/window.png" alt="编辑组合图表信息">&nbsp;
编辑组合图表信息</div>
<br>
