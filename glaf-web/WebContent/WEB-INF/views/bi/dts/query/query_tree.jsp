...
<script type="text/javascript">
	...
	function getUrl(treeId, treeNode) {
		if(treeNode != null){
		    ...
		    return "<%=request.getContextPath()%>/rs/dts/query/treeJson?keywordsLike_base64=${keywordsLike_base64}&selected=${selected}"+param;
		}
		return "<%=request.getContextPath()%>/rs/dts/query/treeJson?keywordsLike_base64=${keywordsLike_base64}&nodeCode=${nodeCode}&selected=${selected}";
	}
...
<div class="easyui-layout" data-options="fit:true">  
  <div data-options="region:'north',split:true,border:true" style="height:42px"> 
	...
	<form id="iForm" name="iForm" method="post" 
          action="<%=request.getContextPath()%>/mx/dts/query/queryTree?elementId=${elementId}&elementName=${elementName}&nodeCode=report_category&selected=${selected}">
