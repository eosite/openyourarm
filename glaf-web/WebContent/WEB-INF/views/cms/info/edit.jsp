...
<%
	...
	if(publicInfo != null && publicInfo.getContent() != null){
		htmlData = htmlspecialchars(publicInfo.getContent());
	}
%>
<!DOCTYPE html>
<html>
...
<script type="text/javascript">
    ...
    KindEditor.ready(function(K) {
			    editor1 = K.create('textarea[id="content"]'<c:if test="${(empty publicInfo) || (publicInfo.status <= 0)  }">, {
	...
	jQuery(function(){
		jQuery.get('<%=request.getContextPath()%>/mx/attachment/getCount?referId=${publicInfo.id}&referType=9999',{qq:'xx'},function(data){
	 ...
	 <form id="iForm" name="iForm" method="post">
		...
		<tbody>
			...
			<tr>
				 <td height="28">内容</td>
				 <td height="28" >
				 <textarea  id="content" name="content" class="x-textarea"  rows="5" cols="58" style="width:715px;height:580px;visibility:hidden;"><%=htmlData%></textarea> 
				 <br>  
				 </td>
			</tr>
