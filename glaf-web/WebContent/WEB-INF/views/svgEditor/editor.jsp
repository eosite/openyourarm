...
<link rel="icon" type="${contextPath}/scripts/plugins/bootstrap/svgEditor/editor/image/png" href="images/logo.png"/>

<!--{if svg_edit_release}>
  <link rel="stylesheet" href="css/method-draw.compiled.css" type="text/css"/>
<!{else}-->
  <link rel="stylesheet" href="${contextPath}/scripts/plugins/bootstrap/svgEditor/editor/lib/jgraduate/css/jPicker.css" type="text/css"/>
  <link rel="stylesheet" href="${contextPath}/scripts/plugins/bootstrap/svgEditor/editor/lib/jgraduate/css/jgraduate.css" type="text/css"/>
  <link rel="stylesheet" href="${contextPath}/scripts/plugins/bootstrap/svgEditor/editor/css/method-draw.css" type="text/css"/>
  <link rel="stylesheet" href="${contextPath}/scripts/plugins/bootstrap/svgEditor/editor/css/fonts.css" type="text/css"/>
<!--{endif}-->
  <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no"/>
  <meta name="apple-mobile-web-app-capable" content="yes"/>


  <script type="text/javascript" src="${contextPath}/scripts/plugins/bootstrap/svgEditor/editor/lib/jquery.js"></script>

  <script type="text/javascript">
      var contextPath = '${contextPath}' ,baseUrl = contextPath+'/scripts/plugins/bootstrap/svgEditor/editor';
  </script>

<!--{if svg_edit_release}>
  <script type="text/javascript" src="method-draw.compiled.js"></script>
<!{else}-->
  <script type="text/javascript" src="${contextPath}/scripts/plugins/bootstrap/svgEditor/editor/lib/pathseg.js"></script>
  <script type="text/javascript" src="${contextPath}/scripts/plugins/bootstrap/svgEditor/editor/lib/touch.js"></script>
  <script type="text/javascript" src="${contextPath}/scripts/plugins/bootstrap/svgEditor/editor/lib/js-hotkeys/jquery.hotkeys.min.js"></script>
  <script type="text/javascript" src="${contextPath}/scripts/plugins/bootstrap/svgEditor/editor/icons/jquery.svgicons.js"></script>
  <script type="text/javascript" src="${contextPath}/scripts/plugins/bootstrap/svgEditor/editor/lib/jgraduate/jquery.jgraduate.js"></script>
  <script type="text/javascript" src="${contextPath}/scripts/plugins/bootstrap/svgEditor/editor/lib/contextmenu/jquery.contextMenu.js"></script>
  <script type="text/javascript" src="${contextPath}/scripts/plugins/bootstrap/svgEditor/editor/lib/jquery-ui/jquery-ui-1.8.17.custom.min.js"></script>
  <script type="text/javascript" src="${contextPath}/scripts/plugins/bootstrap/svgEditor/editor/src/browser.js"></script>
  <script type="text/javascript" src="${contextPath}/scripts/plugins/bootstrap/svgEditor/editor/src/svgtransformlist.js"></script>
  <script type="text/javascript" src="${contextPath}/scripts/plugins/bootstrap/svgEditor/editor/src/math.js"></script>
  <script type="text/javascript" src="${contextPath}/scripts/plugins/bootstrap/svgEditor/editor/src/units.js"></script>
  <script type="text/javascript" src="${contextPath}/scripts/plugins/bootstrap/svgEditor/editor/src/svgutils.js"></script>
  <script type="text/javascript" src="${contextPath}/scripts/plugins/bootstrap/svgEditor/editor/src/sanitize.js"></script>
  <script type="text/javascript" src="${contextPath}/scripts/plugins/bootstrap/svgEditor/editor/src/history.js"></script>
  <script type="text/javascript" src="${contextPath}/scripts/plugins/bootstrap/svgEditor/editor/src/select.js"></script>
  <script type="text/javascript" src="${contextPath}/scripts/plugins/bootstrap/svgEditor/editor/src/draw.js"></script>
  <script type="text/javascript" src="${contextPath}/scripts/plugins/bootstrap/svgEditor/editor/src/path.js"></script>
  <script type="text/javascript" src="${contextPath}/scripts/plugins/bootstrap/svgEditor/editor/src/dialog.js"></script>
  <script type="text/javascript" src="${contextPath}/scripts/plugins/bootstrap/svgEditor/editor/src/svgcanvas.js"></script>
  <script type="text/javascript" src="${contextPath}/scripts/plugins/bootstrap/svgEditor/editor/src/method-draw.js"></script>
  <script type="text/javascript" src="${contextPath}/scripts/plugins/bootstrap/svgEditor/editor/lib/jquery-draginput.js"></script>
  <script type="text/javascript" src="${contextPath}/scripts/plugins/bootstrap/svgEditor/editor/lib/contextmenu.js"></script>
  <script type="text/javascript" src="${contextPath}/scripts/plugins/bootstrap/svgEditor/editor/lib/jgraduate/jpicker.min.js"></script>
  <script type="text/javascript" src="${contextPath}/scripts/plugins/bootstrap/svgEditor/editor/lib/mousewheel.js"></script>
  <script type="text/javascript" src="${contextPath}/scripts/plugins/bootstrap/svgEditor/editor/extensions/ext-eyedropper.js"></script>
  <script type="text/javascript" src="${contextPath}/scripts/plugins/bootstrap/svgEditor/editor/extensions/ext-shapes.js"></script>
  <script type="text/javascript" src="${contextPath}/scripts/plugins/bootstrap/svgEditor/editor/extensions/ext-grid.js"></script>
  <script type="text/javascript" src="${contextPath}/scripts/plugins/bootstrap/svgEditor/editor/lib/requestanimationframe.js"></script>
  <script type="text/javascript" src="${contextPath}/scripts/plugins/bootstrap/svgEditor/editor/lib/taphold.js"></script>
  <script type="text/javascript" src="${contextPath}/scripts/plugins/bootstrap/svgEditor/editor/lib/filesaver.js"></script>
<!--{endif}-->
...
<div id="menu_bar">
  <a class="menu">
    ...
    <div class="menu_list">
      <div id="tool_about" class="menu_item">关于编辑器...</div>
      <div class="separator"></div>
      <div id="tool_about" class="menu_item">快捷键...</div>
    </div>
  </a>
  ...
  <div class="menu">
    ...
    <div class="menu_list" id="file_menu"> 
      <div id="tool_clear" class="menu_item">新文档</div>
      <div id="tool_open" class="menu_item" style="display: none;"><div id="fileinputs"></div>打开 SVG...</div>
      <div id="tool_import" class="menu_item" style="display: none;"><div id="fileinputs_import"></div>导入图片...</div>
      <div id="tool_save" class="menu_item">保存图片... <span class="shortcut">⌘S</span></div>
      <div id="tool_export" class="menu_item">导出PNG图片</div>
    </div>
  </div>
  ...
  <div class="menu">
    ...
    <div class="menu_list" id="edit_menu">
      <div class="menu_item" id="tool_undo">撤销 <span class="shortcut">⌘Z</span></div>
      <div class="menu_item" id="tool_redo">恢复 <span class="shortcut">⌘Y</span></div>
      <div class="separator"></div>
      <div class="menu_item action_selected disabled" id="tool_cut">剪切 <span class="shortcut">⌘X</span></div>
      <div class="menu_item action_selected disabled" id="tool_copy">复制 <span class="shortcut">⌘C</span></div>
      <div class="menu_item action_selected disabled" id="tool_paste">粘贴 <span class="shortcut">⌘V</span></div>
      <div class="menu_item action_selected disabled" id="tool_clone">复制副本 <span class="shortcut">⌘D</span></div>
  ...
  <div class="menu">
    ...
    <div class="menu_list"  id="object_menu">
      <div class="menu_item action_selected disabled" id="tool_move_top">置为顶层 <span class="shortcut">⌘⇧↑</span></div>
      <div class="menu_item action_selected disabled" id="tool_move_up">上移一层 <span class="shortcut">⌘↑</span></div>
      <div class="menu_item action_selected disabled" id="tool_move_down">下移一层 <span class="shortcut">⌘↓</span></div>
      <div class="menu_item action_selected disabled" id="tool_move_bottom">置为底层 <span class="shortcut">⌘⇧↓</span></div>
      <div class="separator"></div>
      <div class="menu_item action_multi_selected disabled" id="tool_group">组合 <span class="shortcut">⌘G</span></div>
      <div class="menu_item action_group_selected disabled" id="tool_ungroup">取消组合 <span class="shortcut">⌘⇧G</span></div>
      <div class="separator"></div>
      <div class="menu_item action_path_convert_selected disabled" id="tool_topath">转换为路径模式</div>
      <div class="menu_item action_path_selected disabled" id="tool_reorient">调整路径</div>
    </div>
  </div>
  ...
  <div class="menu">
    ...
    <div class="menu_list" id="view_menu">
        <div class="menu_item push_button_pressed" id="tool_rulers">显示标尺</div>
        <div class="menu_item" id="tool_wireframe">显示线框</div>
        <div class="menu_item" id="tool_snap">对齐网格</div>
        <div class="separator"></div>
        <div class="menu_item" id="tool_source">源码... <span class="shortcut">⌘U</span></div>
    </div>
  </div>
...
<div id="tools_top" class="tools_panel">
  ...
  <div id="canvas_panel" class="context_panel">
    ...
    <div class="draginput">
      ...
      <select id="resolution">
        <option id="selectedPredefined" selected="selected">自定义</option>
        <option>640x480</option>
        <option>800x600</option>
        <option>1024x768</option>
        <option>1280x960</option>
        <option>1600x1200</option>
        <option id="fitToContent" value="content">填充内容</option>
      </select>
      <div class="caret"></div>
      <label id="resolution_label">自定义</label>
    </div>
  ...
  <div id="rect_panel" class="context_panel">
    ...
    <label>
      <input id="rect_x" class="attr_changer" data-title="改变X轴坐标" size="3" data-attr="x" pattern="[0-9]*" />
      <span>X</span> 
    </label>
    <label>
  ...
  <div id="ellipse_panel" class="context_panel clearfix">
    ...
    <label id="tool_ellipse_cx">
      <input id="ellipse_cx" class="attr_changer" data-title="改变椭圆的x坐标点" size="3" data-attr="cx" pattern="[0-9]*" />
      <span>X</span>
    </label>
      ...
      <div class="toolset align_buttons" id="tool_position">
          <label>
            <div class="col last clear" id="position_opts">
              ...
              <div class="draginput_cell" id="tool_poscenter" title="居中对齐"></div>
              <div class="draginput_cell" id="tool_posright" title="右对齐"></div>
              <div class="draginput_cell" id="tool_postop" title="顶端对齐"></div>
              <div class="draginput_cell" id="tool_posmiddle" title="中部对齐"></div>
              <div class="draginput_cell" id="tool_posbottom" title="底部对齐"></div>
            </div>
          </label>
      </div>    
    </div>
  ...
  <div id="stroke_panel" class="context_panel clearfix">
    ...
    <div class="toolset" data-title="Change stroke">
      <label>
        ...
        <span class="icon_label">描边宽度</span>
      </label>
    </div>
...
<div id="tools_left" class="tools_panel">
  <div class="tool_button" id="tool_select" title="选取 [V]"></div>
  <div class="tool_button" id="tool_fhpath" title="画笔 [P]"></div>
  <div class="tool_button" id="tool_line" title="直线 [L]"></div>
  <div class="tool_button" id="tool_rect" title="矩形 Tool [R]"></div>
  <div class="tool_button" id="tool_ellipse" title="椭圆/圆 Tool [C]"></div>
  <div class="tool_button" id="tool_path" title="路径 [P]"></div>
  <div class="tool_button" id="tool_text" title="文字 [T]"></div>
  <div class="tool_button" id="tool_zoom" title="放大 [Z]"></div>
  
  <div id="color_tools">
        <div id="tool_switch" title="填充描边颜色交换 [X]"></div>
        <div class="color_tool active" id="tool_fill">
          <label class="icon_label" title="改变填充颜色"></label>
          <div class="color_block">
            <div id="fill_bg"></div>
        ...
        <div class="color_tool" id="tool_stroke">
            <label class="icon_label" title="改变描边颜色"></label>
          <div class="color_block">
            <div id="stroke_bg"></div>
            <div id="stroke_color" class="color_block" title="改变描边颜色"></div>
          </div>
        </div>
  </div>
</div> <!-- tools_left -->
...
<div id="tools_bottom" class="tools_panel">
    ...
    <!-- Zoom buttons -->
  <div id="zoom_panel" class="toolset" title="放大缩小">
  ...
  <div id="tools_bottom_3">
    <div id="palette" title="左键点击改变填充颜色, shift-左键 改变描边颜色"></div>
  </div>
</div>
...
<ul id="cmenu_canvas" class="contextMenu">
  ...
  <li class="separator"><a href="#group">组合<span class="shortcut">⌘G</span></a></li>
  <li><a href="#ungroup">取消组合<span class="shortcut">⌘⇧G</span></a></li>
  <li class="separator"><a href="#move_front">置为顶层<span class="shortcut">⌘⇧↑</span></a></li>
  <li><a href="#move_up">上移一层<span class="shortcut">⌘↑</span></a></li>
  <li><a href="#move_down">下移一层<span class="shortcut">⌘↓</span></a></li>
  <li><a href="#move_back">置为底层<span class="shortcut">⌘⇧↓</span></a></li>
</ul>
<script type="text/javascript">
    var frameId = '${param.frameId}',eleId =  frameId.replace("_iframe","");
    $(function() {
      setTimeout(function(){
          var $ele = window.parent.$("#"+eleId).data("svgEditor"),
              dval = "";
          $ele && $ele.options && $ele.options.defaultValue && (dval = $ele.options.defaultValue) ;
          dval && svgCanvas.setSvgString(dval);
      },500)
