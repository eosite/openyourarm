...
<br>
<center>
<form action="<%=request.getContextPath()%>/mx/form/formDictory/importJson" method="post"
	enctype="multipart/form-data" name="iForm" class="x-form">
<div class="content-block"  style=" width: 98%;" >
<br>
<div class="x_content_title"><img
	src="<%=request.getContextPath()%>/images/window.png" alt="导入数据字典">&nbsp;导入数据字典
</div>
 
<div align="center">
<br>
<label for="file">请选择导入的数据字典，必须是json格式或多个json文件的zip包</label>&nbsp;&nbsp;<br>
