...
<script type="text/javascript">
	 ...
	 var setting = {
			async: {
				enable: true,
				url: "<%=request.getContextPath()%>/mx/form/treedot/treeJson?databaseId=${databaseId}&searchWord_enc=${searchWord_enc}",
				dataFilter: filter
			},
			check: {
				enable: true,
	...
	function switchDB(){
		...
		document.iForm.action="<%=request.getContextPath()%>/mx/form/treedot?databaseId="+databaseId+"&elementId=${elementId}&elementName=${elementName}";
