        ...
        "dataSource": {
            ...
            "transport": {
                ...
                "read": {
                            ...
                            "type": "POST",
							"url": "<%=request.getContextPath()%>/rs/form/layout/data"
						}
            },
        ...
        "columns": [
				...
				"command": [{
					...
					"click": function showDetails(e) {
								...
								var link = "<%=request.getContextPath()%>/mx/form/layout/edit?id="+dataItem.id;
								editRow(link);
						 }
					},
					{
					"text": "预览",
					"name": "preview",
					"click": function preview(e) {
								var dataItem = this.dataItem(jQuery(e.currentTarget).closest("tr"));
								var link = "<%=request.getContextPath()%>/mx/form/layout/preview?id="+dataItem.id;
								layoutPreview(link);
						}
					}]
			  }
