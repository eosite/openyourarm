...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		var ctypes =  [{value:'id',text:'id'},{value:'parentid',text:'parentid'},{value:'title',text:'标题'},{value:'value',text:'内容'},{value:'datetime',text:'日期'},{value:'imgUrl',text:'服务器目录'},{value:'datasetId',text:'数据库'},{value:'imgName',text:'图片名称'},{value:'number',text:'数值'}] ;
		//编辑字段
