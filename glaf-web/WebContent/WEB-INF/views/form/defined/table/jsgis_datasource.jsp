...
<script type="text/javascript">
	...
	$(document).ready(function() {
			...
			columns : [{
				...
				command : [ {
					...
					click : function(e) {
			         ...
			         text : "↑" ,
			         click: function(e){
			         	var $target = $(e.target),$tr = $target.parents("tr"),index = $tr.index() ;
			         	if(index){
							var temp = selectDatasource[index-1] ;
			         		selectDatasource[index-1] = selectDatasource[index];
			         		selectDatasource[index] = temp ;
			         		rushSelectDatasourceGrid();
			         	}
			         }
		        },{
			         ...
			         click: function(e){
			         	var $target = $(e.target),$tr = $target.parents("tr"),index = $tr.index() ;
			         	if(selectDatasource.length - 1 != index){
							var temp = selectDatasource[index+1] ;
			         		selectDatasource[index+1] = selectDatasource[index];
			         		selectDatasource[index] = temp ;
			         		rushSelectDatasourceGrid();
		...
		var ctypes =  [{value:'x',text:'坐标信息'},{value:'y',text:'图层信息'}] ;
		//编辑字段
