	...
	$(document).ready(function() {
		...
		$("#grid").kendoGrid({
			...
			
			{
				field : 'tfontSize',
				title : '标题字体大小',
				headerTemplate : '<span class="tooltip" title="如果是空则最大值被自动计算">标题字体大小</span>',
			...
			},
			 {
				field : 'ttextColor',
				title : '标题字体颜色',
				headerTemplate : '<span class="tooltip" title="标题字体颜色">标题字体颜色</span>',
				...
				field : 'tWeight',
				title : '标题是否加粗',
				headerTemplate : '<span class="tooltip" title="是否显示">标题是否加粗</span>',
				template : function(dataItem){
			...
			}, 
			{
				field : 'tStyle',
				title : '标题字体倾斜',
				headerTemplate : '<span class="tooltip" title="是否显示">标题字体倾斜</span>',
				template : function(dataItem){
				...
				field : 'vfontSize',
				title : '数值字体大小',
				headerTemplate : '<span class="tooltip" title="如果是空则最大值被自动计算">数值字体大小</span>',
				editor : function(container,options){
					 $("<input/>").attr('name',options.field).appendTo(container).kendoNumericTextBox({});
				}
			},
			 {
				field : 'vtextColor',
				title : '数值字体颜色',
				headerTemplate : '<span class="tooltip" title="轴字体颜色">数值字体颜色</span>',
				template : function(dataItem){
					return "<div style='width:50px;height:20px;background-color:"+dataItem.textColor+"'></div>";
				},
				editor : function(container,options){
				...
				field : 'vWeight',
				title : '数值是否加粗',
				headerTemplate : '<span class="tooltip" title="是否显示">数值是否加粗</span>',
				template : function(dataItem){
					return dataItem.axisWeight?"是":"否" ;
				}
			}, 
			{
				field : 'vStyle',
				title : '数值字体倾斜',
				headerTemplate : '<span class="tooltip" title="是否显示">数值字体倾斜</span>',
				template : function(dataItem){
					return dataItem.axisStyle?"是":"否" ;
				}
			},{
