	...
	$(document).ready(function() {
		...
		$("#grid").kendoGrid({
			...
			columns : [ 
			{
				field : 'yfontSize',
				title : 'y轴字体大小',
				headerTemplate : '<span class="tooltip" title="如果是空则最大值被自动计算">y轴字体大小</span>',
			...
			},
			 {
				field : 'ytextColor',
				title : 'y轴字体颜色',
				headerTemplate : '<span class="tooltip" title="轴字体颜色">y轴字体颜色</span>',
				...
				field : 'ymin',
				title : 'y轴刻度最小值',
				headerTemplate : '<span class="tooltip" title="如果是空则最大值被自动计算">y轴刻度最小值</span>',
				editor : function(container,options){
					 $("<input/>").attr('name',options.field).appendTo(container).kendoNumericTextBox({});
				}
			},{
				field : 'ymax',
				title : 'y轴刻度最大值',
				headerTemplate : '<span class="tooltip" title="如果是空则最大值被自动计算">y轴刻度最大值</span>',
				editor : function(container,options){
					 $("<input/>").attr('name',options.field).appendTo(container).kendoNumericTextBox({});
				}
			},{
