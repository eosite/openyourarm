...
<script type="text/javascript">
	...
	$(function(){
		...
		var idKeyValue=prefixTableName+'treeid',pIdKeyValue=prefixTableName+'parent_id',textNameValue,iconValue,
			urlValue,indexValue=prefixTableName+'index_id';
		for (var i = 0; i < fieldJson.length; i++) {
			switch (fieldJson[i].columnType) {
				...
				case "nameKey":
					...
					break;
				case "urlKey":
					urlValue = fieldJson[i].ColumnName==undefined ? '' : fieldJson[i].ColumnName ;
					break;
				case "icon":
	...
	function confirm_field_click(){
		...
		//iconOpen
		dataItem = $("#url").data("kendoDropDownList").dataItem();
		if(dataItem){
			fieldId.push(dataItem.FieldId);
			name.push(dataItem.fname);
			temp = {};
...
<table style="width: 100%;text-align: center;">
	...
	<tr>
		...
		<td>
		<input class='menuhid' type="text" id="textName" style="width:200px"
			data-role="dropdownlist" 
			data-text-field="fname"
            data-value-field="dname"
            data-bind="
	...
	<tr>
		...
		<td>
		<input type="text" id="url" style="width:200px"
			data-role="dropdownlist" 
			data-text-field="fname"
            data-value-field="dname"
            data-bind="
