...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$("#grid").kendoGrid({
			...
			{
				field : 'title',
				headerTemplate : '<span class="tooltip" title="这是轴标题">横线标题</span>',
			},
			{
				field : 'yLineVal',
				title : '横线值',
				headerTemplate : '<span class="tooltip" title="横线值若不设置则设置默认">横线值</span>',
			...
			},
			{
				field : 'lineColor',
				title : '颜色',
				headerTemplate : '<span class="tooltip" title="轴字体颜色">折线颜色</span>',
