...
<script type="text/javascript" src="${pageContext.request.contextPath}/webfile/js/verificationSetting.js"></script>
<style>
html, body {
	height: 100%;
	padding: 0;
			...
			<table style="width: 100%;height: 100%">
				<tr>
					<td valign="middle">
						...
						<span style="display: inline;font-size: 28px;font-weight: bold;">页面规则验证</span>
					</td>
