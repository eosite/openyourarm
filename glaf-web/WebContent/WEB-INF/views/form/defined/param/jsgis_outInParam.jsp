...
<script type="text/javascript">
	...
	$(function(){
		...
		var fn = mt.$parent.parent[mt.fn],paramTable = $("#param-table");
		...
		$("#button2").kendoButton({
			...
			click : function(e) {
				...
				mt.$parent['retParamFn']([{name : '输入输出关系',datas : rets}]);
	...
	function tableFunc(id){
		...
		var $this = $('#' + id),K = this,$tr = [
             "<tr>",
       	  		"<td class='td-cls'>",
       		  		" <input type='text' class='k-textbox textbox-menu' name='field' style='width:280px;' />",
       				" <ul class='in-menu conmenu' style='display:none;width:280px;' ></ul>",
       	  		"</td>",
       	  		
       	  		"<td class='td-cls'> ==> </td>",
       	  		
       	  		"<td class='td-cls'>",
       		  		" <input type='text' class='k-textbox textbox-menu' name='param' style='width:280px;' />",
       				" <ul class='out-menu conmenu' style='display:none;width:280px;' ></ul>",
       	  		"</td>",
