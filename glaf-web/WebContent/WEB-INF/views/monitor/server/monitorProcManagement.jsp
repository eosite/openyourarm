                    ...
                    <form style="padding:10px 10px;overflow:hidden;" class="form-horizontal">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-xs-8">
                                    <input type="text" class="form-control" disabled="true" readonly="true" value="{{memSizeGb}} Gb" style="display:inline-block;width:30%;">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-xs-8">
                                    <input type="text" class="form-control" disabled="true" readonly="true" value="{{diskSizeGb}} Gb" style="display:inline-block;width:30%;">
...
<template id="editGridTemplate">
    <form style="padding:10px 10px;overflow:hidden;" class="form-horizontal">
        ...
        <div class="form-group">
            <div class="row">
                <label class="control-label col-xs-3">程序名：</label>
                <div class="col-xs-8">
                    <input type="text" name="processName" class="form-control" maxlength="50" required value="{{processName}}">
                </div>
            </div>
        </div>
        <div class="form-group">
            <div class="row">
                <label class="control-label col-xs-3">中文名称：</label>
                <div class="col-xs-8">
                    <input type="text" name="name" class="form-control" maxlength="50" required value="{{name}}">
                </div>
            </div>
        ...
        <div class="form-group">
            <div class="row">
                <label class="control-label col-xs-3">厂家：</label>
                <div class="col-xs-8">
        ...
        <div class="form-group">
            <div class="row">
                ...
                <div class="col-xs-8">
                    <input type="text" name="ver" class="form-control" maxlength="50" value="{{ver}}">
                </div>
            </div>
        </div>
        <div class="form-group">
            <div class="row">
                <label class="control-label col-xs-3">端口号：</label>
                <div class="col-xs-8">
                    <input type="text" name="port" class="form-control" maxlength="50" value="{{port}}">
                </div>
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <div class="row">
                <label class="control-label col-xs-3">启动服务地址：</label>
                <div class="col-xs-8">
                    <input type="text" name="startAddress" class="form-control" maxlength="150" required value="{{startAddress}}">
                </div>
            </div>
        </div>
        <div class="form-group">
            <div class="row">
                <label class="control-label col-xs-3">启动服务命令：</label>
                <div class="col-xs-8">
                    <input type="text" name="startCommand" class="form-control" maxlength="150" required value="{{startCommand}}">
                </div>
            </div>
        </div>
        <div class="form-group">
            <div class="row">
                <label class="control-label col-xs-3">停止服务地址：</label>
                <div class="col-xs-8">
                    <input type="text" name="stopAddress" class="form-control" maxlength="150" required value="{{stopAddress}}">
                </div>
            </div>
        </div>
        <div class="form-group">
            <div class="row">
                <label class="control-label col-xs-3">停止服务命令：</label>
                <div class="col-xs-8">
                    <input type="text" name="stopCommand" class="form-control" maxlength="150" required value="{{stopCommand}}">
                </div>
            </div>
        </div>
        <div class="form-group">
            <div class="row">
                <label class="control-label col-xs-3">终止服务地址：</label>
                <div class="col-xs-8">
                    <input type="text" name="terminateAddress" class="form-control" maxlength="150" required value="{{terminateAddress}}">
                </div>
            </div>
        </div>
        <div class="form-group">
            <div class="row">
                <label class="control-label col-xs-3">终止服务命令：</label>
                <div class="col-xs-8">
                    <input type="text" name="terminateCommand" class="form-control" maxlength="150" required value="{{terminateCommand}}">
                </div>
            </div>
        </div>
        <div class="form-group">
...
<script src="${contextPath}/scripts/monitor/server/monitorProcManagement.js"></script>
