...
var ProcessDiagramGenerator = {	
	...
	// add by dane 2015-09-22  设置选中节点边框颜色
	setSelectedHighLights: function(processDefinitionId,element){
		...
		if(element.flow)
		{
			processDiagramCanvas.selectedHighLightFlow(element.id);
		}
		else
		{
		   processDiagramCanvas.selectedHighLightActivity(element.id);
		}
		//取消之前选中高亮
		if(this.selectedElement&&this.selectedElement.id)
		{
			processDiagramCanvas.cancelHighLight(this.selectedElement.id);
		}
