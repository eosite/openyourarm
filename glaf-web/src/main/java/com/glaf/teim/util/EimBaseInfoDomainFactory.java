 ...
 *
 */
public class EimBaseInfoDomainFactory {

    public static final String TABLENAME = "EIM_BASEINFO";
    ...
    static{
        ...
        columnMap.put("secret", "SECRET_");
        columnMap.put("paasId", "PAASID_");
	...
	javaTypeMap.put("id", "String");
        ...
        javaTypeMap.put("secret", "String");
        javaTypeMap.put("paasId", "String");
    ...
    public static TableDefinition getTableDefinition(String tableName) {
        ...
        tableDefinition.setName("EimBaseInfo");
        ...
        ColumnDefinition secret = new ColumnDefinition();
        secret.setName("secret");
        secret.setColumnName("SECRET_");
        secret.setJavaType("String");
        secret.setLength(150);
        tableDefinition.addColumn(secret);

        ColumnDefinition paasId = new ColumnDefinition();
        paasId.setName("paasId");
        paasId.setColumnName("PAASID_");
        paasId.setJavaType("String");
        paasId.setLength(30);
        tableDefinition.addColumn(paasId);
    ...
    private EimBaseInfoDomainFactory() {
