 ...
 *
 */
public class EimServerCategoryDomainFactory {

    public static final String TABLENAME = "EIM_SERVER_CATEGORY";
    ...
    public static TableDefinition getTableDefinition(String tableName) {
        ...
        tableDefinition.setName("EimServerCategory");
    ...
    private EimServerCategoryDomainFactory() {
