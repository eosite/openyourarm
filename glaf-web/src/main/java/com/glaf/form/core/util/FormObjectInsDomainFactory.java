 ...
 *
 */
public class FormObjectInsDomainFactory {

    public static final String TABLENAME = "FORM_OBJECT_INS";
    ...
    public static TableDefinition getTableDefinition(String tableName) {
        ...
        tableDefinition.setName("FormObjectIns");
    ...
    private FormObjectInsDomainFactory() {
