 ...
 *
 */
public class FormNodeMessageDomainFactory {

    public static final String TABLENAME = "FORM_NODE_MESSAGE";
    ...
    static{
        ...
        columnMap.put("sendLaterTime", "SENDLATERTIME_");
	...
	javaTypeMap.put("id", "Long");
        ...
        javaTypeMap.put("sendLaterTime", "Date");
    }
    ...
    public static TableDefinition getTableDefinition(String tableName) {
        ...
        tableDefinition.setName("FormNodeMessage");
        ...
        ColumnDefinition sendLaterTime = new ColumnDefinition();
        sendLaterTime.setName("sendLaterTime");
        sendLaterTime.setColumnName("SENDLATERTIME_");
        sendLaterTime.setJavaType("Date");
        tableDefinition.addColumn(sendLaterTime);
    ...
    private FormNodeMessageDomainFactory() {
