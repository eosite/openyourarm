...
public class FormNodeMessageHistoryQuery extends DataQuery {
    ...
    public FormNodeMessageHistoryQuery() {
    ...
    public FormNodeMessageHistoryQuery telephone(String telephone){
	if (telephone == null) {
    ...
    public FormNodeMessageHistoryQuery telephoneLike( String telephoneLike){
    ...
    public FormNodeMessageHistoryQuery telephones(List<String> telephones){
        if (telephones == null) {
    ...
    public FormNodeMessageHistoryQuery msg(String msg){
	if (msg == null) {
    ...
    public FormNodeMessageHistoryQuery msgLike( String msgLike){
        if (msgLike == null) {
            throw new RuntimeException("msg is null");
        }
        this.msgLike = msgLike;
    ...
    public FormNodeMessageHistoryQuery msgs(List<String> msgs){
        if (msgs == null) {
    ...
    public FormNodeMessageHistoryQuery state(Integer state){
	if (state == null) {
    ...
    public FormNodeMessageHistoryQuery stateGreaterThanOrEqual(Integer stateGreaterThanOrEqual){
    ...
    public FormNodeMessageHistoryQuery stateLessThanOrEqual(Integer stateLessThanOrEqual){
    ...
    public FormNodeMessageHistoryQuery states(List<Integer> states){
        if (states == null) {
    ...
    public FormNodeMessageHistoryQuery creator(String creator){
	if (creator == null) {
    ...
    public FormNodeMessageHistoryQuery creatorLike( String creatorLike){
        if (creatorLike == null) {
            throw new RuntimeException("creator is null");
        }
        this.creatorLike = creatorLike;
    ...
    public FormNodeMessageHistoryQuery creators(List<String> creators){
        if (creators == null) {
    ...
    public FormNodeMessageHistoryQuery createDateGreaterThanOrEqual(Date createDateGreaterThanOrEqual){
    ...
    public FormNodeMessageHistoryQuery createDateLessThanOrEqual(Date createDateLessThanOrEqual){
    ...
    public FormNodeMessageHistoryQuery result(String result){
	if (result == null) {
    ...
    public FormNodeMessageHistoryQuery resultLike( String resultLike){
        if (resultLike == null) {
            throw new RuntimeException("result is null");
        }
        this.resultLike = resultLike;
    ...
    public FormNodeMessageHistoryQuery results(List<String> results){
        if (results == null) {
