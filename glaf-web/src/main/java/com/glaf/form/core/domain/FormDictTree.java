...
@Entity
@Table(name = "form_dict_tree")
public class FormDictTree implements Serializable, TreeModel, JSONable {
	...
	@javax.persistence.Transient
	protected FormDictTree parentTree;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		FormDictTree other = (FormDictTree) obj;
		if (id != other.id)
			return false;
		return true;
	}
	...
	public FormDictTree getParentTree() {
		return parentTree;
	}
	...
	public void setParentTree(FormDictTree parentTree) {
	...
	public JSONObject toJsonObject() {
		return FormDictTreeJsonFactory.toJsonObject(this);
	}

	public ObjectNode toObjectNode() {
		return FormDictTreeJsonFactory.toObjectNode(this);
	}
