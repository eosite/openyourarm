...
public class FormDictTreeQuery extends DataQuery {
	...
	public FormDictTreeQuery() {

	}

	public FormDictTreeQuery code(String code) {
		if (code == null) {
	...
	public FormDictTreeQuery codeLike(String codeLike) {
		if (codeLike == null) {
			throw new RuntimeException("code is null");
		}
	...
	public FormDictTreeQuery codes(List<String> codes) {
		if (codes == null) {
	...
	public FormDictTreeQuery descLike(String descLike) {
		if (descLike == null) {
	...
	public FormDictTreeQuery locked(Integer locked) {
		if (locked == null) {
	...
	public FormDictTreeQuery lockedGreaterThanOrEqual(
	...
	public FormDictTreeQuery lockedLessThanOrEqual(Integer lockedLessThanOrEqual) {
	...
	public FormDictTreeQuery name(String name) {
		if (name == null) {
	...
	public FormDictTreeQuery nameLike(String nameLike) {
		if (nameLike == null) {
			throw new RuntimeException("name is null");
		}
	...
	public FormDictTreeQuery names(List<String> names) {
		if (names == null) {
	...
	public FormDictTreeQuery nodeIds(List<Long> nodeIds) {
		if (nodeIds == null) {
	...
	public FormDictTreeQuery sortGreaterThanOrEqual(Integer sortGreaterThanOrEqual) {
	...
	public FormDictTreeQuery sortLessThanOrEqual(Integer sortLessThanOrEqual) {
	...
	public FormDictTreeQuery urlLike(String urlLike) {
		if (urlLike == null) {
