 ...
 *
 */
public class FormObjectTreeDomainFactory {

    public static final String TABLENAME = "FORM_OBJECT_TREE";
    ...
    public static TableDefinition getTableDefinition(String tableName) {
        ...
        tableDefinition.setName("FormObjectTree");
    ...
    private FormObjectTreeDomainFactory() {
