 ...
 *
 */
public class FormDictTreeDomainFactory {

	public static final String TABLENAME = "FORM_DICT_TREE";
	...
	static {
		...
		columnMap.put("allowedFizeSize", "ALLOWEDFIZESIZE");
		columnMap.put("allowedFileExts", "ALLOWEDFILEEXTS");
		columnMap.put("providerClass", "PROVIDERCLASS");
		...
		javaTypeMap.put("allowedFizeSize", "Integer");
		javaTypeMap.put("allowedFileExts", "String");
	...
	public static TableDefinition getTableDefinition(String tableName) {
		...
		ColumnDefinition allowedFizeSize = new ColumnDefinition();
		allowedFizeSize.setName("allowedFizeSize");
		allowedFizeSize.setColumnName("ALLOWEDFIZESIZE");
		allowedFizeSize.setJavaType("Integer");
		tableDefinition.addColumn(allowedFizeSize);

		ColumnDefinition allowedFileExts = new ColumnDefinition();
		allowedFileExts.setName("allowedFileExts");
		allowedFileExts.setColumnName("ALLOWEDFILEEXTS");
		allowedFileExts.setJavaType("String");
		allowedFileExts.setLength(200);
		tableDefinition.addColumn(allowedFileExts);

		ColumnDefinition providerClass = new ColumnDefinition();
		providerClass.setName("providerClass");
		providerClass.setColumnName("PROVIDERCLASS");
	...
	private FormDictTreeDomainFactory() {
