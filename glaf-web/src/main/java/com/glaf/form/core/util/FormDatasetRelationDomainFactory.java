 ...
 *
 */
public class FormDatasetRelationDomainFactory {

    public static final String TABLENAME = "FORM_DATASET_RELATION";
    ...
    public static TableDefinition getTableDefinition(String tableName) {
        ...
        tableDefinition.setName("FormDatasetRelation");
        ...
        ColumnDefinition attrName = new ColumnDefinition();
        attrName.setName("attrName");
        attrName.setColumnName("ATTRNAME_");
        attrName.setJavaType("String");
        attrName.setLength(50);
        tableDefinition.addColumn(attrName);
    ...
    private FormDatasetRelationDomainFactory() {
