...
public class FormDictoryQuery extends DataQuery {
	...
	public FormDictoryQuery() {

	}

	public FormDictoryQuery blocked(Integer blocked) {
		if (blocked == null) {
	...
	public FormDictoryQuery code(String code) {
		if (code == null) {
	...
	public FormDictoryQuery codeLike(String codeLike) {
		if (codeLike == null) {
			throw new RuntimeException("code is null");
		}
	...
	public FormDictoryQuery codes(List<String> codes) {
		if (codes == null) {
	...
	public FormDictoryQuery descLike(String descLike) {
		if (descLike == null) {
	...
	public FormDictoryQuery name(String name) {
		if (name == null) {
	...
	public FormDictoryQuery nameLike(String nameLike) {
		if (nameLike == null) {
			throw new RuntimeException("name is null");
		}
	...
	public FormDictoryQuery names(List<String> names) {
		if (names == null) {
	...
	public FormDictoryQuery nodeId(Long nodeId) {
		if (nodeId == null) {
	...
	public FormDictoryQuery sortGreaterThanOrEqual(Integer sortGreaterThanOrEqual) {
	...
	public FormDictoryQuery sortLessThanOrEqual(Integer sortLessThanOrEqual) {
