 ...
 *
 */
public class FormParamsRelationDomainFactory {

    public static final String TABLENAME = "FORM_PARAMS_RELATION";
    ...
    public static TableDefinition getTableDefinition(String tableName) {
        ...
        tableDefinition.setName("FormParamsRelation");
    ...
    private FormParamsRelationDomainFactory() {
