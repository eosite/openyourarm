...
public class FormParamsRelationQuery extends DataQuery {
    ...
    public FormParamsRelationQuery() {
    ...
    public FormParamsRelationQuery pageId(String pageId){
	if (pageId == null) {
    ...
    public FormParamsRelationQuery pageIdLike( String pageIdLike){
        if (pageIdLike == null) {
            throw new RuntimeException("pageId is null");
        }
        this.pageIdLike = pageIdLike;
    ...
    public FormParamsRelationQuery pageIds(List<String> pageIds){
        if (pageIds == null) {
    ...
    public FormParamsRelationQuery widgetId(String widgetId){
	if (widgetId == null) {
    ...
    public FormParamsRelationQuery widgetIdLike( String widgetIdLike){
    ...
    public FormParamsRelationQuery widgetIds(List<String> widgetIds){
        if (widgetIds == null) {
    ...
    public FormParamsRelationQuery pid(String pid){
	if (pid == null) {
    ...
    public FormParamsRelationQuery pidLike( String pidLike){
        if (pidLike == null) {
            throw new RuntimeException("pid is null");
        }
        this.pidLike = pidLike;
    ...
    public FormParamsRelationQuery pids(List<String> pids){
        if (pids == null) {
    ...
    public FormParamsRelationQuery attrName(String attrName){
	if (attrName == null) {
    ...
    public FormParamsRelationQuery attrNameLike( String attrNameLike){
    ...
    public FormParamsRelationQuery attrNames(List<String> attrNames){
        if (attrNames == null) {
