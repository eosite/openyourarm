...
public class FormDictoryJsonFactory {

	public static java.util.List<FormDictory> arrayToList(JSONArray array) {
		java.util.List<FormDictory> list = new java.util.ArrayList<FormDictory>();
		for (int i = 0; i < array.size(); i++) {
			JSONObject jsonObject = array.getJSONObject(i);
			FormDictory model = jsonToObject(jsonObject);
			list.add(model);
		}
		return list;
	}

	public static FormDictory jsonToObject(JSONObject jsonObject) {
		FormDictory model = new FormDictory();
	...
	public static JSONArray listToArray(java.util.List<FormDictory> list) {
		JSONArray array = new JSONArray();
		if (list != null && !list.isEmpty()) {
			for (FormDictory model : list) {
	...
	public static JSONObject toJsonObject(FormDictory model) {
	...
	public static ObjectNode toObjectNode(FormDictory model) {
	...
	private FormDictoryJsonFactory() {
