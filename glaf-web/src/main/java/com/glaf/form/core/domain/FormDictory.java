...
@Entity
@Table(name = "form_dictory")
public class FormDictory implements Serializable, JSONable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		FormDictory other = (FormDictory) obj;
		if (id != other.id)
			return false;
		return true;
	}
	...
	public FormDictory jsonToObject(JSONObject jsonObject) {
		return FormDictoryJsonFactory.jsonToObject(jsonObject);
	}
	...
	public JSONObject toJsonObject() {
		return FormDictoryJsonFactory.toJsonObject(this);
	}

	public ObjectNode toObjectNode() {
		return FormDictoryJsonFactory.toObjectNode(this);
	}
