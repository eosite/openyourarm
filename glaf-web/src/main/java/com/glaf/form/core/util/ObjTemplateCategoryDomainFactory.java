 ...
 *
 */
public class ObjTemplateCategoryDomainFactory {

    public static final String TABLENAME = "OBJ_TEMPLATE_CATEGORY";
    ...
    public static TableDefinition getTableDefinition(String tableName) {
        ...
        tableDefinition.setName("ObjTemplateCategory");
		...
		if (tableModel == null) {
			...
			try {
				inputStream = Resources
						.getResourceAsStream("com/glaf/form/domain/ObjTemplateCategory.mapping.xml");
    ...
    private ObjTemplateCategoryDomainFactory() {
