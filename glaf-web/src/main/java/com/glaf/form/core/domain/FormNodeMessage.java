...
@Entity
@Table(name = "FORM_NODE_MESSAGE")
public class FormNodeMessage implements Serializable, JSONable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		FormNodeMessage other = (FormNodeMessage) obj;
		if (id == null) {
			if (other.id != null)
				return false;
	...
	public FormNodeMessage jsonToObject(JSONObject jsonObject) {
            return FormNodeMessageJsonFactory.jsonToObject(jsonObject);
	}


	public JSONObject toJsonObject() {
            return FormNodeMessageJsonFactory.toJsonObject(this);
	}

	public ObjectNode toObjectNode(){
            return FormNodeMessageJsonFactory.toObjectNode(this);
	}
