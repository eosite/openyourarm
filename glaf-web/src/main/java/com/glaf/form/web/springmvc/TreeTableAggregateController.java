...
import com.glaf.datamgr.bean.TreeTableAggregateMetaBean;
...
import com.glaf.datamgr.util.TreeTableAggregateDomainFactory;
...
@Controller("/form/treeTableAggregate")
@RequestMapping("/form/treeTableAggregate")
public class TreeTableAggregateController {
	...
	public ModelAndView chooseColumns(HttpServletRequest request, ModelMap modelMap) {
		...
		return new ModelAndView("/datamgr/treeTableAggregate/chooseColumns", modelMap);
	}
	...
	public ModelAndView chooseDatabases(HttpServletRequest request, ModelMap modelMap) {
		...
		return new ModelAndView("/datamgr/treeTableAggregate/chooseDatabases", modelMap);
	}
	...
	public ModelAndView edit(HttpServletRequest request, ModelMap modelMap) {
		...
		if (executions != null && !executions.isEmpty()) {
			...
			for (TableExecution e : executions) {
				if (treeTableAggregate.getSourceTableExecutionIds() != null
						&& StringUtils.contains(treeTableAggregate.getSourceTableExecutionIds(), e.getId())) {
					srcSelectedExecutions.add(e);
					selected1Ids.add(e.getId());
					name1.append(e.getTitle()).append("  ");
				}
				if (treeTableAggregate.getTargetTableExecutionIds() != null
						&& StringUtils.contains(treeTableAggregate.getTargetTableExecutionIds(), e.getId())) {
		...
		return new ModelAndView("/datamgr/treeTableAggregate/edit", modelMap);
	}
	...
	public ModelAndView list(HttpServletRequest request, ModelMap modelMap) {
		...
		return new ModelAndView("/datamgr/treeTableAggregate/list", modelMap);
	}
	...
	public ModelAndView param(HttpServletRequest request, ModelMap modelMap) {
		...
		return new ModelAndView("/datamgr/treeTableAggregate/param");
	}
	...
	public ModelAndView query(HttpServletRequest request, ModelMap modelMap) {
		...
		return new ModelAndView("/datamgr/treeTableAggregate/query", modelMap);
	}
	...
	public byte[] updateAllMeta(HttpServletRequest request) {
		...
		if (list != null && !list.isEmpty()) {
			List<TreeTableAggregateRule> rules = null;
			TreeTableAggregateMetaBean metaBean = new TreeTableAggregateMetaBean();
			for (TreeTableAggregate treeTableAggregate : list) {
				try {
					rules = treeTableAggregateService
	...
	public byte[] updateMeta(HttpServletRequest request) {
		...
		if (treeTableAggregate != null && treeTableAggregate.getRules() != null) {
			TreeTableAggregateMetaBean metaBean = new TreeTableAggregateMetaBean();
			metaBean.updateTreeTableAggregateMeta(treeTableAggregate, treeTableAggregate.getRules());
			return ResponseUtils.responseResult(true);
		}
		return ResponseUtils.responseResult(false);
	}
	...
	public ModelAndView view(HttpServletRequest request, ModelMap modelMap) {
		...
		return new ModelAndView("/datamgr/treeTableAggregate/view");
	}
