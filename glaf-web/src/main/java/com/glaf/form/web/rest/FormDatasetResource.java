...
@Controller
@Path("/rs/core/formDataset")
public class FormDatasetResource {
	protected static final Log logger = LogFactory.getLog(FormDatasetResource.class);
	...
	public byte[] deleteAll(@Context HttpServletRequest request)
		...
		if (rowIds != null) {
			...
			if (ids != null && !ids.isEmpty()) {
				formDatasetService.deleteByIds(ids);
			}
		}
	...
	public byte[] deleteById(@Context HttpServletRequest request) throws IOException {
                formDatasetService.deleteById(request.getParameter("id"));
		return ResponseUtils.responseJsonResult(true);
	}
	...
	@POST
	@Path("/saveFormDataset")
	@ResponseBody
	@Produces({ MediaType.APPLICATION_JSON })
	public byte[] saveFormDataset(@Context HttpServletRequest request) {
	        Map<String, Object> params = RequestUtils.getParameterMap(request);
	...
	public byte[] view(@Context HttpServletRequest request) throws IOException {
		...
		if (StringUtils.isNotEmpty(request.getParameter("id"))) {
                  formDataset = formDatasetService.getFormDataset(request.getParameter("id"));
		}
		JSONObject result = new JSONObject();
		if (formDataset != null) {
		    result =  formDataset.toJsonObject();
		    Map<String, User> userMap = IdentityFactory.getUserMap();
		    result.put("id", formDataset.getId());
		    result.put("formDatasetId", formDataset.getId());
		}
		return result.toJSONString().getBytes("UTF-8");
	}
}
