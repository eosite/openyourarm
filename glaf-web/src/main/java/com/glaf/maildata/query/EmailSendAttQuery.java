...
public class EmailSendAttQuery extends DataQuery {
    ...
    public EmailSendAttQuery topId(String topId){
	if (topId == null) {
    ...
    public EmailSendAttQuery topIdLike( String topIdLike){
        if (topIdLike == null) {
            throw new RuntimeException("topId is null");
        }
        this.topIdLike = topIdLike;
    ...
    public EmailSendAttQuery topIds(List<String> topIds){
        if (topIds == null) {
    ...
    public EmailSendAttQuery fileName(String fileName){
	if (fileName == null) {
    ...
    public EmailSendAttQuery fileNameLike( String fileNameLike){
    ...
    public EmailSendAttQuery fileNames(List<String> fileNames){
        if (fileNames == null) {
    ...
    public EmailSendAttQuery cTimeGreaterThanOrEqual(Date cTimeGreaterThanOrEqual){
    ...
    public EmailSendAttQuery cTimeLessThanOrEqual(Date cTimeLessThanOrEqual){
    ...
    public EmailSendAttQuery fileSize(Integer fileSize){
	if (fileSize == null) {
    ...
    public EmailSendAttQuery fileSizeGreaterThanOrEqual(Integer fileSizeGreaterThanOrEqual){
    ...
    public EmailSendAttQuery fileSizeLessThanOrEqual(Integer fileSizeLessThanOrEqual){
    ...
    public EmailSendAttQuery fileSizes(List<Integer> fileSizes){
        if (fileSizes == null) {
