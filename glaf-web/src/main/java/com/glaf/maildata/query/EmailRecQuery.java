...
public class EmailRecQuery extends DataQuery {
	...
	public EmailRecQuery searchCondition(String searchCondition) {
	...
	public EmailRecQuery email(String email) {
		if (email == null) {
	...
	public EmailRecQuery emailLike(String emailLike) {
		if (emailLike == null) {
			throw new RuntimeException("email is null");
		}
		this.emailLike = emailLike;
	...
	public EmailRecQuery emails(List<String> emails) {
		if (emails == null) {
	...
	public EmailRecQuery msgId(String msgId) {
		if (msgId == null) {
	...
	public EmailRecQuery msgIdLike(String msgIdLike) {
		if (msgIdLike == null) {
			throw new RuntimeException("msgId is null");
		}
		this.msgIdLike = msgIdLike;
	...
	public EmailRecQuery msgIds(List<String> msgIds) {
		if (msgIds == null) {
	...
	public EmailRecQuery inReplyTo(String inReplyTo) {
		if (inReplyTo == null) {
	...
	public EmailRecQuery inReplyToLike(String inReplyToLike) {
	...
	public EmailRecQuery inReplyTos(List<String> inReplyTos) {
		if (inReplyTos == null) {
	...
	public EmailRecQuery from(String from) {
		if (from == null) {
	...
	public EmailRecQuery fromLike(String fromLike) {
		if (fromLike == null) {
			throw new RuntimeException("from is null");
		}
		this.fromLike = fromLike;
	...
	public EmailRecQuery froms(List<String> froms) {
		if (froms == null) {
	...
	public EmailRecQuery to(String to) {
		if (to == null) {
	...
	public EmailRecQuery toLike(String toLike) {
		if (toLike == null) {
			throw new RuntimeException("to is null");
		}
		this.toLike = toLike;
	...
	public EmailRecQuery tos(List<String> tos) {
		if (tos == null) {
	...
	public EmailRecQuery cc(String cc) {
		if (cc == null) {
	...
	public EmailRecQuery ccLike(String ccLike) {
		if (ccLike == null) {
			throw new RuntimeException("cc is null");
		}
		this.ccLike = ccLike;
	...
	public EmailRecQuery ccs(List<String> ccs) {
		if (ccs == null) {
	...
	public EmailRecQuery dateGreaterThanOrEqual(Date dateGreaterThanOrEqual) {
	...
	public EmailRecQuery dateLessThanOrEqual(Date dateLessThanOrEqual) {
	...
	public EmailRecQuery subject(String subject) {
		if (subject == null) {
	...
	public EmailRecQuery subjectLike(String subjectLike) {
		if (subjectLike == null) {
			throw new RuntimeException("subject is null");
		}
		this.subjectLike = subjectLike;
	...
	public EmailRecQuery subjects(List<String> subjects) {
		if (subjects == null) {
	...
	public EmailRecQuery replyTo(String replyTo) {
		if (replyTo == null) {
	...
	public EmailRecQuery replyToLike(String replyToLike) {
		if (replyToLike == null) {
			throw new RuntimeException("replyTo is null");
		}
		this.replyToLike = replyToLike;
	...
	public EmailRecQuery replyTos(List<String> replyTos) {
		if (replyTos == null) {
	...
	public EmailRecQuery intFlag(Integer intFlag) {
		if (intFlag == null) {
	...
	public EmailRecQuery intFlagGreaterThanOrEqual(Integer intFlagGreaterThanOrEqual) {
	...
	public EmailRecQuery intFlagLessThanOrEqual(Integer intFlagLessThanOrEqual) {
	...
	public EmailRecQuery intFlags(List<Integer> intFlags) {
		if (intFlags == null) {
	...
	public EmailRecQuery guidFrom(String guidFrom) {
		if (guidFrom == null) {
	...
	public EmailRecQuery guidFromLike(String guidFromLike) {
	...
	public EmailRecQuery guidFroms(List<String> guidFroms) {
		if (guidFroms == null) {
	...
	public EmailRecQuery fromSysId(String fromSysId) {
		if (fromSysId == null) {
	...
	public EmailRecQuery fromSysIdLike(String fromSysIdLike) {
	...
	public EmailRecQuery fromSysIds(List<String> fromSysIds) {
		if (fromSysIds == null) {
	...
	public EmailRecQuery intAction(Integer intAction) {
		if (intAction == null) {
	...
	public EmailRecQuery intActionGreaterThanOrEqual(Integer intActionGreaterThanOrEqual) {
	...
	public EmailRecQuery intActionLessThanOrEqual(Integer intActionLessThanOrEqual) {
	...
	public EmailRecQuery intActions(List<Integer> intActions) {
		if (intActions == null) {
	...
	public EmailRecQuery intOperat(Integer intOperat) {
		if (intOperat == null) {
	...
	public EmailRecQuery intOperatGreaterThanOrEqual(Integer intOperatGreaterThanOrEqual) {
	...
	public EmailRecQuery intOperatLessThanOrEqual(Integer intOperatLessThanOrEqual) {
	...
	public EmailRecQuery intOperats(List<Integer> intOperats) {
		if (intOperats == null) {
	...
	public EmailRecQuery listNo(Integer listNo) {
		if (listNo == null) {
	...
	public EmailRecQuery listNoGreaterThanOrEqual(Integer listNoGreaterThanOrEqual) {
	...
	public EmailRecQuery listNoLessThanOrEqual(Integer listNoLessThanOrEqual) {
	...
	public EmailRecQuery listNos(List<Integer> listNos) {
		if (listNos == null) {
	...
	public EmailRecQuery toSysId(String toSysId) {
		if (toSysId == null) {
	...
	public EmailRecQuery toSysIdLike(String toSysIdLike) {
		if (toSysIdLike == null) {
			throw new RuntimeException("toSysId is null");
		}
		this.toSysIdLike = toSysIdLike;
	...
	public EmailRecQuery toSysIds(List<String> toSysIds) {
		if (toSysIds == null) {
	...
	public String getOrderBy() {
		if (sortColumn != null) {
			...
			if ("guidFrom".equals(sortColumn)) {
				orderBy = "E.GUID_FROM" + a_x;
			}
