 ...
 *
 */
public class EmailRecAttDomainFactory {

    public static final String TABLENAME = "EMAIL_RECATT";
    ...
    public static TableDefinition getTableDefinition(String tableName) {
        ...
        tableDefinition.setName("EmailRecAtt");
		...
		if (tableModel == null) {
			...
			try {
				inputStream = Resources
						.getResourceAsStream("com/glaf/maildata/domain/EmailRecAtt.mapping.xml");
    ...
    private EmailRecAttDomainFactory() {
