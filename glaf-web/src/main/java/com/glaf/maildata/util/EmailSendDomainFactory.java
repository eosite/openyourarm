 ...
 *
 */
public class EmailSendDomainFactory {

    public static final String TABLENAME = "EMAIL_SEND";
    ...
    public static TableDefinition getTableDefinition(String tableName) {
        ...
        tableDefinition.setName("EmailSend");
		...
		if (tableModel == null) {
			...
			try {
				inputStream = Resources
						.getResourceAsStream("com/glaf/maildata/domain/EmailSend.mapping.xml");
    ...
    private EmailSendDomainFactory() {
