 ...
 *
 */
public class SysThemeTmpLayoutAreaDomainFactory {

    public static final String TABLENAME = "SYS_THEME_TMP_LAYOUT_AREA_";
    ...
    public static TableDefinition getTableDefinition(String tableName) {
        ...
        tableDefinition.setName("SysThemeTmpLayoutArea");

        ColumnDefinition idColumn = new ColumnDefinition();
        idColumn.setName("areaId");
        idColumn.setColumnName("AREA_ID_");
    ...
    private SysThemeTmpLayoutAreaDomainFactory() {
