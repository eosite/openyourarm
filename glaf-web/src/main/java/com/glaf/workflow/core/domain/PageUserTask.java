...
@Entity
@Table(name = "PAGE_USER_TASK")
public class PageUserTask implements Serializable, JSONable, Cloneable {
	 ...
	 * 流程活动编号
	 */
	@Column(name = "ACTIVITYCODE_", length = 64)
	 ...
	 * 流程编号
	 */
	@Column(name = "PROCESSCODE_", length = 64)
	protected String processCode;

	/**
	 * 流程名称
	 */
	@Column(name = "PROCESSNAME_", length = 128)
	...
	public JSONObject toJsonObject() {
		...
		if (this.syncIsSuccess != null) {
			jsonObject.put("syncIsSuccess", syncIsSuccess);
		}
	...
	@Override
	public Object clone() {
		PageUserTask model = null;
		try {
			model = (PageUserTask)super.clone();
