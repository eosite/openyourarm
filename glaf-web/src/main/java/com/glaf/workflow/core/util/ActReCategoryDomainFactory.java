 ...
 *
 */
public class ActReCategoryDomainFactory {

    public static final String TABLENAME = "ACT_RE_CATEGORY";
    ...
    public static TableDefinition getTableDefinition(String tableName) {
        ...
        tableDefinition.setName("ActReCategory");
    ...
    private ActReCategoryDomainFactory() {
