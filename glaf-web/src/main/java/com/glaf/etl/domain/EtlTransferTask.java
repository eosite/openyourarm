...
public class EtlTransferTask implements Serializable, JSONable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		EtlTransferTask other = (EtlTransferTask) obj;
		if (id_ == null) {
			if (other.id_ != null)
				return false;
	...
	public EtlTransferTask jsonToObject(JSONObject jsonObject) {
		return EtlTransferTaskJsonFactory.jsonToObject(jsonObject);
	}

	public JSONObject toJsonObject() {
		return EtlTransferTaskJsonFactory.toJsonObject(this);
	}

	public ObjectNode toObjectNode() {
		return EtlTransferTaskJsonFactory.toObjectNode(this);
	}
