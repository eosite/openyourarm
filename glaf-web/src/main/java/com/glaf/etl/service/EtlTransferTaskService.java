...
public interface EtlTransferTaskService {
	 ...
	 * @return
	 */
	int getEtlTransferTaskCountByQueryCriteria(EtlTransferTaskQuery query);
	 ...
	 * @return
	 */
	List<EtlTransferTask> getEtlTransferTasksByQueryCriteria(int start, int pageSize, EtlTransferTaskQuery query);
	 ...
	 */
	@Transactional
	void save(EtlTransferTask etlTransferTask);
	/**
	 * 更新任务启动状态
