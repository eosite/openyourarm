...
public class RankJob extends BaseJob {

	protected static AtomicLong lastExecuteTime = new AtomicLong(System.currentTimeMillis());

	public void runJob(JobExecutionContext context) throws JobExecutionException {
		// if ((System.currentTimeMillis() - lastExecuteTime.get()) <
		// DateUtils.HOUR) {// 1小时
		// return;
		// }
		/*
		 * try { TimeUnit.SECONDS.sleep(3 + new Random().nextInt(120));//
		 * 随机等待，避免Job同时执行 } catch (InterruptedException e) { }
		 */
