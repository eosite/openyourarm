...
@Controller
@Path("/rs/data/model/dataModel")
public class DataModelResource {
	protected static final Log logger = LogFactory.getLog(DataModelResource.class);
	...
	public byte[] deleteById(@Context HttpServletRequest request) throws IOException {
                dataModelService.deleteById(request.getParameter("id"));
		return ResponseUtils.responseJsonResult(true);
	}
	...
	public byte[] data(@Context HttpServletRequest request, @RequestBody DataRequest dataRequest) throws IOException {
		...
		if (total > 0) {
			...
			List<DataModel> list = dataModelService.getDataModelsByQueryCriteria(start, limit,
					query);
	...
	@ResponseBody
	@Produces({ MediaType.APPLICATION_JSON })
	public byte[] saveDataModel(@Context HttpServletRequest request) {
	        Map<String, Object> params = RequestUtils.getParameterMap(request);
	...
	public byte[] view(@Context HttpServletRequest request) throws IOException {
		...
		if (StringUtils.isNotEmpty(request.getParameter("id"))) {
                  dataModel = dataModelService.getDataModel(request.getParameter("id"));
		}
		JSONObject result = new JSONObject();
		if (dataModel != null) {
		    result =  dataModel.toJsonObject();
		    Map<String, User> userMap = IdentityFactory.getUserMap();
		    result.put("id", dataModel.getId());
		    result.put("dataModelId", dataModel.getId());
		}
		return result.toJSONString().getBytes("UTF-8");
	}
}
