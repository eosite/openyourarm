 ...
 *
 */
public class DataModelColumnsDomainFactory {

    public static final String TABLENAME = "DATA_MODEL_COLUMNS";
    ...
    public static TableDefinition getTableDefinition(String tableName) {
        ...
        tableDefinition.setName("DataModelColumns");
    ...
    private DataModelColumnsDomainFactory() {
