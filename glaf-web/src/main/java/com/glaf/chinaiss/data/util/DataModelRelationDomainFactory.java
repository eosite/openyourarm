 ...
 *
 */
public class DataModelRelationDomainFactory {

    public static final String TABLENAME = "DATA_MODEL_RELATION";
    ...
    static{
        ...
        columnMap.put("relateTable", "RELATETABLE_");
        columnMap.put("relateColumn", "RELATECOLUMN_");
        columnMap.put("relateType", "RELATETYPE_");
	...
	javaTypeMap.put("id", "String");
        ...
        javaTypeMap.put("relateTable", "String");
        javaTypeMap.put("relateColumn", "String");
        javaTypeMap.put("relateType", "String");
    ...
    public static TableDefinition getTableDefinition(String tableName) {
        ...
        tableDefinition.setName("DataModelRelation");
        ...
        ColumnDefinition relateTable = new ColumnDefinition();
        relateTable.setName("relateTable");
        relateTable.setColumnName("RELATETABLE_");
        relateTable.setJavaType("String");
        relateTable.setLength(50);
        tableDefinition.addColumn(relateTable);

        ColumnDefinition relateColumn = new ColumnDefinition();
        relateColumn.setName("relateColumn");
        relateColumn.setColumnName("RELATECOLUMN_");
        relateColumn.setJavaType("String");
        relateColumn.setLength(50);
        tableDefinition.addColumn(relateColumn);

        ColumnDefinition relateType = new ColumnDefinition();
        relateType.setName("relateType");
        relateType.setColumnName("RELATETYPE_");
        relateType.setJavaType("String");
        relateType.setLength(5);
        tableDefinition.addColumn(relateType);
    ...
    private DataModelRelationDomainFactory() {
