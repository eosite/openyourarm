 ...
 *
 */
public class DataModelTreeDomainFactory {

    public static final String TABLENAME = "DATA_MODEL_TREE";
    ...
    public static TableDefinition getTableDefinition(String tableName) {
        ...
        tableDefinition.setName("DataModelTree");
    ...
    private DataModelTreeDomainFactory() {
