...
@Entity
@Table(name = "DATA_MODEL_RELATION")
public class DataModelRelation implements Serializable, JSONable {
	 ...
	 * RelateTable
	 */
	@Column(name = "RELATETABLE_", length = 50)
	protected String relateTable;

	/**
	 * RelateColumn
	 */
	@Column(name = "RELATECOLUMN_", length = 50)
	protected String relateColumn;

	/**
	 * RelateType
	 */
	@Column(name = "RELATETYPE_", length = 5)
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DataModelRelation other = (DataModelRelation) obj;
		if (id == null) {
			if (other.id != null)
				return false;
	...
	public DataModelRelation jsonToObject(JSONObject jsonObject) {
		return DataModelRelationJsonFactory.jsonToObject(jsonObject);
	}

	public JSONObject toJsonObject() {
		return DataModelRelationJsonFactory.toJsonObject(this);
	}

	public ObjectNode toObjectNode() {
		return DataModelRelationJsonFactory.toObjectNode(this);
	}
