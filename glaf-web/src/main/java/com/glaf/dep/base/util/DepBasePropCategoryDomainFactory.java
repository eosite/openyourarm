 ...
 * 
 */
public class DepBasePropCategoryDomainFactory {

	public static final String TABLENAME = "DEP_BASE_PROPCATEGORY";
	...
	public static TableDefinition getTableDefinition(String tableName) {
		...
		tableDefinition.setName("DepBasePropCategory");
		...
		if (tableModel == null) {
			...
			try {
				inputStream = Resources
						.getResourceAsStream("com/glaf/dep/base/domain/DepBasePropCategory.mapping.xml");
	...
	private DepBasePropCategoryDomainFactory() {
