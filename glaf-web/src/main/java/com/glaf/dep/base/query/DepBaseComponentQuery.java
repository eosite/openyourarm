...
public class DepBaseComponentQuery extends DataQuery {
	...
	public DepBaseComponentQuery code(String code) {
		if (code == null) {
	...
	public DepBaseComponentQuery codeLike(String codeLike) {
		if (codeLike == null) {
			throw new RuntimeException("code is null");
		}
		this.codeLike = codeLike;
	...
	public DepBaseComponentQuery codes(List<String> codes) {
		if (codes == null) {
	...
	public DepBaseComponentQuery name(String name) {
		if (name == null) {
	...
	public DepBaseComponentQuery nameLike(String nameLike) {
		if (nameLike == null) {
			throw new RuntimeException("name is null");
		}
		this.nameLike = nameLike;
	...
	public DepBaseComponentQuery names(List<String> names) {
		if (names == null) {
	...
	public DepBaseComponentQuery type(String type) {
		if (type == null) {
	...
	public DepBaseComponentQuery typeLike(String typeLike) {
		if (typeLike == null) {
			throw new RuntimeException("type is null");
		}
		this.typeLike = typeLike;
	...
	public DepBaseComponentQuery types(List<String> types) {
		if (types == null) {
	...
	public DepBaseComponentQuery creator(String creator) {
		if (creator == null) {
	...
	public DepBaseComponentQuery creatorLike(String creatorLike) {
		if (creatorLike == null) {
			throw new RuntimeException("creator is null");
		}
		this.creatorLike = creatorLike;
	...
	public DepBaseComponentQuery creators(List<String> creators) {
		if (creators == null) {
	...
	public DepBaseComponentQuery createDateTimeGreaterThanOrEqual(
			Date createDateTimeGreaterThanOrEqual) {
	...
	public DepBaseComponentQuery createDateTimeLessThanOrEqual(
			Date createDateTimeLessThanOrEqual) {
	...
	public DepBaseComponentQuery modifier(String modifier) {
		if (modifier == null) {
	...
	public DepBaseComponentQuery modifierLike(String modifierLike) {
	...
	public DepBaseComponentQuery modifiers(List<String> modifiers) {
		if (modifiers == null) {
	...
	public DepBaseComponentQuery modifyDateTimeGreaterThanOrEqual(
			Date modifyDateTimeGreaterThanOrEqual) {
	...
	public DepBaseComponentQuery modifyDateTimeLessThanOrEqual(
			Date modifyDateTimeLessThanOrEqual) {
	...
	public DepBaseComponentQuery delFlag(String delFlag) {
		if (delFlag == null) {
	...
	public DepBaseComponentQuery delFlagLike(String delFlagLike) {
		if (delFlagLike == null) {
			throw new RuntimeException("delFlag is null");
		}
		this.delFlagLike = delFlagLike;
	...
	public DepBaseComponentQuery delFlags(List<String> delFlags) {
		if (delFlags == null) {
