 ...
 * 
 */
public class DepBaseComponentDomainFactory {

	public static final String TABLENAME = "DEP_BASE_COMPONENT";
	...
	public static TableDefinition getTableDefinition(String tableName) {
		...
		tableDefinition.setName("DepBaseComponent");
		...
		if (tableModel == null) {
			...
			try {
				inputStream = Resources
						.getResourceAsStream("com/glaf/dep/base/domain/DepBaseComponent.mapping.xml");
	...
	private DepBaseComponentDomainFactory() {
