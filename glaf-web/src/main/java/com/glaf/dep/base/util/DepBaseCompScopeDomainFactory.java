 ...
 * 
 */
public class DepBaseCompScopeDomainFactory {

	public static final String TABLENAME = "DEP_BASE_COMPSCOPE";
	...
	public static TableDefinition getTableDefinition(String tableName) {
		...
		tableDefinition.setName("DepBaseCompScope");
		...
		if (tableModel == null) {
			...
			try {
				inputStream = Resources
						.getResourceAsStream("com/glaf/dep/base/domain/DepBaseCompScope.mapping.xml");
	...
	private DepBaseCompScopeDomainFactory() {
