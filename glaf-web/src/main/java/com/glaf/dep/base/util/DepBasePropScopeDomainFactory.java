 ...
 * 
 */
public class DepBasePropScopeDomainFactory {

	public static final String TABLENAME = "DEP_BASE_PROPSCOPE";
	...
	public static TableDefinition getTableDefinition(String tableName) {
		...
		tableDefinition.setName("DepBasePropScope");
		...
		if (tableModel == null) {
			...
			try {
				inputStream = Resources
						.getResourceAsStream("com/glaf/dep/base/domain/DepBasePropScope.mapping.xml");
	...
	private DepBasePropScopeDomainFactory() {
