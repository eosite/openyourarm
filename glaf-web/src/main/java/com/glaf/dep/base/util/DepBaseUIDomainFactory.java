 ...
 * 
 */
public class DepBaseUIDomainFactory {

	public static final String TABLENAME = "DEP_BASE_UI";
	...
	public static TableDefinition getTableDefinition(String tableName) {
		...
		tableDefinition.setName("DepBaseUI");
		...
		if (tableModel == null) {
			...
			try {
				inputStream = Resources
						.getResourceAsStream("com/glaf/dep/base/domain/DepBaseUI.mapping.xml");
	...
	private DepBaseUIDomainFactory() {
