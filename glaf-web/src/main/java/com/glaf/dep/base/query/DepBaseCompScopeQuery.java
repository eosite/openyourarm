...
public class DepBaseCompScopeQuery extends DataQuery {
	...
	public DepBaseCompScopeQuery depBaseUIId(String depBaseUIId) {
		if (depBaseUIId == null) {
	...
	public DepBaseCompScopeQuery depBaseUIIdLike(String depBaseUIIdLike) {
	...
	public DepBaseCompScopeQuery depBaseUIIds(List<String> depBaseUIIds) {
	...
	public DepBaseCompScopeQuery creator(String creator) {
		if (creator == null) {
	...
	public DepBaseCompScopeQuery creatorLike(String creatorLike) {
		if (creatorLike == null) {
			throw new RuntimeException("creator is null");
		}
		this.creatorLike = creatorLike;
	...
	public DepBaseCompScopeQuery creators(List<String> creators) {
		if (creators == null) {
	...
	public DepBaseCompScopeQuery createDateTimeGreaterThanOrEqual(
			Date createDateTimeGreaterThanOrEqual) {
	...
	public DepBaseCompScopeQuery createDateTimeLessThanOrEqual(
			Date createDateTimeLessThanOrEqual) {
