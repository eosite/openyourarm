 ...
 *
 */
public class DepReportVariableDomainFactory {

    public static final String TABLENAME = "DEP_REPORT_VARIABLE";
    ...
    public static TableDefinition getTableDefinition(String tableName) {
        ...
        tableDefinition.setName("DepReportVariable");
		...
		if (tableModel == null) {
			...
			try {
				inputStream = Resources
						.getResourceAsStream("com/glaf/dep/report/domain/DepReportVariable.mapping.xml");
    ...
    private DepReportVariableDomainFactory() {
