...
import com.glaf.dep.report.domain.DepReportFormula;
import com.glaf.dep.report.query.DepReportFormulaQuery;
import com.glaf.dep.report.service.DepReportFormulaService;
...
@Controller
@Path("/rs/dep/report/depReportFormula")
public class DepReportFormulaResource {
	protected static final Log logger = LogFactory.getLog(DepReportFormulaResource.class);
	...
	public byte[] deleteAll(@Context HttpServletRequest request)
		...
		if (rowIds != null) {
			...
			if (ids != null && !ids.isEmpty()) {
				depReportFormulaService.deleteByIds(ids);
			}
		}
	...
	public byte[] deleteById(@Context HttpServletRequest request) throws IOException {
                depReportFormulaService.deleteById(RequestUtils.getLong(request, "id"));
		return ResponseUtils.responseJsonResult(true);
	}
	...
	@POST
	@Path("/saveDepReportFormula")
	@ResponseBody
	@Produces({ MediaType.APPLICATION_JSON })
	public byte[] saveDepReportFormula(@Context HttpServletRequest request) {
	        Map<String, Object> params = RequestUtils.getParameterMap(request);
	...
	public byte[] view(@Context HttpServletRequest request) throws IOException {
		DepReportFormula depReportFormula = null;
		if (StringUtils.isNotEmpty(request.getParameter("id"))) {
                  depReportFormula = depReportFormulaService.getDepReportFormula(RequestUtils.getLong(request, "id"));
		}
		JSONObject result = new JSONObject();
		if (depReportFormula != null) {
		    result =  depReportFormula.toJsonObject();
		    Map<String, User> userMap = IdentityFactory.getUserMap();
		    result.put("id", depReportFormula.getId());
		    result.put("depReportFormulaId", depReportFormula.getId());
		}
		return result.toJSONString().getBytes("UTF-8");
	}
}
