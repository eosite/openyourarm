...
@Entity
@Table(name = "DEP_REPORT_VARIABLE")
public class DepReportVariable implements Serializable, JSONable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DepReportVariable other = (DepReportVariable) obj;
		if (id == null) {
			if (other.id != null)
				return false;
	...
	public DepReportVariable jsonToObject(JSONObject jsonObject) {
            return DepReportVariableJsonFactory.jsonToObject(jsonObject);
	}


	public JSONObject toJsonObject() {
            return DepReportVariableJsonFactory.toJsonObject(this);
	}

	public ObjectNode toObjectNode(){
            return DepReportVariableJsonFactory.toObjectNode(this);
	}
