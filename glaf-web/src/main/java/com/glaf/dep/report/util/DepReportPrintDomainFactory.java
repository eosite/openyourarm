 ...
 *
 */
public class DepReportPrintDomainFactory {

    public static final String TABLENAME = "DEP_REPORT_PRINT";
    ...
    static{
        ...
        columnMap.put("printFlag", "PRINTFLAG_");
        columnMap.put("pageCells", "PAGECELLS_");
        columnMap.put("loopFlag", "LOOPFLAG_");
	...
	javaTypeMap.put("id", "Long");
        ...
        javaTypeMap.put("printFlag", "String");
        javaTypeMap.put("pageCells", "Integer");
        javaTypeMap.put("loopFlag", "String");
    ...
    public static TableDefinition getTableDefinition(String tableName) {
        ...
        tableDefinition.setName("DepReportPrint");
        ...
        ColumnDefinition printFlag = new ColumnDefinition();
        printFlag.setName("printFlag");
        printFlag.setColumnName("PRINTFLAG_");
        printFlag.setJavaType("String");
        printFlag.setLength(1);
        tableDefinition.addColumn(printFlag);

        ColumnDefinition pageCells = new ColumnDefinition();
        pageCells.setName("pageCells");
        pageCells.setColumnName("PAGECELLS_");
        pageCells.setJavaType("Integer");
        tableDefinition.addColumn(pageCells);

        ColumnDefinition loopFlag = new ColumnDefinition();
        loopFlag.setName("loopFlag");
        loopFlag.setColumnName("LOOPFLAG_");
        loopFlag.setJavaType("String");
        loopFlag.setLength(1);
        tableDefinition.addColumn(loopFlag);
		...
		if (tableModel == null) {
			...
			try {
				inputStream = Resources
						.getResourceAsStream("com/glaf/dep/report/domain/DepReportPrint.mapping.xml");
    ...
    private DepReportPrintDomainFactory() {
