...
import com.glaf.dep.report.domain.DepReportPrint;
import com.glaf.dep.report.query.DepReportPrintQuery;
import com.glaf.dep.report.service.DepReportPrintService;
...
@Controller
@Path("/rs/dep/report/depReportPrint")
public class DepReportPrintResource {
	protected static final Log logger = LogFactory.getLog(DepReportPrintResource.class);
	...
	public byte[] deleteAll(@Context HttpServletRequest request)
		...
		if (rowIds != null) {
			...
			if (ids != null && !ids.isEmpty()) {
				depReportPrintService.deleteByIds(ids);
			}
		}
	...
	public byte[] deleteById(@Context HttpServletRequest request) throws IOException {
                depReportPrintService.deleteById(RequestUtils.getLong(request, "id"));
		return ResponseUtils.responseJsonResult(true);
	}
	...
	@POST
	@Path("/saveDepReportPrint")
	@ResponseBody
	@Produces({ MediaType.APPLICATION_JSON })
	public byte[] saveDepReportPrint(@Context HttpServletRequest request) {
	        Map<String, Object> params = RequestUtils.getParameterMap(request);
	...
	public byte[] view(@Context HttpServletRequest request) throws IOException {
		DepReportPrint depReportPrint = null;
		if (StringUtils.isNotEmpty(request.getParameter("id"))) {
                  depReportPrint = depReportPrintService.getDepReportPrint(RequestUtils.getLong(request, "id"));
		}
		JSONObject result = new JSONObject();
		if (depReportPrint != null) {
		    result =  depReportPrint.toJsonObject();
		    Map<String, User> userMap = IdentityFactory.getUserMap();
		    result.put("id", depReportPrint.getId());
		    result.put("depReportPrintId", depReportPrint.getId());
		}
		return result.toJSONString().getBytes("UTF-8");
	}
}
