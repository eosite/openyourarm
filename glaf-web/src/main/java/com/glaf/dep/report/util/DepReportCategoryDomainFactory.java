 ...
 *
 */
public class DepReportCategoryDomainFactory {

    public static final String TABLENAME = "DEP_REPORT_CATEGORY";
    ...
    public static TableDefinition getTableDefinition(String tableName) {
        ...
        tableDefinition.setName("DepReportCategory");
		...
		if (tableModel == null) {
			...
			try {
				inputStream = Resources
						.getResourceAsStream("com/glaf/dep/report/domain/DepReportCategory.mapping.xml");
    ...
    private DepReportCategoryDomainFactory() {
