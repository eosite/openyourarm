...
public class AspectLayoutModel extends CommonModel implements IRule, CssRule, AttrRule {
	...
	public String getTemplateScript() {
		...
		String script = "<link rel='stylesheet' href='${contextPath}/scripts/plugins/bootstrap/aspectlayout/aspectlayout.extend.css'>"
				+"<script type='text/javascript' src='${contextPath}/scripts/plugins/bootstrap/aspectlayout/jquery.aspectlayout.extend.js'></script>";
        scriptMap.put("aspectlayout", script);
