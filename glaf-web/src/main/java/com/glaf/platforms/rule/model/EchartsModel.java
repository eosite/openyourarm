...
public class EchartsModel implements IRule, CssRule, AttrRule {
	...
	public String getTemplateScript(){
		String  script = "<script type='text/javascript' src='${contextPath}/scripts/plugins/bootstrap/echarts/js/echarts.js'></script>"
			+ "<script type='text/javascript' src='${contextPath}/scripts/kendo/echarts.extend.js'></script>"
			+ "<script type='text/javascript' src='${contextPath}/scripts/plugins/bootstrap/echarts/js/jquery.echarts.extends.js'></script>";
			
		
		scriptMap.put("echarts", script);
	...
	public String getLineColor(){
		return source.get("lineColor");
	}
	public String getAreaColor(){
		return source.get("areacolor");
	}
	public String getHeatBackGroundColor(){
		return source.get("heatbackgroundcolor");
	}
	public String getLeaveNumber(){
		return source.get("leavenumber");
	}
	public String getRangeHeight(){
	    return source.get("rangeHeight");	
	}
	public String getRangeWidth(){
		return source.get("rangeWidth");
	}
	public String getItemLeft(){
		return source.get("itemLeft");
	}
	public String getItemWidth(){
		return source.get("itemWidth");
	}
	public String getItemHeight(){
		return source.get("itemHeight");
	}
	...
	public String getChartsSource(){
		...
		for (String key : keys) {
			...
			for (Object object : jjj) {
				...
				else if("elementsName".equalsIgnoreCase(a) || "elementsName".equalsIgnoreCase(a)){
					o = new JSONObject();
					o.put("cn", j.getString("title"));
					o.put("en", j.getString("columnLabel"));
					o.put("type", j.getString("FieldType"));
				...
				else if("longitute".equalsIgnoreCase(a) || "longitute".equalsIgnoreCase(a)){
					o = new JSONObject();
					o.put("cn", j.getString("title"));
					o.put("en", j.getString("columnLabel"));
					o.put("type", j.getString("FieldType"));
				...
				else if("latitude".equalsIgnoreCase(a) || "latitude".equalsIgnoreCase(a)){
					o = new JSONObject();
					o.put("cn", j.getString("title"));
					o.put("en", j.getString("columnLabel"));
					o.put("type", j.getString("FieldType"));
				...
				else if("yAxisNameSpecial".equalsIgnoreCase(a) || "yAxisNameSpecial".equalsIgnoreCase(a)){
					spec++;
					o = new JSONObject();
					o.put("cn", j.getString("title"));
					o.put("en", j.getString("columnLabel"));
					o.put("type", j.getString("FieldType"));
					retJSONObject.put(a + spec,o); //系列 x 轴 或 （气泡）z 轴
				}
		...
		if(zhouA!=null && !zhouA.isEmpty()){
			...
			if(zhouArray!=null && !zhouArray.isEmpty()){
				for (Object object : zhouArray) {
					...
					if(zhouObj.get("axisWeight")!=null){
						if(zhouObj.getBoolean("axisWeight")){
							retObj.put("fontWeight" , true);
						}
					}
					if(zhouObj.get("axisStyle")!=null){
						if(zhouObj.getBoolean("axisStyle")){
							retObj.put("fontStyle" , true);
						}
					}
					...
					setOBJ(zhouObj, retObj, "xLie" ,"xLie","number");
					setOBJ(zhouObj, retObj, "yLie" ,"yLie","number");
					setOBJ(zhouObj, retObj, "radius" ,"radius","number");
					setOBJ(zhouObj, retObj, "spiltNumber" ,"spiltNumber","number");
					setOBJ(zhouObj, retObj, "fontSize" ,"fontSize","number");
	...
	public String getDefined(){
		String zhou = source.get("defined");
		JSONArray zhouA = JSON.parseArray(zhou);
		JSONArray zhouArray  = null ;
		JSONObject zhouObj  = null ;
		JSONArray retArray = new JSONArray();
		...
		if(zhouA!=null && !zhouA.isEmpty()){
			...
			if(zhouArray!=null && !zhouArray.isEmpty()){
				for (Object object : zhouArray) {
					...
					setOBJ(zhouObj, retObj, "yLineVal","yLineVal","number");
					setOBJ(zhouObj, retObj, "lineColor","lineColor","string");
					retArray.add(retObj);
				}
				return retArray.toJSONString() ;
			}
	...
	public String getXAxisSet(){
		String zhou = source.get("xAxisSet");
		JSONArray zhouA = JSON.parseArray(zhou);
		JSONArray zhouArray  = null ;
		JSONObject zhouObj  = null ;
		JSONArray retArray = new JSONArray();
		...
		if(zhouA!=null && !zhouA.isEmpty()){
			...
			if(zhouArray!=null && !zhouArray.isEmpty()){
				for (Object object : zhouArray) {
					...
					setOBJ(zhouObj, retObj, "xfontSize", "xfontSize","string");
					setOBJ(zhouObj, retObj, "xtextColor", "xtextColor","string");
					setOBJ(zhouObj, retObj, "xlineColor", "xlineColor","string");
	...
	public String getYAxisSet(){
		String zhou = source.get("yAxisSet");
		JSONArray zhouA = JSON.parseArray(zhou);
		JSONArray zhouArray  = null ;
		JSONObject zhouObj  = null ;
		JSONArray retArray = new JSONArray();
		...
		if(zhouA!=null && !zhouA.isEmpty()){
			...
			if(zhouArray!=null && !zhouArray.isEmpty()){
				for (Object object : zhouArray) {
					...
					setOBJ(zhouObj, retObj, "yfontSize", "yfontSize","string");
					setOBJ(zhouObj, retObj, "ytextColor", "ytextColor","string");
					setOBJ(zhouObj, retObj, "yline", "yline","string");
					setOBJ(zhouObj, retObj, "ymin", "ymin","number");
					setOBJ(zhouObj, retObj, "ymax", "ymax","number");
					retArray.add(retObj);
				}
				return retArray.toJSONString() ;
			}
	...
	public String getLineSet(){
		String zhou = source.get("lineSet");
		JSONArray zhouA = JSON.parseArray(zhou);
		JSONArray zhouArray  = null ;
		JSONObject zhouObj  = null ;
		JSONArray retArray = new JSONArray();
	...
	public String getItemTextSize(){
		return source.get("itemTextSize");
	}
	/**
	 * x 轴标题
	 * @return
