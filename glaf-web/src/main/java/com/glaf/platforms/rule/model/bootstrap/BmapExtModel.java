...
public class BmapExtModel extends CommonModel implements IRule, CssRule, AttrRule {
	...
	public String getbmapurl() {
		return source.get("bmapUrl");
	}
	public String getSearchRange() {
		return source.get("searchRange");
	}
	public String getShowSearchBtn(){
		return source.get("showSearchBtn");
	}
	//平移缩放
	...
	public String getScrollWheelZoom(){
		return source.get("scrollWheelZoom");
	}
	@Override
	...
	public String getTemplateScript() {
		...
		sb.append("<script src='${contextPath}/scripts/plugins/bootstrap/baidumap/ext/jquery.baidumap.extend.js'></script>");
