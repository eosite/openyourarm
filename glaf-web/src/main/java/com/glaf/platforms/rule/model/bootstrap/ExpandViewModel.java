...
public class ExpandViewModel extends CommonModel implements IRule, CssRule, AttrRule {
	/**
	 * 
	 */
	...
	public String getTemplateScript() {
		...
		script =  "<script type='text/javascript' src='${contextPath}/scripts/plugins/bootstrap/expandview/js/jquery.expandview.extends.js'></script>";

		scriptMap.put("expandview", script);
