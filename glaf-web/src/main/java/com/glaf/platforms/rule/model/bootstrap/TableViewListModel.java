...
public class TableViewListModel extends CommonModel implements IRule, CssRule, AttrRule {
	/**
	 * 
	 */
	...
	public String getTemplateScript() {
		...
		script =  "<script type='text/javascript' src='${contextPath}/scripts/plugins/bootstrap/tableViewList/js/jquery.tableViewList.extends.js'></script>";

		scriptMap.put("tableViewList", script);
