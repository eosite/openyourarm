...
public class BmapMarkerModel extends CommonModel implements IRule, CssRule, AttrRule {
	...
	public String getTemplateScript() {
		...
		sb.append("<script src='${contextPath}/scripts/plugins/bootstrap/baidumap/ext/jquery.bmapmarker.extend.js'></script>");
	...
	public String getSelectPointModel(){
		return source.get("selectPointModel");
	}
