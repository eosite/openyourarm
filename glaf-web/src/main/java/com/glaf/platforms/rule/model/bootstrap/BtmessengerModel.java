...
public class BtmessengerModel extends CommonModel {
	...
	public void setScriptMap(Map<String, String> scriptMap) {
		...
		SB.append("<script src=\"${contextPath}/scripts/plugins/bootstrap/messenger/jquery.btmessenger.extends.js\"></script>");

		this.scriptMap.put("messenger", SB.toString());
	}
