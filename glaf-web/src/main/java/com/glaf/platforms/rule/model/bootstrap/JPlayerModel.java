...
public class JPlayerModel extends CommonModel implements IRule, CssRule, AttrRule {
	...
	public String getTemplateScript() {
		String script = "<link rel='stylesheet' type='text/css' href='${contextPath}/scripts/plugins/bootstrap/jPlayer/css/jplayer.blue.monday.min.css'>"
				+ "<script type='text/javascript' src='${contextPath}/scripts/plugins/bootstrap/jPlayer/js/jquery.jplayer.min.js'></script>"
				+ "<script type='text/javascript' src='${contextPath}/scripts/plugins/bootstrap/jPlayer/js/jplayer.playlist.min.js'></script>"
				+ "<script type='text/javascript' src='${contextPath}/scripts/plugins/bootstrap/jPlayer/js/jquery.jplayer.extends.js'></script>";

		scriptMap.put("jplayer", script);
	 ...
	 * @return 
	 */
	public String getJPlayerSource(){
