...
public class PhotoSwipeModel extends CommonModel implements IRule, CssRule, AttrRule {
	/**
	 * 
	 */
	...
	public String getTemplateScript() {
		...
		String script = "<link rel='stylesheet' type='text/css' href='${contextPath}/scripts/plugins/bootstrap/photoSwipe/dist/photoswipe.css' />"
				+ "<link rel='stylesheet' type='text/css' href='${contextPath}/scripts/plugins/bootstrap/photoSwipe/dist/default-skin/default-skin.css' />"
				+ "<link rel='stylesheet' type='text/css' href='${contextPath}/scripts/plugins/bootstrap/photoSwipe/css/site.css' />"
				+ "<script type='text/javascript' src='${contextPath}/scripts/plugins/bootstrap/photoSwipe/dist/photoswipe.min.js'></script>"
				+ "<script type='text/javascript' src='${contextPath}/scripts/plugins/bootstrap/photoSwipe/dist/photoswipe-ui-default.min.js'></script>"
				+ "<script type='text/javascript' src='${contextPath}/scripts/plugins/bootstrap/photoSwipe/js/jquery.photoSwipe.extends.js'></script>";
