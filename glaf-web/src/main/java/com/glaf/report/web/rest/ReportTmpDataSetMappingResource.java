...
import com.glaf.report.core.service.ReportTmpDataSetMappingService;
...
@Controller
@Path("/rs/report/reportTmpDataSetMapping")
public class ReportTmpDataSetMappingResource {
	protected static final Log logger = LogFactory.getLog(ReportTmpDataSetMappingResource.class);
	...
	public byte[] deleteAll(@Context HttpServletRequest request)
		...
		if (rowIds != null) {
			...
			if (ids != null && !ids.isEmpty()) {
				reportTmpDataSetMappingService.deleteByIds(ids);
			}
		}
	...
	public byte[] deleteById(@Context HttpServletRequest request) throws IOException {
                reportTmpDataSetMappingService.deleteById(request.getParameter("id"));
		return ResponseUtils.responseJsonResult(true);
	}
	...
	public byte[] data(@Context HttpServletRequest request, @RequestBody DataRequest dataRequest) throws IOException {
		...
		if (total > 0) {
			...
			List<ReportTmpDataSetMapping> list = reportTmpDataSetMappingService.getReportTmpDataSetMappingsByQueryCriteria(start, limit,
					query);
	...
	@POST
	@Path("/saveReportTmpDataSetMapping")
	@ResponseBody
	@Produces({ MediaType.APPLICATION_JSON })
	public byte[] saveReportTmpDataSetMapping(@Context HttpServletRequest request) {
	        Map<String, Object> params = RequestUtils.getParameterMap(request);
	...
	public byte[] view(@Context HttpServletRequest request) throws IOException {
		ReportTmpDataSetMapping reportTmpDataSetMapping = null;
		if (StringUtils.isNotEmpty(request.getParameter("id"))) {
                  reportTmpDataSetMapping = reportTmpDataSetMappingService.getReportTmpDataSetMapping(request.getParameter("id"));
		}
		JSONObject result = new JSONObject();
		if (reportTmpDataSetMapping != null) {
		    result =  reportTmpDataSetMapping.toJsonObject();
		    Map<String, User> userMap = IdentityFactory.getUserMap();
		    result.put("id", reportTmpDataSetMapping.getId());
		    result.put("reportTmpDataSetMappingId", reportTmpDataSetMapping.getId());
		}
		return result.toJSONString().getBytes("UTF-8");
	}
}
