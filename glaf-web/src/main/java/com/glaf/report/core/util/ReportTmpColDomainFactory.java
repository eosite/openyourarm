 ...
 *
 */
public class ReportTmpColDomainFactory {

    public static final String TABLENAME = "REPORT_TMP_COL";
    ...
    public static TableDefinition getTableDefinition(String tableName) {
        ...
        tableDefinition.setName("ReportTmpCol");
    ...
    private ReportTmpColDomainFactory() {
