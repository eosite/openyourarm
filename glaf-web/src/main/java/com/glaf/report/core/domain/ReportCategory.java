...
public class ReportCategory implements Serializable, JSONable {
	...
	public String getModifyDatetimeString(){
        ...
        public void setParentId_(Long parentId_) {
	...
	public ReportCategory jsonToObject(JSONObject jsonObject) {
            return ReportCategoryJsonFactory.jsonToObject(jsonObject);
	}


	public JSONObject toJsonObject() {
            return ReportCategoryJsonFactory.toJsonObject(this);
	}

	public ObjectNode toObjectNode(){
            return ReportCategoryJsonFactory.toObjectNode(this);
	}
